...
namespace Ophelia_Test_V21.AFuncionesGlobales.CRUDProgramas.ModulosNm
{
    class CrudKnmpainc
    {
        public static void KNmPaincCRUD(WindowsDriver<WindowsElement> desktopSession, List<string> variables, int flag) {
            ...
            List<int> lupasOff = new List<int>() { 2, 3, 4, 5, 6 };
            if (flag == 0)
            {
                ...
                lupasOff = new List<int>() { 0, 2, 3, 4, 5, 6 };
