...
namespace Ophelia_Test_V21.AFuncionesGlobales.CRUDProgramas.ModulosNm_2
{
    class CrudKnmpectr
    {
        public static void KNmPectrCRUD(WindowsDriver<WindowsElement> desktopSession, List<string> variables, int flag) {
            ...
            if (flag == 0)
            {
                ...
                desktopSession.Mouse.MouseMove(checkBoxes[34].Coordinates);
                Thread.Sleep(1000);
