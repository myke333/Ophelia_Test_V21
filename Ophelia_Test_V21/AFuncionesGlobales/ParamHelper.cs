...
namespace ParamAccessHelper
{
    public class GetTestCaseParams
    {
        ...
        public async Task<DataSet> GetOrderTestCases(string plan, string suitecase)
        {

            try
            {
                string url = this.VstsURI + "//" + Project + "/" + Collection + "/_apis/test/Plans/" + plan + "/Suites/" + suitecase + "/testcases";
