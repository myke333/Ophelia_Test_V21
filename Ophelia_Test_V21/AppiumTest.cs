...
namespace Ophelia_Test_21
{
    [TestClass]
    public class AppiumTest : FuncionesVitales
    {
        ...
        public void TestApiumModules()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.AppiumTest.TestApiumModules")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                                ...
                                )
                            {
                                ...
                                //Debugger.Launch();
                                string file = CrearDocumentoWordDinamico(programa, "NM", "SQL");
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        //errors = FuncionesGlobales.validarCodPrograma(desktopSession, programa);
                                        //if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }

                                        //errors = FuncionesGlobales.validarDescripPrograma(desktopSession, descripcion);
                                        //if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }
                                        ...
                                        errors = newFunctions_2.ExpExcel(desktopSession, banExcel, file, programa, ruta);
                                        if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }
                                        ...
                                        PruebaCRUD.CRUD(desktopSession, 1);
                                        ...
                                        PruebaCRUD.CRUD(desktopSession, 2);
                                        ...
                                        desktopSession.Mouse.Click(null);
                                        Thread.Sleep(500);
                                        desktopSession.Keyboard.SendKeys("{ENTER}");
                                        Thread.Sleep(5000);

                                    }
                                    else
                                    {
                                        ErrorValidacion.Add($"El programa no puede ser leido : {programa}");
                                    }
        ...
        public void AbrirPrograma()
        {
            ...
            List<string> ErrorValidacion = new List<string>();
            List<string> errors = new List<string>();
            AbrirPrograma a = new AbrirPrograma("KSoRcvot", "UCalida1");
            //AbrirPrograma a = new AbrirPrograma("KNmRenov", "ODESAR");
            desktopSession = a.Start2("SQL", "");
        ...
        public void KNmAusenCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.AppiumTest.KNmAusenCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                                ...
                                )
                            {
                                ...
                                List<string> crudVariables = new List<string>() { identificacion, concepto, ausencia, observaciones };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        PruebaCRUD.CRUDAusen(desktopSession, 1, crudVariables, file);
                                        ...
                                        PruebaCRUD.CRUDAusen(desktopSession, 2, crudVariables, file);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, identificacion, ausencia, "OBS_ERVA", c, ErrorValidacion, "No se edito correctamente", 1);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, identificacion, observaciones, "OBS_ERVA", c, ErrorValidacion, "El registro no se editó correctamente", 1);
                                        ...
                                        ////REPORTE DINAMICO
                                        //errors = newFunctions_5.ReporteDinamico(desktopSession, file);
                                        //if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }

                                        ////REPORTE PRELIMINAR
                                        //errors = FuncionesGlobales.ReportePreliminar(desktopSession, BanderaPreli, file);
                                        //if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }

                                        ////EXPORTAR EXCEL
                                        //errors = newFunctions_2.ExpExcel(desktopSession, banExcel, file, codProgram);
                                        //if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }
                                        ...
                                        desktopSession.Mouse.Click(null);
                                        Thread.Sleep(500);
                                        Screenshot("Borrar Registro", true, file, desktopSession);
                                        ...
                                        string tipo2 = "D";
                                        c[4] = SqlAdapter.ConsultaSqlOraAuditoriaDelete(motor, user, Tabla);
