...
namespace Ophelia_Test_V21.Procesos.Proceso_Incap
{
    /// <summary>
    /// Descripción resumida de ModulosProcesoIncap
    /// </summary>
    [TestClass]
    public class ModulosProcesoIncap : FuncionesVitales
    {
        ...
        public void RegistroKNmIncap()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.Procesos.Proceso_Incap.ModulosProcesoIncap.RegistroKNmIncap")
                {
        ...
        //        if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.Procesos.Proceso_Incap.ModulosProcesoIncap.CorrerNominaLinom")
        //        {
        //            DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
        //            string endstatus = null;
        //            foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        //                                FuncionesProcesosIncap.CorrerNomina(desktopSession, 0, crudPrincipal);
        ...
        //                                FuncionesProcesosIncap.CorrerNomina(desktopSession, 1, crudPrincipal);
        //                                Thread.Sleep(10000);
        ...
        //[TestMethod]
        //public void VerificarNominaPreno()
        //{
        ...
        //        if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.Procesos.Proceso_Incap.ModulosProcesoIncap.VerificarNominaPreno")
        //        {
        //            DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
        //            string endstatus = null;
        //            foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        //                                FuncionesProcesosIncap.VerificarPrenomina(desktopSession, 0 , crudPrincipal);
        //                                Thread.Sleep(2000);
        ...
        //                                for(int i = 0; i < 4; i++)
        //                                {
        //                                    FuncionesProcesosIncap.VerificarPrenomina(desktopSession, 1, crudPrincipal);
        //                                    Thread.Sleep(2000);
