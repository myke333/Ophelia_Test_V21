...
using Ophelia_Test_V21.AFuncionesGlobales.FuncionesProcesos.FuncionesProcesosKNmProac;
...
namespace Ophelia_Test_V21.Procesos.ProcesoKNmProac
{
    /// <summary>
    /// Descripción resumida de ModulosProcesosKNmProac
    /// </summary>
    [TestClass]
    public class ModulosProcesosKNmProac : FuncionesVitales
    {
        ...
        public ModulosProcesosKNmProac()
        {
            //
        ...
        public void ProcesoAcumulados()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.Procesos.ProcesoKNmProac.ModulosProcesosKNmProac.ProcesoAcumulados")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
...

                            {
                                ...
                                string DatosQBE = rows["DatosQBE"].ToString();
                                ...
                                List<string> crudPrincipal = new List<string>() {dia, mes};

                                //CREAR EL DOCUMENTO DEL REPORTE DE LA PRUEBA
                                string file = CrearDocumentoWordDinamico(codProgram, "ProcespAcumulados", motor);
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        //Proyectar Fechas
                                        FuncionesProcesosKNmProac.FechaAcumulados(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Proceso", true, file);
                                        Thread.Sleep(1500);

                                        ////QBE
                                        //errors = FuncionesGlobales.QBEQry2Campos(desktopSession, TipoQbe, QbeFilter, DatosQBE, file, campo);
