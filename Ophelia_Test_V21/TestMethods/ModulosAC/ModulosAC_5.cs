...
{
    /// <summary>
    /// Descripción resumida de ModulosAC_5
    /// </summary>
    [TestClass]
    public class ModulosAC_5 : FuncionesVitales
    {
        ...
        public void KAcTiprgChecklist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosAC.ModulosAC_5.KAcTiprgChecklist")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["nomReg"].ToString().Length != 0 && rows["nomReg"].ToString() != null &&
                                rows["editCabecera"].ToString().Length != 0 && rows["editCabecera"].ToString() != null &&
                                rows["campoEdit"].ToString().Length != 0 && rows["campoEdit"].ToString() != null)
                            {
                                ...
                                string nomReg = rows["nomReg"].ToString();
                                string editCabecera = rows["editCabecera"].ToString();
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKtiprg.CrudKTiprg(desktopSession, 1, codigo, nomReg, editCabecera);
                                        Thread.Sleep(1000);
                                        ...
                                        CrudKtiprg.CrudKTiprg(desktopSession, 2, codigo, nomReg, editCabecera);
                                        Thread.Sleep(1000);
                                        ...
                                        //Validacion Editar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, codigo, nomReg, campoEdit, c, ErrorValidacion, "No se descartó correctamente", 1);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionLogbo(Tabla, motor, user, campoEdit, editCabecera, "E", c, ErrorValidacion);

                                        //Validacion Editar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, codigo, editCabecera, campoEdit, c, ErrorValidacion, "No se editó correctamente", 1);
        ...
        public void KAcRequiChecklist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosAC.ModulosAC_5.KAcRequiChecklist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                                ...
                                rows["campoEdit"].ToString().Length != 0 && rows["campoEdit"].ToString() != null)
                            {
                                ...
                                string campoEdit = rows["campoEdit"].ToString();
                                List<string> lupa = new List<string> { tipReg };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKacrequi.CrudKAcrequi(desktopSession, 1, codigo, nombre, lupa, edit);
                                        Thread.Sleep(1000);
                                        ...
                                        CrudKacrequi.CrudKAcrequi(desktopSession, 2, codigo, nombre, lupa, edit);
                                        Thread.Sleep(1000);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
        ...
        public void KAcEspecChecklist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosAC.ModulosAC_5.KAcEspecChecklist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void KAcTipcaChecklist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosAC.ModulosAC_5.KAcTipcaChecklist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                                ...
                                rows["campoEdit"].ToString().Length != 0 && rows["campoEdit"].ToString() != null)
                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKactipca.CrudKActipca(desktopSession, 1, codigo, abreviatura, descrip, edit);
                                        Thread.Sleep(1000);
                                        ...
                                        CrudKactipca.CrudKActipca(desktopSession, 2, codigo, abreviatura, descrip, edit);
                                        Thread.Sleep(1000);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
