...
namespace Ophelia_Test_V21.TestMethods.ModulosAC
{
    ...
    [TestClass]
    public class ModulosAC_7 : FuncionesVitales
    {
        ...
        public void KAcReporChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosAC.ModulosAC_7.KAcReporChecKlist")
                {
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudAcrepor.AgregarCrud(desktopSession);
        ...
        public void KAcMaansChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosAC.ModulosAC_7.KAcMaansChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
...

                            {
                                ...
                                List<string> crudPrincipal = new List<string>() { Identificacion, Nombre, Fecha1, Fecha2, ActNombre };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKacmaans.Click(desktopSession);
                                        Thread.Sleep(2000);
                                        CrudKacmaans.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        ...
                                        CrudKacmaans.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        ...
                                        string pdf1 = @"C:\Reportes\ReportePDF1_" + "Preliminar" + "_" + Hora();
                                        errors = CrudKacmaans.ReportePreliminar1(desktopSession, BanderaPreli, file, pdf1);
                                        if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }


                                        //REPORTE PRELIMINAR 2
                                        string pdf2 = @"C:\Reportes\ReportePDF1_" + "Preliminar" + "_" + Hora();
                                        CrudKacmaans.ReportePreliminar2(desktopSession, file, pdf2);


                                        //REPORTE PRELIMINAR 3
                                        string pdf3 = @"C:\Reportes\ReportePDF1_" + "Preliminar" + "_" + Hora();
                                        errors = CrudKacmaans.ReportePreliminar3(desktopSession, BanderaPreli, file, pdf3);
                                        if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }


                                        //REPORTE PRELIMINAR 4
                                        string pdf4 = @"C:\Reportes\ReportePDF1_" + "Preliminar" + "_" + Hora();
                                        CrudKacmaans.ReportePreliminar4(desktopSession, file, pdf4);


                                        //REPORTE PRELIMINAR 5
                                        string pdf5 = @"C:\Reportes\ReportePDF1_" + "Preliminar" + "_" + Hora();
                                        errors = CrudKacmaans.ReportePreliminar5(desktopSession, BanderaPreli, file, pdf5);
                                        if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }
                                        ...
                                        CrudKacmaans.ReportePreliminar6(desktopSession, file, pdf6);
                                        Thread.Sleep(1500);


                                        //REPORTE PRELIMINAR 6.2 / 7
                                        string pdf7 = @"C:\Reportes\ReportePDF1_" + "Preliminar" + "_" + Hora();
                                        CrudKacmaans.ReportePreliminar7(desktopSession, file, pdf7);
                                        Thread.Sleep(1500);


                                        //REPORTE PRELIMINAR 6.3 / 8
                                        string pdf8 = @"C:\Reportes\ReportePDF1_" + "Preliminar" + "_" + Hora();
                                        CrudKacmaans.ReportePreliminar8(desktopSession, file, pdf8);
                                        Thread.Sleep(1500);


                                        //REPORTE PRELIMINAR 6.4 / 9
                                        string pdf9 = @"C:\Reportes\ReportePDF1_" + "Preliminar" + "_" + Hora();
                                        CrudKacmaans.ReportePreliminar9(desktopSession, file, pdf9);
                                        Thread.Sleep(1500);
        ...
        public void KAcProasChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosAC.ModulosAC_7.KAcProasChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        // Se ingresan las fechas para traer registros del Qbe
                                        Thread.Sleep(2000);
                                        CrudAcproas.AgregarCrud(desktopSession);
                                        ...
                                        CrudAcproas.Click(desktopSession, 0);
                                        Thread.Sleep(2000);
                                        newFunctions_4.ScreenshotNuevo("Aceptar", true, file);

                                        CrudAcproas.Enter(desktopSession);
                                        Thread.Sleep(2000);
                                        ...
                                        CrudAcproas.Click(desktopSession, 1);
        ...
        public void KAcRCuSaChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosAC.ModulosAC_7.KAcRCuSaChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void KAcParacChecklist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosAC.ModulosAC_7.KAcParacChecklist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                //Datos Cruds
                                rows["ActNomReg"].ToString().Length != 0 && rows["ActNomReg"].ToString() != null &&                               

                                rows["ActNomDet1"].ToString().Length != 0 && rows["ActNomDet1"].ToString() != null &&
                          
                                rows["ActNomDet2"].ToString().Length != 0 && rows["ActNomDet2"].ToString()  != null)

                            {
                                ...
                                //Variables crud principal
                                string ActNomReg = rows["ActNomReg"].ToString();
                                
                                //Variables Crud Det 1
                                string ActNomDet1 = rows["ActNomDet1"].ToString();
                               
                                //Variables Crud Det 2
                                string ActNomDet2 = rows["ActNomDet2"].ToString();
                                                                                   

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { ActNomReg };
                                //LISTA DETALLE 1
                                List<string> crudDet1 = new List<string>() { ActNomDet1 };
                                //LISTA DETALLE 2
                                List<string> crudDet2 = new List<string>() { ActNomDet2 };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        botonesNavegador2 = PruebaCRUD.findname(desktopSession, 28, 2);
                                        var ElementList2 = PruebaCRUD.NavClass(desktopSession);

                                        //// Botones Crud  DETALLE 2
                                        Dictionary<string, Point> botonesNavegador3 = new Dictionary<string, Point>();
                                        botonesNavegador3 = PruebaCRUD.findname(desktopSession, 28, 1);
                                        ...
                                        CrudKacparac.CrudPrincipal(desktopSession, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        //// CRUD DETALLE 1
                                        ////  DESCARTAR EDICION
                                        desktopSession.Mouse.MouseMove(ElementList2[2].Coordinates, botonesNavegador2["Editar"].X, botonesNavegador2["Editar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        newFunctions_4.ScreenshotNuevo("Editar DETALLE 1", true, file);

                                        // Ingresa Datos en el CRUD
                                        CrudKacparac.CrudDet1(desktopSession, crudDet1);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados DETALLE 1", true, file);
                                        Thread.Sleep(1000);

                                        CrudKacparac.BotonesCrudDetalleCentro(desktopSession, 2);
                                        ...
                                        CrudKacparac.BotonesCrudDetalleCentro(desktopSession, 1);
                                        newFunctions_4.ScreenshotNuevo("Edición Aplicada", true, file);
                                        Thread.Sleep(1000);
                                        ...
                                        // Ingresa Datos en el CRUD
                                        CrudKacparac.CrudDet2(desktopSession, crudDet2);
