...
namespace Ophelia_Test_V21.TestMethods.ModulosBI
{
    ...
    /// </summary>
    [TestClass]
    public class ModulosBi_12 : FuncionesVitales
    {
        ...
        public void KBiVadveChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosBI.ModulosBi_12.KBiVadveChecKlist")
                {
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        //Clicl en Generar reporte
                                        CrudKbivadve.Click(desktopSession, 0);


                                        //AGREGAR FECHA
                                        CrudKbivadve.KBivadveCRUD(desktopSession, crudVariablesTEdit, "TEdit", 0, 0, "");

                                        newFunctions_4.ScreenshotNuevo("Se agrega la fecha", true, file);

                                        CrudKbivadve.Click(desktopSession, 1);
                                        Thread.Sleep(1000);
                                        ...
                                        /////BOTON ACEPTAR
                                        CrudKbivadve.AceptarEnter(desktopSession, 0);
                                        Thread.Sleep(1000);
                                        newFunctions_4.ScreenshotNuevo("Boton aceptar", true, file);

                                        /////VENTANA EMERGENTE
                                        CrudKbivadve.AceptarEnter(desktopSession, 1);
                                        Thread.Sleep(1000);
                                        ...
                                        CrudKbivadve.AceptarEnter(desktopSession, 1);
                                        Thread.Sleep(1000);
                                        newFunctions_4.ScreenshotNuevo("Aviso emergente", true, file);
                                                                               
                                        ///////ERRORES
                                        CrudKbivadve.Errores(desktopSession);
                                        Thread.Sleep(2000);
