...
namespace Ophelia_Test_V21.TestMethods.ModulosBI
{
    ...
    [TestClass]
    public class ModulosBi_15 : FuncionesVitales
    {
        ...
        public void KBiProexChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosBI.ModulosBi_15.KBiProexChecKlist")
                {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
...

                            {
                               ...
                               string entidad = rows["entidad"].ToString();                            
                                ...
                                List<string> crudPrincipal = new List<string>() { entidad };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKbiProex.editproex(desktopSession, 0, crudPrincipal);

                                        //Aceptar
                                        CrudKbiaumca.BotonAceptar(desktopSession, file);

                                        //boton errores
                                        CrudKbiProex.Botonerror(desktopSession);
        ...
        public void KBiParbiChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosBI.ModulosBi_15.KBiParbiChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
...

                            {
                                ...
                                //LISTA DETALLE 1
                                List<string> crudDet1 = new List<string>() { Regui, Reque, ActEspec };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKbiparbi.ChoiceVentana(desktopSession);
                                        Thread.Sleep(1000);
                                        ...
                                        CrudKbiparbi.AggCrudPri(desktopSession, 0, crudPrincipal);
                                        Thread.Sleep(1500);
                                        ...
                                        CrudKbiparbi.AggCrudPri(desktopSession, 1, crudPrincipal);
                                        ...
                                        CrudKbiparbi.AggCrudDet(desktopSession, 0, crudDet1);
                                        ...
                                        CrudKbiparbi.AggCrudDet(desktopSession, 1, crudDet1);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos CRUD DETALLE", true, file);
