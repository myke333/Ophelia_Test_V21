...
{
    /// <summary>
    /// Descripción resumida de ModulosBi_2
    /// </summary>
    [TestClass]
    public class ModulosBi_2 : FuncionesVitales
    {
        ...
        public void KBiUnespChecklist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosBI.ModulosBi_2.KBiUnespChecklist")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                                ...
                                rows["CampoEdit"].ToString().Length != 0 && rows["CampoEdit"].ToString() != null)
                            {
                                ...
                                List<string> crudVariables = new List<string>() { Codigo, Nombre, Especificacion, Editar };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        Thread.Sleep(500);
                                        CrudKbiunesp.CrudKBiunesp(desktopSession, 1, Codigo, Nombre, Especificacion, Editar);

                                        // Aplicar
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Aplicar"].X, botonesNavegador["Aplicar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        Thread.Sleep(2000);
                                        newFunctions_4.ScreenshotNuevo("Registro Aplicado", true, file);
                                        ...
                                        CrudKbiunesp.CrudKBiunesp(desktopSession, 2, Codigo, Nombre, Especificacion, Editar);
                                        ...
                                        ////Validacion Editar
                                        //ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, Especificacion, CampoEdit, c, ErrorValidacion, "No se descartó correctamente", 1);
                                        ...
                                        ////Validacion Editar
                                        //ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, Editar, CampoEdit, c, ErrorValidacion, "No se editó correctamente", 1);
        ...
        public void KBiHsidiChecklist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosBI.ModulosBi_2.KBiHsidiChecklist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                                ...
                                rows["CampoEdit"].ToString().Length != 0 && rows["CampoEdit"].ToString() != null)
                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        desktopSession.Mouse.Click(null);
                                        Thread.Sleep(500);
                                        newFunctions_4.ScreenshotNuevo("Insetar Registro", true, file);

                                        CrudKbihsidi.CrudKBihsidi(desktopSession, 1, Nombre, Codigo, Editar);
                                        ...
                                        CrudKbihsidi.CrudKBihsidi(desktopSession, 2, Nombre, Codigo, Editar);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
        ...
        public void KBiCladiChecklist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosBI.ModulosBi_2.KBiCladiChecklist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["NomDiag"].ToString().Length != 0 && rows["NomDiag"].ToString() != null &&
                                rows["EditarDetalle"].ToString().Length != 0 && rows["EditarDetalle"].ToString() != null)
                            {
                                string user = rows["User"].ToString();
                                string motor = rows["Motor"].ToString();
                                string Tabla = rows["Tabla"].ToString();
                                ...
                                string NomDiag = rows["NomDiag"].ToString();
                                string EditarDetalle = rows["EditarDetalle"].ToString();
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera("BI_DCLAD", user, motor, Campo, Codigo, Codigo, Campo, c, ErrorValidacion, "No se agregó correctamente", 0, "1");
                                        ...
                                        CrudKbicladi.CrudKBicladiCabecera(desktopSession, 1, Codigo, Nombre, Editar);
                                        newFunctions_4.ScreenshotNuevo("Datos Ingresados", true, file);
                                        ...
                                        CrudKbicladi.CrudKBicladiCabecera(desktopSession, 2, Codigo, Nombre, Editar);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        CrudKbicladi.CrudKBicladiDetalle(desktopSession, 1, Diagnostico, NomDiag, EditarDetalle);
                                        newFunctions_4.ScreenshotNuevo("Datos Ingresados", true, file);
                                        ...
                                        CrudKbicladi.CrudKBicladiDetalle(desktopSession, 2, Diagnostico, NomDiag, EditarDetalle);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
        ...
        public void KBiModacChecklist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosBI.ModulosBi_2.KBiModacChecklist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["NomMod"].ToString().Length != 0 && rows["NomMod"].ToString() != null &&
                                rows["Editar"].ToString().Length != 0 && rows["Editar"].ToString() != null &&
                                rows["Peso"].ToString().Length != 0 && rows["Peso"].ToString() != null &&
                                rows["CodDane"].ToString().Length != 0 && rows["CodDane"].ToString() != null &&
                                rows["Profesion"].ToString().Length != 0 && rows["Profesion"].ToString() != null &&
                                rows["EditProfe"].ToString().Length != 0 && rows["EditProfe"].ToString() != null &&
                                rows["NomProfe"].ToString().Length != 0 && rows["NomProfe"].ToString() != null &&
                                ...
                                rows["CampoEdit"].ToString().Length != 0 && rows["CampoEdit"].ToString() != null)
                            {
                                ...
                                string NomMod = rows["NomMod"].ToString();
                                string Editar = rows["Editar"].ToString();
                                string Peso = rows["Peso"].ToString();
                                string CodDane = rows["CodDane"].ToString();
                                string Profesion = rows["Profesion"].ToString();
                                string EditProfe = rows["EditProfe"].ToString();
                                string NomProfe = rows["NomProfe"].ToString();
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKbimodac.CrudKBimodacCabecera(desktopSession, 1, Modalidad, NomMod, Peso, CodDane, Editar);
                                        ...
                                        //Validacion Agregar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Peso, Peso, Campo, c, ErrorValidacion, "No se agregó correctamente", 0);
                                        ...
                                        CrudKbimodac.CrudKBimodacCabecera(desktopSession, 2, Modalidad, NomMod, Peso, CodDane, Editar);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        //Validacion Editar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Peso, NomMod, CampoEdit, c, ErrorValidacion, "No se descartó correctamente", 1);
                                        ...
                                        //Validacion Editar Logbo
                                        ErrorValidacion = ValidacionesQueries.ValidacionLogbo(Tabla, motor, user, Campo, Peso, "E", c, ErrorValidacion);

                                        //Validacion Editar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Peso, Editar, CampoEdit, c, ErrorValidacion, "No se editó correctamente", 1);
                                        ...
                                        CrudKbimodac.CrudKBimodacDetalle(desktopSession, 1, Profesion, NomProfe, Registro, Requerimiento, Espec, EditProfe);
                                        ...
                                        CrudKbimodac.CrudKBimodacDetalle(desktopSession, 2, Profesion, NomProfe, Registro, Requerimiento, Espec, EditProfe);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        //Validacion Eliminar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Modalidad, "", Campo, c, ErrorValidacion, "No se eliminó correctamente", 2);
                                    }
                                    else
                                    {
                                        ErrorValidacion.Add($"El programa no puede ser leido : {codProgram}");
        ...
        public void KBiEmpleChecklist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosBI.ModulosBi_2.KBiEmpleChecklist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["SegundoA"].ToString().Length != 0 && rows["SegundoA"].ToString() != null &&
                                rows["PrimerN"].ToString().Length != 0 && rows["PrimerN"].ToString() != null &&
                                rows["SegundoN"].ToString().Length != 0 && rows["SegundoN"].ToString() != null &&
                                ...
                                rows["FechaNacimiento"].ToString().Length != 0 && rows["FechaNacimiento"].ToString() != null &&
                                rows["Telefono"].ToString().Length != 0 && rows["Telefono"].ToString() != null &&
                                rows["num1"].ToString().Length != 0 && rows["num1"].ToString() != null &&
                                rows["num2"].ToString().Length != 0 && rows["num2"].ToString() != null &&
                                rows["num3"].ToString().Length != 0 && rows["num3"].ToString() != null &&
                                rows["correo"].ToString().Length != 0 && rows["correo"].ToString() != null &&
                                rows["titulo"].ToString().Length != 0 && rows["titulo"].ToString() != null &&
                                rows["editar"].ToString().Length != 0 && rows["editar"].ToString() != null &&
                                rows["CampoEdit"].ToString().Length != 0 && rows["CampoEdit"].ToString() != null)
                            {
                                string user = rows["User"].ToString();
                                ...
                                string SegundoA = rows["SegundoA"].ToString();
                                string PrimerN = rows["PrimerN"].ToString();
                                string SegundoN = rows["SegundoN"].ToString();
                                ...
                                string num2 = rows["num2"].ToString();
                                string num3 = rows["num3"].ToString();
                                string correo = rows["correo"].ToString();
                                string titulo = rows["BanderaPreli"].ToString();
                                string editar = rows["editar"].ToString();
                                string CampoEdit = rows["CampoEdit"].ToString();
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        //cerrar ventana de error que no es error
                                        rootSession = RootSession();
                                        rootSession.Keyboard.SendKeys(OpenQA.Selenium.Keys.Enter);
                                        Thread.Sleep(1000);
                                        CrudKbiemple.CrudKBiemple(desktopSession, 1, Id, PrimerA, SegundoA, PrimerN, SegundoN, Pais, Departamento, Municipio, FechaNacimiento, Telefono, num1, num2, num3, correo, titulo, editar);
                                        ...
                                        CrudKbiemple.CrudKBiemple(desktopSession, 2, Id, PrimerA, SegundoA, PrimerN, SegundoN, Pais, Departamento, Municipio, FechaNacimiento, Telefono, num1, num2, num3, correo, titulo, editar);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        ////Validacion Editar
                                        //ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Id, SegundoA, CampoEdit, c, ErrorValidacion, "No se descartó correctamente", 1);
                                        ...
                                        ////Validacion Editar
                                        //ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Id, editar, CampoEdit, c, ErrorValidacion, "No se editó correctamente", 1);
        ...
        public void KBiEdforChecklist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosBI.ModulosBi_2.KBiEdforChecklist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                                ...
                                rows["campoEdit"].ToString().Length != 0 && rows["campoEdit"].ToString() != null)
                            {
                                ...
                                string campoEdit = rows["campoEdit"].ToString();
                                List<string> Lupas = new List<string> { Id, Modalidad, Metodologia };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        Thread.Sleep(500);
                                        newFunctions_4.ScreenshotNuevo("Insertar Registro", true, file);
                                        CrudKbiedfor.CrudKBiedfor(desktopSession, 1, Lupas, fechaIni, fechaFin, editCabeza, motor);
                                        ...
                                        CrudKbiedfor.CrudKBiedfor(desktopSession, 2, Lupas, fechaIni, fechaFin, editCabeza, motor);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        ////Validacion Editar
                                        //ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Id, espec, campoEdit, c, ErrorValidacion, "No se descartó correctamente", 1);
                                        ...
                                        CrudKbiedfor.CrudKBiedforDetalle(desktopSession, 1, tipo, req, espec, editDetalle);
                                        ...
                                        CrudKbiedfor.CrudKBiedforDetalle(desktopSession, 2, tipo, req, espec, editDetalle);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
