...
{
    [TestClass]
    public class ModulosBP_1 : FuncionesVitales
    {
        ...
        public void KBpCenvaCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosBP.ModulosBP_1.KBpCenvaCheckList")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                               ...
                               rows["centrov"].ToString().Length != 0 && rows["centrov"].ToString() != null &&
                                ...
                                rows["cabañas"].ToString().Length != 0 && rows["cabañas"].ToString() != null &&
                                rows["personas"].ToString().Length != 0 && rows["personas"].ToString() != null &&
                                rows["editpersonas"].ToString().Length != 0 && rows["editpersonas"].ToString() != null)

                            {
                                ...
                                string centrov = rows["centrov"].ToString();
                                ...
                                string cabañas = rows["cabañas"].ToString();
                                string personas = rows["personas"].ToString();
                                string editpersonas = rows["editpersonas"].ToString();

                                //String Codigo = "9";

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { centrov, identificacion, fechadesde, horadesde, fechahasta, horahasta, cabañas, personas, editpersonas };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKbpcenva.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        ...
                                        CrudKbpcenva.AgregarCrud(desktopSession, 1, crudPrincipal);
        ...
        public void KBpPCevaCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosBP.ModulosBP_1.KBpPCevaCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                               ...
                               //Datos Crud principal
                               rows["numcentro"].ToString().Length != 0 && rows["numcentro"].ToString() != null &&
                                rows["nomcentro"].ToString().Length != 0 && rows["nomcentro"].ToString() != null &&
                                rows["pais"].ToString().Length != 0 && rows["pais"].ToString() != null &&
                                rows["depa"].ToString().Length != 0 && rows["depa"].ToString() != null &&
                                rows["muni"].ToString().Length != 0 && rows["muni"].ToString() != null &&
                                rows["tiemposoli"].ToString().Length != 0 && rows["tiemposoli"].ToString() != null &&
                                rows["cantidadp"].ToString().Length != 0 && rows["cantidadp"].ToString() != null &&
                                rows["numnoches"].ToString().Length != 0 && rows["numnoches"].ToString() != null &&
                                rows["adulto"].ToString().Length != 0 && rows["adulto"].ToString() != null &&
                                rows["cantniños"].ToString().Length != 0 && rows["cantniños"].ToString() != null &&
                                rows["añosns"].ToString().Length != 0 && rows["añosns"].ToString() != null &&
                                
                                 rows["concenomina"].ToString().Length != 0 && rows["concenomina"].ToString() != null &&
                                rows["cabañas"].ToString().Length != 0 && rows["cabañas"].ToString() != null)

                            {
                                ...
                                //Variables Crud principal
                                string numcentro = rows["numcentro"].ToString();
                                string nomcentro = rows["nomcentro"].ToString();
                                string pais = rows["pais"].ToString();
                                string depa = rows["depa"].ToString();
                                string muni = rows["muni"].ToString();
                                string tiemposoli = rows["tiemposoli"].ToString();
                                string cantidadp = rows["cantidadp"].ToString();
                                string numnoches = rows["numnoches"].ToString();
                                string adulto = rows["adulto"].ToString();
                                string cantniños = rows["cantniños"].ToString();
                                string añosns = rows["añosns"].ToString();
                              
                                string concenomina = rows["concenomina"].ToString();
                                string cabañas = rows["cabañas"].ToString();

                                //String Codigo = "9";

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { numcentro, nomcentro, pais, depa, muni, tiemposoli, cantidadp, numnoches, adulto, cantniños, añosns, concenomina, cabañas };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKbppceva.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKbppceva.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
        ...
        public void KBpRotbeCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosBP.ModulosBP_1.KBpRotbeCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                                ...
                                )
                            {
                                ...
                                Modulo = "BP";
                                List<string> crudVariables = new List<string>() { fechaInic,fechaFin };                                
                                //CREAR EL DOCUMENTO DEL REPORTE DE LA PRUEBA
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        Thread.Sleep(1000);
                                        //Debugger.Launch();
                                        CrudKbprotbe.CRUD(desktopSession, 1, crudVariables, file);
                                        newFunctions_4.ScreenshotNuevo("Registro", true, file);
                                        Thread.Sleep(2000);

                                        //QBE
                                        //errors = CrudKbprotbe.QBEQry(desktopSession, TipoQbe, QbeFilter, file);
                                        errors = FuncionesGlobales.QBEQry(desktopSession, TipoQbe, QbeFilter, file);
                                        if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }
