...
{
    /// <summary>
    /// Descripción resumida de ModulosBP_10
    /// </summary>
    [TestClass]
    public class ModulosBP_10 : FuncionesVitales
    {
        ...
        [TestMethod]
        public void KBpGapmaCheckKlist()
        {
            //Debugger.Launch();
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosBP.ModulosBP_10.KBpGapmaCheckKlist")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["tasa"].ToString().Length != 0 && rows["tasa"].ToString() != null &&
                                rows["plazo"].ToString().Length != 0 && rows["plazo"].ToString() != null &&
                                rows["minimo"].ToString().Length != 0 && rows["minimo"].ToString() != null &&
                                rows["maximo"].ToString().Length != 0 && rows["maximo"].ToString() != null &&
                                rows["capital"].ToString().Length != 0 && rows["capital"].ToString() != null &&
                                rows["intereses"].ToString().Length != 0 && rows["intereses"].ToString() != null &&
                                rows["Actmaximo"].ToString().Length != 0 && rows["Actmaximo"].ToString() != null)

                            {
                                ...
                                string tasa = rows["tasa"].ToString();
                                string plazo = rows["plazo"].ToString();
                                string minimo = rows["minimo"].ToString();
                                string maximo = rows["maximo"].ToString();
                                string capital = rows["capital"].ToString();
                                string intereses = rows["intereses"].ToString();
                                string Actmaximo = rows["Actmaximo"].ToString();

                                //String Codigo = "9";

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { modalidad, capital, intereses, Codigo, Nombre, tasa, plazo, minimo, maximo, Actmaximo };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKbpgapma.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        ...
                                        CrudKbpgapma.AgregarCrud(desktopSession, 1, crudPrincipal);
        ...
        [TestMethod]
        public void KBpGappaCheckKlist()
        {
            //Debugger.Launch();
            List<string> errorMessages = new List<string>();
            List<string> listaResultado;
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosBP.ModulosBP_10.KBpGappaCheckKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["ipc"].ToString().Length != 0 && rows["ipc"].ToString() != null &&
                                rows["rango1"].ToString().Length != 0 && rows["rango1"].ToString() != null &&
                                rows["rango2"].ToString().Length != 0 && rows["rango2"].ToString() != null &&                                
                                rows["Actipc"].ToString().Length != 0 && rows["Actipc"].ToString() != null)

                            {
                                ...
                                string ipc = rows["ipc"].ToString();
                                string rango1 = rows["rango1"].ToString();
                                string rango2 = rows["rango2"].ToString();
                                string Actipc = rows["Actipc"].ToString();

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { año, fecha, salario, seguro, ipc, rango1, rango2, Actipc};
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKbpgappa.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKbpgappa.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        ////Validacion Editar Descartar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, año, ipc, EditCampo, c, ErrorValidacion, "No se edito correctamente", 1);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, año, Actipc, EditCampo, c, ErrorValidacion, "El registro no se editó correctamente", 1);
        ...
        [TestMethod]
        public void KBpGapreCheckKlist()
        {
            //Debugger.Launch();
            List<string> errorMessages = new List<string>();
            List<string> listaResultado;
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosBP.ModulosBP_10.KBpGapreCheckKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKbpgapre.AgregarCrud(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Aceptar", true, file);

                                        CrudKbpgapre.AgregarCrud2(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Aceptar", true, file);
        ...
        [TestMethod]
        public void KBpGapsaCheckKlist()
        {
            //Debugger.Launch();
            List<string> errorMessages = new List<string>();
            List<string> listaResultado;
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosBP.ModulosBP_10.KBpGapsaCheckKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["capital"].ToString().Length != 0 && rows["capital"].ToString() != null &&
                                rows["segurov"].ToString().Length != 0 && rows["segurov"].ToString() != null &&
                                rows["intereses"].ToString().Length != 0 && rows["intereses"].ToString() != null &&
                                rows["siniestros"].ToString().Length != 0 && rows["siniestros"].ToString() != null &&
                                rows["fechasaldo"].ToString().Length != 0 && rows["fechasaldo"].ToString() != null &&
                                rows["saldop"].ToString().Length != 0 && rows["saldop"].ToString() != null &&
                                rows["saldoe"].ToString().Length != 0 && rows["saldoe"].ToString() != null)

                            {
                                ...
                                string capital = rows["capital"].ToString();
                                string segurov = rows["segurov"].ToString();
                                string intereses = rows["intereses"].ToString();
                                string siniestros = rows["siniestros"].ToString();
                                string fechasaldo = rows["fechasaldo"].ToString();
                                string saldop = rows["saldop"].ToString();
                                string saldoe = rows["saldoe"].ToString();

                                //String Codigo = "9";

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Codigo, empleado, capital, segurov, intereses, siniestros, fechasaldo, saldop, saldoe };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKbpgapsa.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKbpgapsa.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
        ...
        [TestMethod]
        public void KBpSaldoCheckKlist()
        {
            //Debugger.Launch();
            List<string> errorMessages = new List<string>();
            List<string> listaResultado;
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosBP.ModulosBP_10.KBpSaldoCheckKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
