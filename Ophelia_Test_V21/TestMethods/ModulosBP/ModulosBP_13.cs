...
{
    [TestClass]
    public class ModulosBP_13 : FuncionesVitales
    {
        ...
        public void KBpCapreCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosBP.ModulosBP_13.KBpCapreCheckList")
                {
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKbpcapre.AgregarCrud(desktopSession, 0);
                                        ...
                                        CrudKbpcapre.AgregarCrud(desktopSession, 1);
        ...
        public void KBpGaaboCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosBP.ModulosBP_13.KBpGaaboCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["ValorPago"].ToString().Length != 0 && rows["ValorPago"].ToString() != null &&
                                rows["NoDoc"].ToString().Length != 0 && rows["NoDoc"].ToString() != null &&
                                rows["EditVPago"].ToString().Length != 0 && rows["EditVPago"].ToString() != null &&
...

                            {
                                ...
                                //Variables crud Principal
                                string ValorPago = rows["ValorPago"].ToString();
                                string NoDoc = rows["NoDoc"].ToString();
                                string EditVPago = rows["EditVPago"].ToString();
                                ...
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { ValorPago, NoDoc, EditVPago};
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKbpGaabo.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKbpGaabo.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        //PruebaCRUD.EliminarRegistro(desktopSession, ElementList[0], botonesNavegador, file);
                                        CrudKbpGaabo.EliminarRegistro(desktopSession, ElementList[0], botonesNavegador, file);
                                        newFunctions_4.ScreenshotNuevo("Datos Eliminados Principal", true, file);
                                        //VALIDACIÓN ELIMINAR REGISTRO
                                        //ErrorValidacion = ValidacionesQueries.ValidacionLogbo(Tabla, motor, user, Campo, Codigo, "D", c, ErrorValidacion);
                                        //ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, "", Campo, c, ErrorValidacion, "los datos no se eliminaron correctamente", 2);
        ...
        public void KBpPremiCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosBP.ModulosBP_13.KBpPremiCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                //Variables Validaciones Crud Principal
                                rows["Premio"].ToString().Length != 0 && rows["Premio"].ToString() != null &&
                                rows["NomPremio"].ToString().Length != 0 && rows["NomPremio"].ToString() != null &&
                                rows["Puntos"].ToString().Length != 0 && rows["Puntos"].ToString() != null &&
                                rows["Editpuntos"].ToString().Length != 0 && rows["Editpuntos"].ToString() != null &&
...

                            {
                                ...
                                //Variables Validaciones Crud Principal
                                string Premio = rows["Premio"].ToString();
                                string NomPremio = rows["NomPremio"].ToString();
                                string Puntos = rows["Puntos"].ToString();
                                string Editpuntos = rows["Editpuntos"].ToString();
                                ...
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() {Premio, NomPremio, Puntos, Editpuntos};
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        //CrudKbppremi.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
