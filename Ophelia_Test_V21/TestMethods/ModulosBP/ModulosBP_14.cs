...
{
    [TestClass]
    public class ModulosBP_14 : FuncionesVitales
    {
        ...
        public void KBpHiincChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosBP.ModulosBP_14.KBpHiincChecKlist")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["ActNroRes"].ToString().Length != 0 && rows["ActNroRes"].ToString() != null &&
...

                            {
                                ...
                                string ActNroRes = rows["ActNroRes"].ToString();

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { valor, NroRes, FechaRes, ActNroRes };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudkbpHiinc.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        ...
                                        CrudkbpHiinc.AgregarCrud(desktopSession, 1, crudPrincipal);
