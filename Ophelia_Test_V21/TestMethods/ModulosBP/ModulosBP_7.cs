...
{
    /// <summary>
    /// Descripción resumida de ModulosBP_7
    /// </summary>
    [TestClass]
    public class ModulosBP_7 : FuncionesVitales
    {
        ...
        public void KBpMopreCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosBP.ModulosBP_7.KBpMopreCheckList")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["grEvaluacion"].ToString().Length != 0 && rows["grEvaluacion"].ToString() != null &&
                                rows["DescripcionACT"].ToString().Length != 0 && rows["DescripcionACT"].ToString() != null
                                )
                            {
                                ...
                                string grEvaluacion = rows["grEvaluacion"].ToString();
                                string DescripcionACT = rows["DescripcionACT"].ToString();

                                List<string> crudVariables = new List<string>() { Modalidad, Descripcion, grEvaluacion, DescripcionACT };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Modalidad, Modalidad, Campo, c, ErrorValidacion, "No se agregó correctamente", 0,"1");
                                        ...
                                        CrudKbpmopre.CRUD(desktopSession, "0", crudVariables, file);
                                        ...
                                        Thread.Sleep(2000);
                                        //VALIDACIÓN INSERTAR
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Modalidad, Modalidad, Campo, c, ErrorValidacion, "No se agregó correctamente", 0);
                                        ...
                                        CrudKbpmopre.CRUD(desktopSession, "1", crudVariables, file);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Modalidad, Descripcion, EdCampo, c, ErrorValidacion, "No se edito correctamente", 1);

                                        newFunctions_3.LupaAud(desktopSession, BanderaLupa, file);
                                        Thread.Sleep(1000);
                                        ...
                                        Thread.Sleep(1500);
                                        ErrorValidacion = ValidacionesQueries.ValidacionLogbo(Tabla, motor, user, Campo, Modalidad, "E", c, ErrorValidacion);
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Modalidad, DescripcionACT, EdCampo, c, ErrorValidacion, "El registro no se editó correctamente", 1);
                                        ...
                                        string COD_EMPRAUX = ValidacionesQueries.CodEmpresa(Tabla, user, motor, Campo, Modalidad, c);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionLogbo(Tabla, motor, user, Campo, Modalidad, "D", c, ErrorValidacion);
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Modalidad, "", Campo, c, ErrorValidacion, "los datos no se eliminaron correctamente", 2);
                                    }
                                    else
                                    {
        ...
        public void KBpMzrceCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosBP.ModulosBP_7.KBpMzrceCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["nroCarnet"].ToString().Length != 0 && rows["nroCarnet"].ToString() != null &&
                                
                                rows["fecha"].ToString().Length != 0 && rows["fecha"].ToString() != null &&
                                rows["fechaACT"].ToString().Length != 0 && rows["fechaACT"].ToString() != null)

                            {
                                ...
                                string nroCarnet = rows["nroCarnet"].ToString();
                                
                                string fecha = rows["fecha"].ToString();
                                string fechaACT = rows["fechaACT"].ToString();



                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() {  Identificacion, nroCarnet,  fecha, fechaACT };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKbpmzrce.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKbpmzrce.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
        ...
        public void KBpPapreCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosBP.ModulosBP_7.KBpPapreCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKbPapre.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKbPapre.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
        ...
        public void KBpGapprCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosBP.ModulosBP_7.KBpGapprCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                //VARIABLES CRUD
                                rows["Codigo"].ToString().Length != 0 && rows["Modalidad"].ToString() != null &&
                                rows["NombrePre"].ToString().Length != 0 && rows["Descripcion"].ToString() != null &&
                                rows["grEvaluacion"].ToString().Length != 0 && rows["grEvaluacion"].ToString() != null &&
                                rows["DescripcionACT"].ToString().Length != 0 && rows["DescripcionACT"].ToString() != null
                                )
                            {
