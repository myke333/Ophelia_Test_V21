...
namespace Ophelia_Test_V21.TestMethods.ModulosBP
{
    ...
    /// </summary>
    [TestClass]
    public class ModulosBP_8 : FuncionesVitales
    {
        ...
        public void KBpAcumuChecklist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosBP.ModulosBP_8.KBpAcumuChecklist")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["CargoConc"].ToString().Length != 0 && rows["CargoConc"].ToString() != null &&
                                ...
                                rows["ActDias"].ToString().Length != 0 && rows["ActDias"].ToString() != null)
                            {
                                ...
                                string CargoConc = rows["CargoConc"].ToString();
                                ...
                                List<string> crudPrincipal = new List<string>() { Contrato, Identificacion, CargoConc, CentroCost, CentroTrab, ClaseNom, Dias, Valor, ActDias };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKbpacumu.AgregarCrud(desktopSession, 0, crudPrincipal);                                        
                                        ...
                                        CrudKbpacumu.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        ...
                                        //ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Contrato, ActDias, EditCampo, c, ErrorValidacion, "El registro no se editó correctamente", 1);
        ...
        public void KBpAboexChecklist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosBP.ModulosBP_8.KBpAboexChecklist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void KBpMovAcChecklist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosBP.ModulosBP_8.KBpMovAcChecklist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                                ...
                                rows["fecha"].ToString().Length != 0 && rows["fecha"].ToString() != null)
                            {
                                ...
                                List<string> CrudPrincipal = new List<string>() {fecha, fecha2 };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKbpmovAc.AgregarCrud(desktopSession, CrudPrincipal);

                                        //QBE
                                        errors = FuncionesGlobales.QBEQry(desktopSession, TipoQbe, QbeFilter, file);
                                        if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }

                                        CrudKbpmovAc.AgregarCrud2(desktopSession, CrudPrincipal);

                                        newFunctions_4.ScreenshotNuevo("Abrir Programa", true, file);

                                        CrudKbpmovAc.AgregarCrud3(desktopSession, CrudPrincipal);
        ...
        public void KBpAmortChecklist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosBP.ModulosBP_8.KBpAmortChecklist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("BP", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    {
                        endstatus = rowsta["states"].ToString();
        ...
        [TestMethod]
        public void KBpCapahCheckKlist()
        {
            //Debugger.Launch();
            List<string> errorMessages = new List<string>();
            List<string> listaResultado;
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosBP.ModulosBP_8.KBpCapahCheckKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKbpcapah.AgregarCrud(desktopSession, crudPrincipal);
        ...
        [TestMethod]
        public void KBpGamopCheckKlist()
        {
            //Debugger.Launch();
            List<string> errorMessages = new List<string>();
            List<string> listaResultado;
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosBP.ModulosBP_8.KBpGamopCheckKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKbpgamop.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKbpgamop.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
        ...
        [TestMethod]
        public void KBpGapcaCheckKlist()
        {
            //Debugger.Launch();
            List<string> errorMessages = new List<string>();
            List<string> listaResultado;
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosBP.ModulosBP_8.KBpGapcaCheckKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKbpgapca.AgregarCrud(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("1", true, file);

                                        CrudKbpgapca.AgregarCrud2(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("2", true, file);
                                        ...
                                        CrudKbpgapca.Errores(desktopSession);
