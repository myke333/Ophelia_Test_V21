...
namespace Ophelia_Test_V21.TestMethods.ModulosCO
{
    ...
    /// </summary>
    [TestClass]
    public class ModulosCO_6 : FuncionesVitales
    {
        ...
        public void KCoConenCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosCO.ModulosCO_6.KCoConenCheckList")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            ...
                            if (
                                ...
                                rows["NroEncuesta"].ToString().Length != 0 && rows["NroEncuesta"].ToString() != null
                                ...
                                )
                            {
                                ...
                                string nroEncuesta = rows["NroEncuesta"].ToString();

                                Modulo = "CO";
                                List<string> crudVariables = new List<string>() { nroEncuesta };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        //    errors = CrudKcoconen.ReportePreliminar(desktopSession, "0", file, pdf1, i, crudVariables);
                                        //    if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }
