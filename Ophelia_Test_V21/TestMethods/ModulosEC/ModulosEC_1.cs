...
using Ophelia_Test_V21.AFuncionesGlobales.CRUDProgramas.ModulosEc;
using OpenQA.Selenium.Support.UI;
using OpenQA.Selenium.Interactions;
using OpenQA.Selenium;

namespace Ophelia_Test_V21.TestMethods.ModulosEC
{
    /// <summary>
    /// Descripción resumida de ModulosEC_1
    /// </summary>
    [TestClass]
    public class ModulosEC_1 : FuncionesVitales
    {
        ...
        public void KEcRubroCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosEC.ModulosEC_1.KEcRubroCheckList")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                //@Identificacion @CentroCos @CentroTrab @Concepto @Cargo @GrupoProto @GrupoTrab @FechaMarca @Cantidad 
                                //@CantidadPagar @FechaPago @Observaciones @EditarObserv
                                ...
                                )
                            {
                                ...
                                List<string> crudVariables = new List<string>() { Codigo, Nombre, EditarNombre };
                                //CREAR EL DOCUMENTO DEL REPORTE DE LA PRUEBA
                                string file = CrearDocumentoWordDinamico(codProgram, "EC", motor);
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKecrubro.CRUD(desktopSession, 1, crudVariables, file);
                                        ...
                                        CrudKecrubro.CRUD(desktopSession, 2, crudVariables, file);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, Nombre, "NOM_RUBR", c, ErrorValidacion, "No se edito correctamente", 1);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, EditarNombre, "NOM_RUBR", c, ErrorValidacion, "El registro no se editó correctamente", 1);
                                        ...
                                        //CrudKecrubro.Preliminar(desktopSession, file, pdf1, BanderaPreli);
                                        if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }
