...
{
    /// <summary>
    /// Descripción resumida de ModulosED_1
    /// </summary>
    [TestClass]
    public class ModulosED_1 : FuncionesVitales
    {
        ...
        public void KEd3TievCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosED.ModulosED_1.KEd3TievCheckList")
                {
                                ...
                                )
                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        Thread.Sleep(1000);
                                        CrudKed3tiev.KEd3TievCRUD(desktopSession, crudVariables, 0);
                                        Thread.Sleep(2000);
                                        ...
                                        desktopSession.Mouse.Click(null);
                                        CrudKed3tiev.KEd3TievCRUD(desktopSession, crudVariables, 1);
                                        Thread.Sleep(1000);
        ...
        public void KEd3itemCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosED.ModulosED_1.KEd3itemCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                                ...
                                )
                            {
                                ...
                                Dictionary<string, Point> botonesNavegadorDet1 = new Dictionary<string, Point>();
                                Dictionary<string, Point> botonesNavegadorDet2 = new Dictionary<string, Point>();
                                List<string> crudVariables = new List<string>() { registro, requerimiento, especificacion, codigo, descripcion, editDescripcion };
                                List<string> crudVariablesDet1 = new List<string>() { };
                                WindowsDriver<WindowsElement> rootSession = null;
                                bool isErrorDisplayed = false;
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        desktopSession.Mouse.Click(null);
                                        Thread.Sleep(1000);
                                        CrudKed3item.KEd3itemCRUD(desktopSession, crudVariables, 0);
                                        Thread.Sleep(2000);
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Aplicar"].X, botonesNavegador["Aplicar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        Thread.Sleep(2000);
                                        ...
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Editar"].X, botonesNavegador["Editar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        CrudKed3item.KEd3itemCRUD(desktopSession, crudVariables, 1);
                                        Thread.Sleep(1000);
                                        newFunctions_4.ScreenshotNuevo("Registro Editado", true, file);
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Cancelar"].X, botonesNavegador["Cancelar"].Y);
                                        desktopSession.Mouse.Click(null);
        ...
        public void KEd3relaCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosED.ModulosED_1.KEd3relaCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            ...
                            if (
                                ...
                                rows["TipoEvaluador"].ToString().Length != 0 && rows["TipoEvaluador"].ToString() != null &&
                                rows["EvaluadorLupa"].ToString().Length != 0 && rows["EvaluadorLupa"].ToString() != null &&
                                rows["EditEvaluador"].ToString().Length != 0 && rows["EditEvaluador"].ToString() != null &&
                                rows["EvaluadorVali"].ToString().Length != 0 && rows["EvaluadorVali"].ToString() != null &&
                                rows["EditEvaluadorVali"].ToString().Length != 0 && rows["EditEvaluadorVali"].ToString() != null
                                )
                            {
                                ...
                                string tipoEvaluador = rows["TipoEvaluador"].ToString();
                                string evaluadorLupa = rows["EvaluadorLupa"].ToString();
                                string editEvaluador = rows["EditEvaluador"].ToString();

                                string evaluadorVali = rows["EvaluadorVali"].ToString();
                                string editEvaluadorVali = rows["EditEvaluadorVali"].ToString();

                                Dictionary<string, Point> botonesNavegador = new Dictionary<string, Point>();
                                Dictionary<string, Point> botonesNavegadorDet1 = new Dictionary<string, Point>();
                                Dictionary<string, Point> botonesNavegadorDet2 = new Dictionary<string, Point>();
                                List<string> crudVariables = new List<string>() { identificacion, tipoEvaluador, evaluadorLupa, editEvaluador };
                                List<string> crudVariablesDet1 = new List<string>() { };
                                WindowsDriver<WindowsElement> rootSession = null;
                                bool isErrorDisplayed = false;
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        desktopSession.Mouse.Click(null);
                                        Thread.Sleep(1000);
                                        CrudKed3rela.KEd3relaCRUD(desktopSession, crudVariables, 0);
                                        Thread.Sleep(5000);
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Aplicar"].X, botonesNavegador["Aplicar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        Thread.Sleep(2000);
                                        ...
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Editar"].X, botonesNavegador["Editar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        CrudKed3rela.KEd3relaCRUD(desktopSession, crudVariables, 1);
                                        Thread.Sleep(1000);
                                        newFunctions_4.ScreenshotNuevo("Registro Editado", true, file);
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Cancelar"].X, botonesNavegador["Cancelar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        ...
                                        newFunctions_4.ScreenshotNuevo("Edición Descartada", true, file);
                                        //Validacion Editar Descartar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, identificacion, evaluadorVali, editCampo, c, ErrorValidacion, "No se edito correctamente", 1);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionLogbo(Tabla, motor, user, Campo, identificacion, "E", c, ErrorValidacion);
                                        //Validacion Editar Aceptar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, identificacion, editEvaluadorVali, editCampo, c, ErrorValidacion, "El registro no se editó correctamente", 1);
                                        Thread.Sleep(1000);
        ...
        public void KEd3evexCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosED.ModulosED_1.KEd3evexCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            ...
                            if (
                                ...
                                rows["BanderaPreli"].ToString().Length != 0 && rows["BanderaPreli"].ToString() != null &&
                                rows["Identificacion"].ToString().Length != 0 && rows["Identificacion"].ToString() != null &&
                                rows["Nombres"].ToString().Length != 0 && rows["Nombres"].ToString() != null &&
                                rows["Apellidos"].ToString().Length != 0 && rows["Apellidos"].ToString() != null &&
                                rows["Organizacion"].ToString().Length != 0 && rows["Organizacion"].ToString() != null &&
                                rows["Descripcion"].ToString().Length != 0 && rows["Descripcion"].ToString() != null &&
                                rows["EditOrganizacion"].ToString().Length != 0 && rows["EditOrganizacion"].ToString() != null
                                )
                            {
                                ...
                                string identificacion = rows["Identificacion"].ToString();
                                string nombres = rows["Nombres"].ToString();
                                string apellidos = rows["Apellidos"].ToString();
                                string organizacion = rows["Organizacion"].ToString();
                                string descripcion = rows["Descripcion"].ToString();
                                string editOrganizacion = rows["EditOrganizacion"].ToString();


                                Dictionary<string, Point> botonesNavegador = new Dictionary<string, Point>();
                                Dictionary<string, Point> botonesNavegadorDet1 = new Dictionary<string, Point>();
                                Dictionary<string, Point> botonesNavegadorDet2 = new Dictionary<string, Point>();
                                List<string> crudVariables = new List<string>() { identificacion, nombres, apellidos, organizacion, descripcion, editOrganizacion };
                                List<string> crudVariablesDet1 = new List<string>() { };
                                WindowsDriver<WindowsElement> rootSession = null;
                                bool isErrorDisplayed = false;
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        desktopSession.Mouse.Click(null);
                                        Thread.Sleep(1000);
                                        CrudKed3evex.KEd3evexCRUD(desktopSession, crudVariables, 0);
                                        Thread.Sleep(5000);
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Aplicar"].X, botonesNavegador["Aplicar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        Thread.Sleep(2000);
                                        ...
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Editar"].X, botonesNavegador["Editar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        CrudKed3evex.KEd3evexCRUD(desktopSession, crudVariables, 1);
                                        Thread.Sleep(1000);
                                        newFunctions_4.ScreenshotNuevo("Registro Editado", true, file);
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Cancelar"].X, botonesNavegador["Cancelar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        ...
                                        newFunctions_4.ScreenshotNuevo("Edición Descartada", true, file);
                                        //Validacion Editar Descartar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, identificacion, organizacion, editCampo, c, ErrorValidacion, "No se edito correctamente", 1);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionLogbo(Tabla, motor, user, Campo, identificacion, "E", c, ErrorValidacion);
                                        //Validacion Editar Aceptar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, identificacion, editOrganizacion, editCampo, c, ErrorValidacion, "El registro no se editó correctamente", 1);
                                        Thread.Sleep(1000);
        ...
        public void KEd3escaCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosED.ModulosED_1.KEd3escaCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            ...
                            if (
                                ...
                                rows["Descripcion"].ToString().Length != 0 && rows["Descripcion"].ToString() != null &&
                                rows["EditDescripcion"].ToString().Length != 0 && rows["EditDescripcion"].ToString() != null &&
                                rows["ValorInicial"].ToString().Length != 0 && rows["ValorInicial"].ToString() != null &&
                                rows["ValorFinal"].ToString().Length != 0 && rows["ValorFinal"].ToString() != null &&
                                ...
                                rows["EditDescripcionDet"].ToString().Length != 0 && rows["EditDescripcionDet"].ToString() != null
                                )
                            {
                                ...
                                string valorInicial = rows["ValorInicial"].ToString();
                                string valorFinal = rows["ValorFinal"].ToString();
                                string escala = rows["Escala"].ToString();
                                string descripcionDet = rows["DescripcionDet"].ToString();
                                string editDescripcionDet = rows["EditDescripcionDet"].ToString();
