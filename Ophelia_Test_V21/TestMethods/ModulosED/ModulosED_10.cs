...
{
    /// <summary>
    /// Descripción resumida de ModulosED_10
    /// </summary>
    [TestClass]
    public class ModulosED_10 : FuncionesVitales
    {
        ...
        public void KEdRjeasChecklist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosED.ModulosED_10.KEdRjeasChecklist")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["Num1"].ToString().Length != 0 && rows["Num1"].ToString() != null &&
                                rows["Fecha"].ToString().Length != 0 && rows["Fecha"].ToString() != null &&
                                rows["EditFecha"].ToString().Length != 0 && rows["EditFecha"].ToString() != null &&
...

                            {
                                ...
                                string Num1 = rows["Num1"].ToString();
                                string Fecha = rows["Fecha"].ToString();
                                string EditFecha = rows["EditFecha"].ToString();
                                ...
                                try
                                {
                                    ...
                                    //CRUD
                                    List<string> crudPrincipal = new List<string>() { Num1, Fecha, EditFecha };
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKedrjeas.Agregarcrud(desktopSession, 0, crudPrincipal);
