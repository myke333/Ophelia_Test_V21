...
{
    /// <summary>
    /// Descripción resumida de ModulosED_5
    /// </summary>
    [TestClass]
    public class ModulosED_5 : FuncionesVitales
    {
        ...
        public void KEdEsevaChecklist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosED.ModulosED_5.KEdEsevaChecklist")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["valorIni"].ToString().Length != 0 && rows["valorIni"].ToString() != null &&
                                rows["valorFin"].ToString().Length != 0 && rows["valorFin"].ToString() != null &&
                                rows["escala"].ToString().Length != 0 && rows["escala"].ToString() != null &&
                                rows["descrip"].ToString().Length != 0 && rows["descrip"].ToString() != null &&
                                rows["editDescipt"].ToString().Length != 0 && rows["editDescipt"].ToString() != null)
                            {
                                ...
                                string valorIni = rows["valorIni"].ToString();
                                string valorFin = rows["valorFin"].ToString();
                                string escala = rows["escala"].ToString();
                                string descrip = rows["descrip"].ToString();
                                string editDescipt = rows["editDescipt"].ToString();
                                
                                List<string> cabecera = new List<string> { tipo, nombre, editNombre };
                                List<string> detalle = new List<string> { valorIni, valorFin, escala, descrip, editDescipt };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKedeseva.CrudKEdeseva(desktopSession, 1, cabecera);
                                        ...
                                        CrudKedeseva.CrudKEdeseva(desktopSession, 2, cabecera);
                                        ...
                                        //Validacion Editar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, tipo, nombre, campoEdit, c, ErrorValidacion, "No se descartó correctamente", 1);
                                        ...
                                        //Validacion Editar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, tipo, editNombre, campoEdit, c, ErrorValidacion, "No se editó correctamente", 1);
                                        ...
                                        CrudKedeseva.CrudKEdesevaDetalle(desktopSession, 1, detalle);
                                        ...
                                        CrudKedeseva.CrudKEdesevaDetalle(desktopSession, 2, detalle);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        //Validacion Eliminar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, tipo, "", Campo, c, ErrorValidacion, "No se eliminó correctamente", 2);
                                    }
                                    else
                                    {
