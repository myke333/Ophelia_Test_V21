...
namespace Ophelia_Test_V21.TestMethods.ModulosED
{
    ...
    [TestClass]
    public class ModulosED_7 : FuncionesVitales
    {
        ...
        public void KEdPmoevChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosED.ModulosED_7.KEdPmoevChecKlist")
                {
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CurdKedpmoev.AgregarCrud(desktopSession);
                                        ...
                                        CurdKedpmoev.Click(desktopSession);
                                        Thread.Sleep(1500);


                                        newFunctions_4.ScreenshotNuevo("pantalla1", true, file);
                                        CurdKedpmoev.Enter(desktopSession);
                                        Thread.Sleep(1500);
        ...
        public void KFdReporChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosED.ModulosED_7.KFdReporChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void KEd3MocaChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosED.ModulosED_7.KEd3MocaChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKed3moca.AgregarCrud(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("lupas", true, file);
                                        ...
                                        // Click Btn Aceptar
                                        CrudKed3moca.ClickBtnAceptar(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Aceptar", true, file);
                                        Thread.Sleep(1000);

                                        newFunctions_4.ScreenshotNuevo("Guardar archivo ", true, file);
                                        CrudKed3moca.SaveArchivo(desktopSession);
                                        Thread.Sleep(1000);

                                        CrudKed3moca.Enter(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Se termina el proceso ", true, file);
                                        Thread.Sleep(1000);

                                        newFunctions_4.ScreenshotNuevo("Ventana 1", true, file);
                                        CrudKed3moca.VentanaClose(desktopSession);
                                        Thread.Sleep(1000);


                                        CrudKed3moca.BtnListado(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Listado", true, file);
                                        Thread.Sleep(1000);
