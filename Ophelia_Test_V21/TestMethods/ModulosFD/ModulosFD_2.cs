...
{
    /// <summary>
    /// Descripción resumida de ModulosFD_2
    /// </summary>
    [TestClass]
    public class ModulosFD_2 : FuncionesVitales
    {
        ...
        public void KFdPargeCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosFD.ModulosFD_2.KFdPargeCheckList")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            ...
                            if (
                                ...
                                rows["ServidorArchivos"].ToString().Length != 0 && rows["ServidorArchivos"].ToString() != null &&
                                rows["Conceptos"].ToString().Length != 0 && rows["Conceptos"].ToString() != null &&
                                ...
                                )
                            {
                                ...
                                string servidorArchivos = rows["ServidorArchivos"].ToString();
                                string conceptos = rows["Conceptos"].ToString();
                                string motivo = rows["Motivo"].ToString();
                                string tipo = rows["Tipo"].ToString();
                                string editTipo = rows["EditTipo"].ToString();

                                Dictionary<string, Point> botonesNavegador = new Dictionary<string, Point>();
                                List<string> crudVariables = new List<string> { conceptos, motivo, servidorArchivos, tipo, editTipo };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        desktopSession.Mouse.Click(null);
                                        CrudKfdparge.KFdPargeCRUD(desktopSession, crudVariables, 0);
                                        Thread.Sleep(5000);
                                        ...
                                        desktopSession.Mouse.Click(null);
                                        CrudKfdparge.KFdPargeCRUD(desktopSession, crudVariables, 1);
                                        Thread.Sleep(1000);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, identificacion, tipo.Substring(0,1), editCampo, c, ErrorValidacion, "No se edito correctamente", 1);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, identificacion, editTipo.Substring(0,1), editCampo, c, ErrorValidacion, "El registro no se editó correctamente", 1);
                                        Thread.Sleep(1000);
        ...
        public void KFdEnfunCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosFD.ModulosFD_2.KFdEnfunCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void KFdRpcapCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosFD.ModulosFD_2.KFdRpcapCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                                ...
                                )
                            {
                                ...
                                string BanderaSum = rows["BanderaSum"].ToString();
                                string BanderaPreli = rows["BanderaPreli"].ToString();
                                string radioButton = rows["RadioName"].ToString();

                                Dictionary<string, Point> botonesNavegador = new Dictionary<string, Point>();
                                List<string> crudVariables = new List<string> { radioButton };
                                bool isErrorDisplayed = false;
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        //Datos
                                        CrudKfdrpcap.KFdRpcapCRUD(desktopSession, crudVariables);
        ...
        public void KFdItevaCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosFD.ModulosFD_2.KFdItevaCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            ...
                            if (
                                ...
                                rows["BanderaPreli"].ToString().Length != 0 && rows["BanderaPreli"].ToString() != null &&
                                rows["Identificacion"].ToString().Length != 0 && rows["Identificacion"].ToString() != null &&
                                rows["NombreEvaluacion"].ToString().Length != 0 && rows["NombreEvaluacion"].ToString() != null &&
                                rows["DirigidoA"].ToString().Length != 0 && rows["DirigidoA"].ToString() != null &&
                                rows["Tipo"].ToString().Length != 0 && rows["Tipo"].ToString() != null &&
                                rows["Clasificacion"].ToString().Length != 0 && rows["Clasificacion"].ToString() != null &&
                                rows["EditTipo"].ToString().Length != 0 && rows["EditTipo"].ToString() != null &&
                                rows["Detalle1"].ToString().Length != 0 && rows["Detalle1"].ToString() != null &&
                                rows["Nombre"].ToString().Length != 0 && rows["Nombre"].ToString() != null &&
                                rows["Puntaje"].ToString().Length != 0 && rows["Puntaje"].ToString() != null &&
                                rows["Val1"].ToString().Length != 0 && rows["Val1"].ToString() != null &&
                                rows["EditVal1"].ToString().Length != 0 && rows["EditVal1"].ToString() != null
                                ...
                                )
                            {
                                ...
                                string nombreEvaluacion = rows["NombreEvaluacion"].ToString();
                                string dirigidoA = rows["DirigidoA"].ToString();
                                string tipo = rows["Tipo"].ToString();
                                string clasificacion = rows["Clasificacion"].ToString();
                                string editTipo = rows["EditTipo"].ToString();

                                string detalle1 = rows["Detalle1"].ToString();
                                string editDetalle1 = rows["EditDetalle1"].ToString();
                                string nombre = rows["Nombre"].ToString();
                                string puntaje = rows["Puntaje"].ToString();
                                string val1 = rows["Val1"].ToString();
                                string editVal1 = rows["EditVal1"].ToString();
                                ...
                                List<string> crudVariables = new List<string> { nombreEvaluacion, dirigidoA, tipo, clasificacion };
                                List<string> crudVariablesDet1 = new List<string> { detalle1, editDetalle1 };
                                List<string> crudVariablesDet2 = new List<string> { nombre, puntaje, val1, editVal1 };
                                bool isErrorDisplayed = false;
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Insertar"].X, botonesNavegador["Insertar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        CrudKfditeva.KFdItevaCRUD(desktopSession, crudVariables, editTipo, 0);
                                        Thread.Sleep(5000);
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Aplicar"].X, botonesNavegador["Aplicar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        Thread.Sleep(2000);
                                        ...
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Editar"].X, botonesNavegador["Editar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        CrudKfditeva.KFdItevaCRUD(desktopSession, crudVariables, editTipo, 1);
                                        Thread.Sleep(1000);
                                        newFunctions_4.ScreenshotNuevo("Registro Editado", true, file);
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Cancelar"].X, botonesNavegador["Cancelar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        ...
                                        Thread.Sleep(1000);
                                        ///
                                        botonesNavegadorDet1 = PruebaCRUD.findname(desktopSession, 30, 2);
                                        ...
                                        desktopSession.Mouse.Click(null);
                                        CrudKfditeva.KFdItevaCRUDDet1(desktopSession, crudVariablesDet1, 0, 0);
                                        Thread.Sleep(5000);
                                        ...
                                        desktopSession.Mouse.Click(null);
                                        CrudKfditeva.KFdItevaCRUDDet1(desktopSession, crudVariablesDet1, 1, 1);
                                        Thread.Sleep(1000);
                                        newFunctions_4.ScreenshotNuevo("Registro Editado Detalle 1", true, file);
                                        desktopSession.Mouse.MouseMove(ElementList[2].Coordinates, botonesNavegadorDet1["Cancelar"].X, botonesNavegadorDet1["Cancelar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        Thread.Sleep(2000);
                                        newFunctions_4.ScreenshotNuevo("Registro Descartado Detalle 1", true, file);

                                        /////ACEPTAR EDICION DETALLE
                                        desktopSession.Mouse.MouseMove(ElementList[2].Coordinates, botonesNavegadorDet1["Editar"].X, botonesNavegadorDet1["Editar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        CrudKfditeva.KFdItevaCRUDDet1(desktopSession, crudVariablesDet1, 1, 0);
                                        Thread.Sleep(1000);
                                        desktopSession.Mouse.MouseMove(ElementList[2].Coordinates, botonesNavegadorDet1["Aplicar"].X, botonesNavegadorDet1["Aplicar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        Thread.Sleep(2000);
                                        ...
                                        botonesNavegadorDet2 = PruebaCRUD.findname(desktopSession, 30, 1);
                                        ElementList = PruebaCRUD.NavClass(desktopSession);
                                        ...
                                        desktopSession.Mouse.Click(null);
                                        CrudKfditeva.KFdItevaCRUDDet2(desktopSession, crudVariablesDet2, 0);
                                        Thread.Sleep(5000);
                                        ...
                                        desktopSession.Mouse.Click(null);
                                        CrudKfditeva.KFdItevaCRUDDet2(desktopSession, crudVariablesDet2, 1);
                                        Thread.Sleep(1000);
