...
{
    /// <summary>
    /// Descripción resumida de ModulosFD_6
    /// </summary>
    [TestClass]
    public class ModulosFD_6:FuncionesVitales
    {
        ...
        public void KFdSesioCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosFD.ModulosFD_6.KFdSesioCheckList")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["NombreCur"].ToString().Length != 0 && rows["NombreCur"].ToString() != null &&
                                ...
                                )
                            {
                                ...
                                string NombreCur = rows["NombreCur"].ToString();
                                string EditarNombre = rows["EditarNombre"].ToString();

                                List<string> crudVariables = new List<string>() { Codigo, NombreCur, EditarNombre };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKfdsesio.CRUD(desktopSession, 1, crudVariables, file);
                                        ...
                                        CrudKfdsesio.CRUD(desktopSession, 2, crudVariables, file);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, NombreCur, "NOM_SESI", c, ErrorValidacion, "No se edito correctamente", 1);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, EditarNombre, "NOM_SESI", c, ErrorValidacion, "El registro no se editó correctamente", 1);
        ...
        public void KFdRepfdCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosFD.ModulosFD_6.KFdRepfdCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                                ...
                                )
                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        //SELECCIONAR TIPO  REGISTRO
                                        CrudKfdrepfd.CRUD(desktopSession, file);
                                        Thread.Sleep(2000);
                                        ...
                                        //REPORTE PRELIMINAR
                                        string pdf1 = @"C:\Reportes\ReportePDF1_" + "Preliminar" + "_" + Hora();
                                        CrudKfdrepfd.BotonPreliminar(desktopSession, file);
                                        Thread.Sleep(4000);
        ...
        public void KFdProgrCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosFD.ModulosFD_6.KFdProgrCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                                ...
                                )
                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Insertar"].X, botonesNavegador["Insertar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        CrudKfdprogr.CRUD(desktopSession, 1, crudVariables, file);
                                        ...
                                        CrudKfdprogr.CRUD(desktopSession, 2, crudVariables, file);
                                        ...
                                        //Validacion Editar Descartar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, NombreCur, "NOM_PROG", c, ErrorValidacion, "No se edito correctamente", 1);
        ...
        public void KFdCursoCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosFD.ModulosFD_6.KFdCursoCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["Codigo"].ToString().Length != 0 && rows["Codigo"].ToString() != null &&
                                rows["NombreCur"].ToString().Length != 0 && rows["NombreCur"].ToString() != null &&
                                rows["CursoAso"].ToString().Length != 0 && rows["CursoAso"].ToString() != null &&
                                ...
                                )
                            {
                                ...
                                string Codigo = rows["Codigo"].ToString();
                                string NombreCur = rows["NombreCur"].ToString();
                                string CursoAso = rows["CursoAso"].ToString();
                                ...
                                List<string> crudVariables = new List<string>() { Codigo, NombreCur, CursoAso, Valor, EditarNombre};
                                List<string> crudDetalle = new List<string> { Registro, Requisito, Especificacion };
                                //CREAR EL DOCUMENTO DEL REPORTE DE LA PRUEBA
                                string file = CrearDocumentoWordDinamico(codProgram, "FD", motor);
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Insertar"].X, botonesNavegador["Insertar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        CrudKfdcurso.CRUD(desktopSession, 1, crudVariables, file);
                                        ...
                                        CrudKfdcurso.CRUD(desktopSession, 2, crudVariables, file);
                                        ...
                                        //Validacion Editar Descartar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, NombreCur, "NOM_CURS", c, ErrorValidacion, "No se edito correctamente", 1);
                                        ...
                                        // //Debugger.Launch();
                                        ErrorValidacion = ValidacionesQueries.ValidacionLogbo(Tabla, motor, user, Campo, Codigo, "E", c, ErrorValidacion);
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, EditarNombre, "NOM_CURS", c, ErrorValidacion, "El registro no se editó correctamente", 1);
                                        ...
                                        CrudKfdcurso.CrudDetalle(desktopSession, 1, crudDetalle, file);
