...
namespace Ophelia_Test_V21.TestMethods.ModulosGD
{
    ...
    [TestClass]
    public class ModulosGD_1 : FuncionesVitales
    {
        ...
        public void KGdPemveCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosGD.ModulosGD_1.KGdPemveCheckList")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            ...
                            if (
                                ...
                                rows["NumEmpresa"].ToString().Length != 0 && rows["NumEmpresa"].ToString() != null &&
                                ...
                                rows["EditFechaFin"].ToString().Length != 0 && rows["EditFechaFin"].ToString() != null &&
                                ...
                                )
                            {
                                ...
                                string numEmpresa = rows["NumEmpresa"].ToString();
                                string consecutivo = rows["Consecutivo"].ToString();
                                string fechaFin = rows["FechaFin"].ToString();
                                string editFechaFin = rows["EditFechaFin"].ToString();
                                ...
                                Modulo = "GD";
                                List<string> crudVariables = new List<string>() { numEmpresa, consecutivo, fechaFin, editFechaFin };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKgdpemve.CRUD(desktopSession, 1, crudVariables, file);
                                        ...
                                        CrudKgdpemve.CRUD(desktopSession, 2, crudVariables, file);
                                        ...
                                        //ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, QbeFilter, fechaFin, EditCampo, c, ErrorValidacion, "No se edito correctamente", 1);
                                        ...
                                        //ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, QbeFilter, editFechaFin, EditCampo, c, ErrorValidacion, "El registro no se editó correctamente", 1);
