...
namespace Ophelia_Test_V21.TestMethods.ModulosGD
{
    ...
    /// <summary>
    /// Descripción resumida de ModulosGD_3
    /// </summary>
    [TestClass]
    public class ModulosGD_3 : FuncionesVitales
    {
        ...
        public void KGdPemaiCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosGD.ModulosGD_3.KGdPemaiCheckList")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            ...
                            if (
                                ...
                                rows["CuerpoEditar"].ToString().Length != 0 && rows["CuerpoEditar"].ToString() != null &&
                                ...
                                )
                            {
                                ...
                                string CuerpoEditar = rows["CuerpoEditar"].ToString();
                                //VARIABLES DETALLE 1
                                string Codigo = rows["Codigo"].ToString();
                                string Nombre = rows["Nombre"].ToString();
                                string NombreEditar = rows["NombreEditar"].ToString();

                                List<string> crudVariables = new List<string>() { Asunto, Cuerpo, CuerpoEditar };

                                List<string> crudVariablesdet1 = new List<string>() { Codigo, Nombre, NombreEditar };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        //CLic pestaña Conceptos Finales
                                        desktopSession.FindElementByName("Conceptos Finales").Click();
                                        ...
                                        //CLic pestaña Correo
                                        desktopSession.FindElementByName("Correo").Click();
                                        ...
                                        //ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Asunto, "", "MAI_ASUN", c, ErrorValidacion, "los datos no se encontraron correctamente", 2);

                                        //CONSULTA DE DELETE DE AUDITORIA GN_LOGBO CABECERA
                                        //ErrorValidacion = ValidacionesQueries.ValidacionLogbo(Tabla, motor, user, Campo, Asunto, "D", c, ErrorValidacion);

                                        //////AGREGAR REGISTRO            
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Insertar"].X, botonesNavegador["Insertar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        CrudKgdpemai.CRUDKGdPemai(desktopSession, 1, crudVariables, file, motor);
                                        ...
                                        //Validacion Agregar
                                        //ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Asunto, Asunto, "MAI_ASUN", c, ErrorValidacion, "No se agregó correctamente", 0);

                                        //DESCARTAR EDICION
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Editar"].X, botonesNavegador["Editar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        CrudKgdpemai.CRUDKGdPemai(desktopSession, 2, crudVariables, file,motor);
                                        ...
                                        //ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Asunto, Cuerpo, "MAI_CUER", c, ErrorValidacion, "No se edito correctamente", 1);
                                        ...
                                        //ErrorValidacion = ValidacionesQueries.ValidacionLogbo(Tabla, motor, user, Campo, Asunto, "E", c, ErrorValidacion);

                                        //Validacion Editar Aceptar
                                        //ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Asunto, CuerpoEditar, "MAI_CUER", c, ErrorValidacion, "El registro no se editó correctamente", 1);

                                        //PASAR DETALLE 1
                                        var TPageControl = desktopSession.FindElementsByClassName("TPageControl");
                                        desktopSession.Mouse.MouseMove(TPageControl[0].Coordinates, 20, 5);
                                        desktopSession.Mouse.Click(null);
                                        ...
                                        desktopSession.Mouse.Click(null);
                                        CrudKgdpemai.CRUDDetalle1KGdPemai(desktopSession, 1, crudVariablesdet1, file);
                                        ...
                                        desktopSession.Mouse.Click(null);
                                        CrudKgdpemai.CRUDDetalle1KGdPemai(desktopSession, 2, crudVariablesdet1, file);
                                        ...
                                        string COD_EMPRAUX = ValidacionesQueries.CodEmpresa(Tabla, user, motor, Campo, Asunto, c);
                                        ...
                                        Thread.Sleep(500);
                                        PruebaCRUD.EliminarRegistro(desktopSession, ElementList[1], botonesNavegador, file);
                                        newFunctions_4.ScreenshotNuevo("Eliminar Detalle", true, file);
