...
{
    /// <summary>
    /// Descripción resumida de ModulosGN_1
    /// NataliaC
    /// </summary>
    [TestClass]
    public class ModulosGN_1 : FuncionesVitales
    {
        ...
        public void KGnFlujoCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosGN.ModulosGN_1.KGnFlujoCheckList")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                                ...
                                rows["Campo"].ToString().Length != 0 && rows["Campo"].ToString() != null)
                            {
                                ...
                                List<string> crudPrincipal = new List<string>() { Codigo, Estado, Nombre, Editar };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKgnflujo.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        ...
                                        CrudKgnflujo.AgregarCrud(desktopSession, 1, crudPrincipal);
        ...
        public void KGnGusuaCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosGN.ModulosGN_1.KGnGusuaCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                                ...
                                )
                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKgngusua.CRUDKgngusua(desktopSession, 1, crudVariables);
                                        ...
                                        CrudKgngusua.CRUDKgngusua(desktopSession, 2, crudVariables);
                                        ...
                                        //Validacion Editar Descartar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, Nombre, "NOM_GUSU", c, ErrorValidacion, "No se descarto correctamente", 1);
                                        ...
                                        Thread.Sleep(1000);
                                        ErrorValidacion = ValidacionesQueries.ValidacionLogbo(Tabla, motor, user, Campo, Codigo, "E", c, ErrorValidacion);
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, Editar, "NOM_GUSU", c, ErrorValidacion, "El registro no se editó correctamente", 1);

                                        Thread.Sleep(1000);

                                        //QBE
                                        errors = FuncionesGlobales.QBEQry(desktopSession, TipoQbe, Codigo, file);
                                        if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }
        ...
        public void KGnHabdaCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosGN.ModulosGN_1.KGnHabdaCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                                ...
                                )
                            {
                                ...
                                string Editar = rows["Editar"].ToString();
                                List<string> crudVariables = new List<string>() { Codigo, Tipo, Texto, Editar };
                                //CREAR EL DOCUMENTO DEL REPORTE DE LA PRUEBA
                                string file = CrearDocumentoWordDinamico(codProgram, "GN", motor);
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKgnhabda.CRUDKgnhabda(desktopSession, 1, crudVariables);
                                        ...
                                        CrudKgnhabda.CRUDKgnhabda(desktopSession, 2, crudVariables);
                                        newFunctions_4.ScreenshotNuevo("Editar Registro", true, file);
                                        ...
                                        //Validacion Editar Descartar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, Tipo, "TIP_OLOG", c, ErrorValidacion, "No se descarto correctamente", 1);
                                        ...
                                        Thread.Sleep(1000);
                                        ErrorValidacion = ValidacionesQueries.ValidacionLogbo(Tabla, motor, user, Campo, Codigo, "E", c, ErrorValidacion);
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, Editar, "TIP_OLOG", c, ErrorValidacion, "El registro no se editó correctamente", 1);
        ...
        public void KGnHttseCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosGN.ModulosGN_1.KGnHttseCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["IDK"].ToString().Length != 0 && rows["IDK"].ToString() != null &&
                                rows["IDS"].ToString().Length != 0 && rows["IDS"].ToString() != null &&
                                rows["IDO"].ToString().Length != 0 && rows["IDO"].ToString() != null &&
                                rows["Editar"].ToString().Length != 0 && rows["Editar"].ToString() != null
...

                            {
                                ...
                                string IDK = rows["IDK"].ToString();
                                string IDS = rows["IDS"].ToString();
                                string IDO = rows["IDO"].ToString();
                                string Editar = rows["Editar"].ToString();
                                List<string> crudPrincipal = new List<string>() { IDK, IDS, IDO, Editar };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKgnhttse.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKgnhttse.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
        ...
        public void KGnInfnoCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosGN.ModulosGN_1.KGnInfnoCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["Codigo"].ToString().Length != 0 && rows["Codigo"].ToString() != null &&
                                rows["Asunto"].ToString().Length != 0 && rows["Asunto"].ToString() != null &&
                                rows["Cuerpo"].ToString().Length != 0 && rows["Cuerpo"].ToString() != null &&
                                rows["Editar"].ToString().Length != 0 && rows["Editar"].ToString() != null
                                ...
                                )
                            {
                                ...
                                string Codigo = rows["Codigo"].ToString();
                                string Asunto = rows["Asunto"].ToString();
                                string Cuerpo = rows["Cuerpo"].ToString();
                                string Editar = rows["Editar"].ToString();
                                List<string> crudVariables = new List<string>() { Codigo, Asunto, Cuerpo, Editar };
                                //CREAR EL DOCUMENTO DEL REPORTE DE LA PRUEBA
                                string file = CrearDocumentoWordDinamico(codProgram, "GN", motor);
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKgninfno.CRUDKgninfno(desktopSession, 1, crudVariables);
                                        ...
                                        CrudKgninfno.CRUDKgninfno(desktopSession, 2, crudVariables);
                                        newFunctions_4.ScreenshotNuevo("Editar Registro", true, file);
                                        ...
                                        //Validacion Editar Descartar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, Asunto, "ASU_NTOM", c, ErrorValidacion, "No se descarto correctamente", 1);
                                        ...
                                        Thread.Sleep(1000);
                                        ErrorValidacion = ValidacionesQueries.ValidacionLogbo(Tabla, motor, user, Campo, Codigo, "E", c, ErrorValidacion);
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, Editar, "ASU_NTOM", c, ErrorValidacion, "El registro no se editó correctamente", 1);
        ...
        public void KGnInfscCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosGN.ModulosGN_1.KGnInfscCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                                ...
                                )
                            {
                                ...
                                string Nombre = rows["Nombre"].ToString();
                                string Editar = rows["Editar"].ToString();
                                List<string> crudVariables = new List<string>() { Codigo, NIT, Digito, Nombre, Editar };
                                //CREAR EL DOCUMENTO DEL REPORTE DE LA PRUEBA
                                string file = CrearDocumentoWordDinamico(codProgram, "GN", motor);
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKgninfsc.CRUDKgninfsc(desktopSession, 1, crudVariables);
                                        ...
                                        CrudKgninfsc.CRUDKgninfsc(desktopSession, 2, crudVariables);
                                        newFunctions_4.ScreenshotNuevo("Editar Registro", true, file);
                                        ...
                                        //Validacion Editar Descartar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, Nombre, "NOM_SECC", c, ErrorValidacion, "No se descarto correctamente", 1);
                                        ...
                                        Thread.Sleep(1000);
                                        ErrorValidacion = ValidacionesQueries.ValidacionLogbo(Tabla, motor, user, Campo, Codigo, "E", c, ErrorValidacion);
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, Editar, "NOM_SECC", c, ErrorValidacion, "El registro no se editó correctamente", 1);
