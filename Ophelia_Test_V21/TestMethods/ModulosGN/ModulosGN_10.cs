...
{
    /// <summary>
    /// Descripción resumida de ModulosGN_10
    /// </summary>
    [TestClass]
    public class ModulosGN_10 : FuncionesVitales
    {
        ...
        public void abrirprograma()
        {
            ...
            string motor = "SQL";
            var prog = "KNmNoema";
            AbrirPrograma a = new AbrirPrograma(prog, "KNEAUTOM");
            ...
            errors = FuncionesGlobales.QBEQry(desktopSession, "0", "1985163", file);
            Thread.Sleep(5000);
            ...
            var CajaVacaciones1 = desktopSession.FindElementsByClassName("TDBGrid");
            ...
            //var Cajita = desktopSession.FindElementsByClassName("TDBGridInplaceEdit");
            //Cajita[0].Click();
            //string var1 = Cajita[0].Text;
            //CajaVacaciones[0].Click();
            //string var2 = CajaVacaciones[0].Text;
            CajaVacaciones1[0].Click();
            CajaVacaciones1[0].Click();
            string var3 = CajaVacaciones1[0].Text;
            Thread.Sleep(50000);
            ////ARRANCAR EN SQL *Ejemplo con KGnProgr
            //string motor = "SQL";
            //AbrirPrograma a = new AbrirPrograma("KNmcontr", "ADesar2");
            //string file = CrearDocumentoWordDinamico("KNmCesen", "PruebasCrud", motor);
            //List<string> crudVariables = new List<string> { "1", "Parciales Empresa", "20/07/2021", "40000000" };

            ////string BanderaPreli = "1";
            ////string banExcel = "0";
            ////string codProgram = "KGnPergu";
            //////ARRANCAR EN ORA (NO FUNCIONA - NO DEJA ELIMINAR)
            ////string motor = "ORA";
            ////AbrirPrograma a = new AbrirPrograma("KBpMopre", "ODESAR");
            ////string file = CrearDocumentoWordDinamico("KGnProgr", "PruebasCrud", motor);
            ////List<string> crudVariables = new List<string> { "QWERTY", "HANN", "1", "SHADOW", "HWAA" };
            ...
            //Thread.Sleep(1000);
            //////Debugger.Launch();
            //FuncionesKNmLices.AgregarCesantiasParciales(desktopSession, crudVariables, file);

            ////////-----------KGNPERGU----var = 114------//
            ////REPORTE PRELIMINAR DIFERENTE(2 OPCIONES)
            ////List<string> errors = new List<string>();
            ////string pdf1 = @"C:\Reportes\ReportePDF1_" + "Preliminar" + "_" + Hora();
            ////CrudKgnpergu.PreliKGnPergu(desktopSession, file, pdf1, BanderaPreli, crudVariables);

            ////REPORTE EXCEL
            ////string ruta = @"C:\Reportes\ExportarExcel" + "_" + codProgram + "_" + Hora();
            ////CrudKgnpergu.generarExcel(desktopSession, file, codProgram, ruta);
            ////////------------------------------//

            ////////-----------KGNPERMA----------//
            ////REPORTE PRELIMINAR DIFERENTE
            ////List<string> errors = new List<string>();
            ////string pdf1 = @"C:\Reportes\ReportePDF1_" + "Preliminar" + "_" + Hora();
            ////CrudKgnperma.PreliKGnPerma(desktopSession, file, pdf1, BanderaPreli, crudVariables);

            //////REPORTE EXCEL DIFERENTE
            ////string ruta = @"C:\Reportes\ExportarExcel" + "_" + codProgram + "_" + Hora();
            ////CrudKgnperma.ExcelKGnPerma(desktopSession, file, BanExcel, codProgram, crudVariables, ruta);
            //////------------------------------//
            ...
            //desktopSession.Mouse.Click(null);
            //CrudKgnprogr.CRUD(desktopSession, "0", crudVariables, file);
            ////-----------KGNTEMPR----------//
            //CrudKgntempr.CRUD(desktopSession, "0", crudVariables, file);
            //newFunctions_4.ScreenshotNuevo("Datos Insertados", true, file);
            //Thread.Sleep(1000);
            //CrudKgntempr.BotonAceptarConBarraProgreso(desktopSession, file);
            ////------------------------------//
            ///
            ////////APLICAR
            ...
            //CrudKgnprogr.CRUD(desktopSession, "1", crudVariables, file);
        ...
        public void KGnProgrCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosGN.ModulosGN_10.KGnProgrCheckList")
                {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                               ...
                               rows["Codigo"].ToString().Length != 0 && rows["Codigo"].ToString() != null &&
                                ...
                                rows["Ejecutable"].ToString().Length != 0 && rows["Ejecutable"].ToString() != null &&
                                rows["NombreEdit"].ToString().Length != 0 && rows["NombreEdit"].ToString() != null 
                           )

                            {
                                ...
                                string Ejecutable = rows["Ejecutable"].ToString();
                                string NombreEdit = rows["NombreEdit"].ToString();


                                //String Codigo = "9";

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Codigo, Nombre, Modulo, Ejecutable, NombreEdit };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKgnprogr.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        ...
                                        CrudKgnprogr.AgregarCrud(desktopSession, 1, crudPrincipal);
        ...
        public void KGnUtlapCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosGN.ModulosGN_10.KGnUtlapCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                //VARIABLES CRUD
                                rows["userKactus"].ToString().Length != 0 && rows["userKactus"].ToString() != null &&
                                rows["Programa"].ToString().Length != 0 && rows["Programa"].ToString() != null &&
                                rows["userSist"].ToString().Length != 0 && rows["userSist"].ToString() != null &&
                                rows["nombreMaq"].ToString().Length != 0 && rows["nombreMaq"].ToString() != null &&
                                rows["IPMaq"].ToString().Length != 0 && rows["IPMaq"].ToString() != null &&
                                rows["fechaIn"].ToString().Length != 0 && rows["fechaIn"].ToString() != null &&
                                rows["fechaOut"].ToString().Length != 0 && rows["fechaOut"].ToString() != null &&
                                rows["nombreMaqACT"].ToString().Length != 0 && rows["nombreMaqACT"].ToString() != null
                                )
                            {
                                string user = rows["User"].ToString();
                                string motor = rows["Motor"].ToString();
                                ...
                                string userKactus = rows["userKactus"].ToString();
                                string Programa = rows["Programa"].ToString();
                                string userSist = rows["userSist"].ToString();
                                string nombreMaq = rows["nombreMaq"].ToString();
                                string IPMaq = rows["IPMaq"].ToString();
                                string fechaIn = rows["fechaIn"].ToString();
                                string fechaOut = rows["fechaOut"].ToString();
                                string nombreMaqACT = rows["nombreMaqACT"].ToString();

                                List<string> crudVariables = new List<string>() { userKactus, Programa, userSist, nombreMaq, IPMaq, fechaIn, fechaOut, nombreMaqACT };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, userKactus, userKactus, Campo, c, ErrorValidacion, "No se agregó correctamente", 0,"1");
                                        ...
                                        CrudKgnutlap.CRUD(desktopSession, "0", crudVariables, file);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        ////VALIDACIÓN INSERTAR
                                        //ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, userKactus, userKactus, Campo, c, ErrorValidacion, "No se agregó correctamente", 0);
                                        Thread.Sleep(2000);
                                        //////EDITAR CAMBIOS (EDITAR - CANCELAR)
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Editar"].X, botonesNavegador["Editar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        ...
                                        CrudKgnutlap.CRUD(desktopSession, "1", crudVariables, file);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        //ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, userKactus, nombreMaq, EdCampo, c, ErrorValidacion, "No se edito correctamente", 1);
                                        ...
                                        Thread.Sleep(1500);
                                        //ErrorValidacion = ValidacionesQueries.ValidacionLogbo(Tabla, motor, user, Campo, userKactus, "E", c, ErrorValidacion);
                                        //ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, userKactus, nombreMaqACT, EdCampo, c, ErrorValidacion, "El registro no se editó correctamente", 1);
                                        ...
                                        */
                                        ...
                                        /*string COD_EMPRAUX = ValidacionesQueries.CodEmpresa(Tabla, user, motor, Campo, userKactus, c);
                                        ...
                                        PruebaCRUD.EliminarRegistro(desktopSession, ElementList[0], botonesNavegador, file);
                                        //VALIDACIÓN ELIMINAR REGISTRO
                                        //ErrorValidacion = ValidacionesQueries.ValidacionLogbo(Tabla, motor, user, Campo, userKactus, "D", c, ErrorValidacion);
                                        //ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, userKactus, "", Campo, c, ErrorValidacion, "los datos no se eliminaron correctamente", 2);
                                    }
                                    else
                                    {
                                        ErrorValidacion.Add($"El programa no puede ser leido : {codProgram}");
        ...
        {            
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosGN.ModulosGN_10.KGnTemprChecklist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                                ...
                                rows["NomProgram"].ToString().Length != 0 && rows["NomProgram"].ToString() != null)
                            {
                                ...
                                string empDestino = rows["empDestino"].ToString();

                                List<string> crudVariables = new List<string>() { empDestino };
        ...
        public void KGnPermaChecklist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosGN.ModulosGN_10.KGnPermaChecklist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                                ...
                                //rows["BanderaSum"].ToString().Length != 0 && rows["BanderaSum"].ToString() != null)
                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        //REPORTE PRELIMINAR DIFERENTE
                                        string pdf1 = @"C:\Reportes\ReportePDF1_" + "Preliminar" + "_" + Hora();
                                        errors = CrudKgnperma.PreliKGnPerma(desktopSession, file, pdf1, BanderaPreli, crudVariables);
                                        if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }
                                        //Rectificar Pie Pagina PDF PRELIMINAR
                                        listaResultado = Textopdf(pdf1, codProgram, user);
                                        listaResultado.ForEach(e => ErrorValidacion.Add(e));
        ...
        } //Preliminar y excel diferente (4 OPTIONS)

        [TestMethod]
        public void KGnPerguChecklist()
        {
            List<string> listaResultado;
            List<string> Celda = new List<string>();
            List<string> errorMessages = new List<string>();
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosGN.ModulosGN_10.KGnPerguChecklist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        } //revisar (Parecido al anterior KGnPerma)
