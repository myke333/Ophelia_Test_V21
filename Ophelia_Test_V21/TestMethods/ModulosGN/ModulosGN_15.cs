...
namespace Ophelia_Test_V21.TestMethods.ModulosGN
{
    ...
    [TestClass]
    public class ModulosGN_15 : FuncionesVitales
    {
        ...
        public void KGnTaplaChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosGN.ModulosGN_15.KGnTaplaChecKlist")
                {
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKgnTapla.CrudTapla(desktopSession, 0);
                                        newFunctions_4.ScreenshotNuevo("Selecionar datos", true, file);

                                        CrudKgnTapla.BotonAceptar(desktopSession, 0);
                                        Thread.Sleep(1500);
                                        CrudKgnTapla.BotonAceptar(desktopSession, 1);
                                        ...
                                        CrudKgnTapla.CrudTapla(desktopSession, 1);
                                        Thread.Sleep(1500);
                                        newFunctions_4.ScreenshotNuevo("Regresar datos", true, file);
                                        CrudKgnTapla.BotonAceptar(desktopSession, 0);
                                        Thread.Sleep(1500);
                                        CrudKgnTapla.BotonAceptar(desktopSession, 1);
        ...
        public void KGnPacdaChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosGN.ModulosGN_14.KGnTaplaChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
