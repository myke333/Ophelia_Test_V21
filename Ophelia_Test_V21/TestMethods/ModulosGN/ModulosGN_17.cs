...
{
    [TestClass]
    public class ModulosGN_17 : FuncionesVitales
    {
...

        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosGN.ModulosGN_17.KGnCwordChecKlist")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["cons"].ToString().Length != 0 && rows["cons"].ToString() != null &&
                                rows["formaP"].ToString().Length != 0 && rows["formaP"].ToString() != null &&
                                rows["nombreC"].ToString().Length != 0 && rows["nombreC"].ToString() != null &&
                                rows["rutaP"].ToString().Length != 0 && rows["rutaP"].ToString() != null &&
                                 rows["rutaD"].ToString().Length != 0 && rows["rutaD"].ToString() != null &&
                                rows["camposG"].ToString().Length != 0 && rows["camposG"].ToString() != null)

                            {
                                ...
                                string cons = rows["cons"].ToString();
                                string formaP = rows["formaP"].ToString();
                                string nombreC = rows["nombreC"].ToString();
                                string rutaP = rows["rutaP"].ToString();
                                string rutaD = rows["rutaD"].ToString();
                                string camposG = rows["camposG"].ToString();

                                //String Codigo = "9";

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { cons, formaP, nombreC, rutaP, rutaD, camposG };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKgncword.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        ...
                                        CrudKgncword.AgregarCrud(desktopSession, 1, crudPrincipal);
        ...
        public void KGnDtdtlChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosGN.ModulosGN_17.KGnDtdtlChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["R"].ToString().Length != 0 && rows["R"].ToString() != null &&
                                rows["tipo"].ToString().Length != 0 && rows["tipo"].ToString() != null &&
                                rows["nombre1"].ToString().Length != 0 && rows["nombre1"].ToString() != null &&
                                rows["fisica"].ToString().Length != 0 && rows["fisica"].ToString() != null &&
                                rows["digital"].ToString().Length != 0 && rows["digital"].ToString() != null &&

                                //Datos Crud principal
                                rows["division"].ToString().Length != 0 && rows["division"].ToString() != null &&
...

                            {
                                ...
                                string R = rows["R"].ToString();
                                string tipo = rows["tipo"].ToString();
                                string nombre1 = rows["nombre1"].ToString();
                                string fisica = rows["fisica"].ToString();
                                string digital = rows["digital"].ToString();

                                //Variables Crud principal
                                string division = rows["division"].ToString();
                                ...
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { division, nombre };
                                //LISTA DETALLE 1
                                List<string> crudDet1 = new List<string>() { R, tipo, nombre1, fisica, digital };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKgndtdtl.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKgndtdtl.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        //Thread.Sleep(1500);
                                        CrudKgndtdtl.AgregarCrud1(desktopSession, 0, crudDet1);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKgndtdtl.AgregarCrud1(desktopSession, 1, crudDet1);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
        ...
        public void KGnLanguChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosGN.ModulosGN_17.KGnLanguChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["nemotecnico"].ToString().Length != 0 && rows["nemotecnico"].ToString() != null &&
                                rows["nombre"].ToString().Length != 0 && rows["nombre"].ToString() != null &&
                                rows["cont"].ToString().Length != 0 && rows["cont"].ToString() != null &&
                                rows["cont1"].ToString().Length != 0 && rows["cont1"].ToString() != null)

                            {
                                ...
                                string nemotecnico = rows["nemotecnico"].ToString();
                                string nombre = rows["nombre"].ToString();
                                string cont = rows["cont"].ToString();
                                string cont1 = rows["cont1"].ToString();

                                //String Codigo = "9";
                                String campo1 = "1";

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { codigo, nemotecnico, nombre, cont, cont1 };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKgnLangu.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKgnLangu.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        //QBE
                                        errors = FuncionesGlobales.QBEQry(desktopSession, TipoQbe, QbeFilter, file, campo1);
                                        if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }
