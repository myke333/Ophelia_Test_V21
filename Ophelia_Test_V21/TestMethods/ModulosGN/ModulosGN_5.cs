...
{
    /// <summary>
    /// Descripción resumida de ModulosGN_5
    /// NataliaC
    /// </summary>
    [TestClass]
    public class ModulosGN_5 : FuncionesVitales
    {
        ...
        public void KGnPatagCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosGN.ModulosGN_5.KGnPatagCheckList")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["Sentencia"].ToString().Length != 0 && rows["Sentencia"].ToString() != null &&
                                ...
                                )
                            {
                                ...
                                string Sentencia = rows["Sentencia"].ToString();
                                string Parametro = rows["Parametro"].ToString();
                                string Editar = rows["Editar"].ToString();
                                List<string> crudVariables = new List<string>() {Codigo, Sentencia, Parametro, Editar };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKgnpatag.CRUDKgnpatag(desktopSession, 1, crudVariables);
                                        ...
                                        CrudKgnpatag.CRUDKgnpatag(desktopSession, 2, crudVariables);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, Parametro, "PAR_TAGS", c, ErrorValidacion, "No se descarto correctamente", 1);
                                        //LUPA
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, Editar, "PAR_TAGS", c, ErrorValidacion, "El registro no se editó correctamente", 1);
        ...
        public void KGnPawebCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosGN.ModulosGN_5.KGnPawebCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                                ...
                                )
                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKgnpaweb.CRUDKgnpaweb(desktopSession, 1, crudVariables);
                                        ...
                                        CrudKgnpaweb.CRUDKgnpaweb(desktopSession, 2, crudVariables);
                                        newFunctions_4.ScreenshotNuevo("Editar Registro", true, file);
                                        ...
                                        //Validacion Editar Descartar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, Nombre, "MEN_BIEN", c, ErrorValidacion, "No se descarto correctamente", 1);
                                        ...
                                        Thread.Sleep(1000);
                                        ErrorValidacion = ValidacionesQueries.ValidacionLogbo(Tabla, motor, user, Campo, Codigo, "E", c, ErrorValidacion);
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, Editar, "MEN_BIEN", c, ErrorValidacion, "El registro no se editó correctamente", 1);
        ...
        public void KGnPbcajCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosGN.ModulosGN_5.KGnPbcajCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                                ...
                                )
                            {
                                ...
                                string Editar = rows["Editar"].ToString();
                                List<string> crudVariables = new List<string>() { FechaI, FechaF, Mensaje, Editar };
                                //CREAR EL DOCUMENTO DEL REPORTE DE LA PRUEBA
                                string file = CrearDocumentoWordDinamico(codProgram, "GN", motor);
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKgnpbcaj.CRUDKgnpbcaj(desktopSession, 1, crudVariables);
                                        ...
                                        CrudKgnpbcaj.CRUDKgnpbcaj(desktopSession, 2, crudVariables);
                                        newFunctions_4.ScreenshotNuevo("Editar Registro", true, file);
                                        ...
                                        //Validacion Editar Descartar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, Mensaje, "MOV_BLCA", c, ErrorValidacion, "No se descarto correctamente", 1);
                                        ...
                                        Thread.Sleep(1000);
                                        ErrorValidacion = ValidacionesQueries.ValidacionLogbo(Tabla, motor, user, Campo, Codigo, "E", c, ErrorValidacion);
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, Editar, "MOV_BLCA", c, ErrorValidacion, "El registro no se editó correctamente", 1);
        ...
        public void KGnPpladCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosGN.ModulosGN_5.KGnPpladCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKgnpplad.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        ...
                                        CrudKgnpplad.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        ...
                                        //QBE
                                        errors = FuncionesGlobales.QBEQry(desktopSession, TipoQbe, QbeFilter, file, numero);
                                        if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }
        ...
        public void KGnReuscCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosGN.ModulosGN_5.KGnReuscCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
...

                            {
                                ...
                                List<string> crudPrincipal = new List<string>() { Codigo, Seccional, Editar };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKgnreusc.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKgnreusc.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
