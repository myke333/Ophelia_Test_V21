...
{
    /// <summary>
    /// Descripción resumida de ModulosGN_6
    /// </summary>
    [TestClass]
    public class ModulosGN_6:FuncionesVitales
    {
        ...
        public void KGnWgrupCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosGN.ModulosGN_6.KGnWgrupCheckList")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                //@Tipo @URL @Servicio @Puerto @EditarServ
                                ...
                                rows["TipoEmpl"].ToString().Length != 0 && rows["TipoEmpl"].ToString() != null &&
                                ...
                                )
                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKgnwgrup.CRUD(desktopSession, 1, crudVariables, file);
                                        ...
                                        CrudKgnwgrup.CRUD(desktopSession, 2, crudVariables, file);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, Nombre, "NOM_GUSW", c, ErrorValidacion, "No se edito correctamente", 1);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, EditarNombre, "NOM_GUSW", c, ErrorValidacion, "El registro no se editó correctamente", 1);
        ...
        public void KGnWprogCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosGN.ModulosGN_6.KGnWprogCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                                ...
                                )
                            {
                                ...
                                List<string> crudVariables = new List<string>() { Modulo, Codigo, Nombre, EditarNombre };
                                //CREAR EL DOCUMENTO DEL REPORTE DE LA PRUEBA
                                string file = CrearDocumentoWordDinamico(codProgram, "GN", motor);
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKgnwprog.CRUD(desktopSession, 1, crudVariables, file);
                                        ...
                                        CrudKgnwprog.CRUD(desktopSession, 2, crudVariables, file);
                                        ...
                                        //Validacion Editar Descartar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, Nombre, "NOM_PROG", c, ErrorValidacion, "No se edito correctamente", 1);
                                        ...
                                        // //Debugger.Launch();
                                        ErrorValidacion = ValidacionesQueries.ValidacionLogbo(Tabla, motor, user, Campo, Codigo, "E", c, ErrorValidacion);
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, EditarNombre, "NOM_PROG", c, ErrorValidacion, "El registro no se editó correctamente", 1);
        ...
        public void AbrirPrograma()
        {
            ...
            List<string> ErrorValidacion = new List<string>();
            string motor = "SQL";
            AbrirPrograma a = new AbrirPrograma("KNmRptie", "UCalida1");
            //string motor = "ORA";
            //AbrirPrograma a = new AbrirPrograma("KNmAumge", "KCT_SVPK");
            desktopSession = a.Start2(motor, "");
            Thread.Sleep(2000000);
        }

        [TestMethod]
        public void KGnTipccCheckList()
        {
            //Debugger.Launch();
            List<string> errorMessages = new List<string>();
            List<string> listaResultado;
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosGN.ModulosGN_6.KGnTipccCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKgntipcc.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        ...
                                        CrudKgntipcc.AgregarCrud(desktopSession, 1, crudPrincipal);
        ...
        public void KGnWebseCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosGN.ModulosGN_6.KGnWebseCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["EditarServ"].ToString().Length != 0 && rows["EditarServ"].ToString() != null
                                ...
                                )
                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKgnwebse.CRUD(desktopSession, 1, crudVariables, file);
                                        ...
                                        CrudKgnwebse.CRUD(desktopSession, 2, crudVariables, file);
                                        ...
                                        //Validacion Editar Descartar
                                        //ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Tipo, Servicio, "WES_SERV", c, ErrorValidacion, "No se edito correctamente", 1);
                                        ...
                                        //ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Tipo, EditarServ, "WES_SERV", c, ErrorValidacion, "El registro no se editó correctamente", 1);
