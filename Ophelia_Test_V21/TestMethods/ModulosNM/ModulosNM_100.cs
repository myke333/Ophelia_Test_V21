...
using CrudKnmmdeja = Ophelia_Test_V21.AFuncionesGlobales.CRUDProgramas.ModulosNm_10.CrudKnmmdeja;

namespace Ophelia_Test_V21.TestMethods.ModulosNM
{
    [TestClass]
    public class ModulosNM_100 : FuncionesVitales
    {
        ...
        public void KNmLiptuChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_100.KNmLiptuChecKlist")
                {
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmliptu.AgregarCrud(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Datos", true, file);
                                        ...
                                        CrudKnmliptu.Boton(desktopSession);
                                        Thread.Sleep(1500);
                                        newFunctions_4.ScreenshotNuevo("boton aceptar", true, file);

                                        CrudKnmliptu.Enter(desktopSession);
                                        Thread.Sleep(1500);
        ...
        public void KNmLiqheChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_100.KNmLiqheChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmliqhe.AgregarCrud(desktopSession);
                                        Thread.Sleep(1500);
                                        ...
                                        CrudKnmliqhe.Boton(desktopSession);
                                        Thread.Sleep(1500);
                                        newFunctions_4.ScreenshotNuevo("boton aceptar", true, file);

                                        CrudKnmliqhe.Enter(desktopSession);
                                        Thread.Sleep(1500);
                                        newFunctions_4.ScreenshotNuevo("ventana 1", true, file);
                                        Thread.Sleep(1500);
        ...
        public void KNmMdejaChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_100.KNmMdejaChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmmdeja.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        ...
                                        CrudKnmmdeja.AgregarCrud(desktopSession, 1, crudPrincipal);
        ...
        public void KNmMefnaChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_100.KNmMefnaChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmmefna.AgregarCrud(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Datos", true, file);
                                        ...
                                        CrudKnmmefna.Boton(desktopSession);
                                        Thread.Sleep(1500);
                                        newFunctions_4.ScreenshotNuevo("boton aceptar", true, file);

                                        CrudKnmmefna.Enter(desktopSession);
                                        Thread.Sleep(1500);
                                        newFunctions_4.ScreenshotNuevo("ventana 1", true, file);
                                        Thread.Sleep(1500);
                                        ...
                                        CrudKnmmefna.Enter(desktopSession);
                                        Thread.Sleep(1500);
                                        newFunctions_4.ScreenshotNuevo("ventana 3", true, file);
                                        Thread.Sleep(1500);
                                        ...
                                        //if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }
                                        //newFunctions_1.lapiz(desktopSession);
                                        CrudKnmmefna.BotonReportes(desktopSession, 0);
                                        Thread.Sleep(1500);
                                        //REPORTE DINAMICO
                                        ...
                                        Thread.Sleep(1500);
                                        CrudKnmmefna.BotonReportes(desktopSession, 1);
                                        Thread.Sleep(1500);
                                        ...
                                        CrudKnmmefna.BotonReportes(desktopSession, 2);
                                        Thread.Sleep(1500);
        ...
        public void KNmMgecoChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_100.KNmMgecoChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmmgeco.Boton(desktopSession);
                                        Thread.Sleep(1500);
                                        newFunctions_4.ScreenshotNuevo("boton aceptar", true, file);

                                        CrudKnmmgeco.Enter(desktopSession);
                                        Thread.Sleep(1500);
                                        newFunctions_4.ScreenshotNuevo("ventana 1", true, file);
                                        Thread.Sleep(1500);
