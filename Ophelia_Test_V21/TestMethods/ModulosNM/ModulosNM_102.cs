...
{
    [TestClass]
    public class ModulosNM_102 : FuncionesVitales
    {
        ...
        public void KNmPagnoChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_102.KNmPagnoChecKlist")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                //Datos Generales
                                rows["CDP"].ToString().Length != 0 && rows["CDP"].ToString() != null &&
                                ...
                                rows["Banco"].ToString().Length != 0 && rows["Banco"].ToString() != null &&
                                rows["ACH"].ToString().Length != 0 && rows["ACH"].ToString() != null)

                            {
                                ...
                                string Banco = rows["Banco"].ToString();
                                string ACH = rows["ACH"].ToString();


                                //String campo = "2";

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { CDP, FechIni, FechFin, Proto, Firma, Banco, ACH };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmpagno.Click(desktopSession, 0, crudPrincipal, file);
                                        newFunctions_4.ScreenshotNuevo("Datos en el maestro pestana entidades", true, file);
                                        Thread.Sleep(2000);

                                        CrudKnmpagno.Click(desktopSession, 1, crudPrincipal, file);
                                        newFunctions_4.ScreenshotNuevo("Click en preeliminar", true, file);
                                        Thread.Sleep(6000);                                                                          
                                        
                                        string pdf1 = @"C:\Reportes\ReportePDF1_" + "Preliminar" + "_" + Hora();
                                        errors = CrudKnmrnoel.GenerarReportes("Preliminar", file, pdf1, nomProgram);
        ...
        public void KNmPahocChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_102.KNmPahocChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["FechIni"].ToString().Length != 0 && rows["FechIni"].ToString() != null &&
                                rows["FechFin"].ToString().Length != 0 && rows["FechFin"].ToString() != null &&
                                rows["ProtoVa"].ToString().Length != 0 && rows["ProtoVa"].ToString() != null &&
                                rows["ProtoEmAli"].ToString().Length != 0 && rows["ProtoEmAli"].ToString() != null &&
                                rows["ProtoEmEje"].ToString().Length != 0 && rows["ProtoEmEje"].ToString() != null &&
                                rows["ProtoDscto"].ToString().Length != 0 && rows["ProtoDscto"].ToString() != null &&
                                rows["Rete"].ToString().Length != 0 && rows["Rete"].ToString() != null &&
                                rows["ConceUni"].ToString().Length != 0 && rows["ConceUni"].ToString() != null &&
...

                            {
                                ...
                                string FechIni = rows["FechIni"].ToString();
                                string FechFin = rows["FechFin"].ToString();
                                string ProtoVa = rows["ProtoVa"].ToString();
                                string ProtoEmAli = rows["ProtoEmAli"].ToString();
                                string ProtoDscto = rows["ProtoDscto"].ToString();
                                string ProtoEmEje = rows["ProtoEmEje"].ToString();
                                string Rete = rows["Rete"].ToString();
                                string ConceUni = rows["ConceUni"].ToString();

                                //String campo = "2";

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { FechIni, FechFin, ProtoVa, ProtoEmAli, ProtoEmEje,
                                                                                  ProtoDscto, Rete, ConceUni };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmpahoc.Click(desktopSession, 0, crudPrincipal, file);
                                        newFunctions_4.ScreenshotNuevo("Datos en el maestro", true, file);
                                        Thread.Sleep(2000);
                                        ...
                                        CrudKnmpahoc.Click(desktopSession, 1, crudPrincipal, file);
                                        ...
                                        CrudKnmpahoc.ClickButtonAceptarEnter(desktopSession, 1);

                                        //CrudKnmpahoc.Click(desktopSession, 2, crudPrincipal, file);
                                        //newFunctions_4.ScreenshotNuevo("Click en el excel generado", true, file);
                                        //Thread.Sleep(8000);
        ...
        public void KNmPasypChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_102.KNmPasypChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                //Datos Generales
                                rows["Subti"].ToString().Length != 0 && rows["Subti"].ToString() != null &&
                                rows["CDP"].ToString().Length != 0 && rows["CDP"].ToString() != null &&
                                rows["FechIni"].ToString().Length != 0 && rows["FechIni"].ToString() != null &&
                                rows["FechFin"].ToString().Length != 0 && rows["FechFin"].ToString() != null &&
                                rows["Porce"].ToString().Length != 0 && rows["Porce"].ToString() != null &&
                                rows["Firma"].ToString().Length != 0 && rows["Firma"].ToString() != null &&
                                rows["Docu"].ToString().Length != 0 && rows["Docu"].ToString() != null)

                            {
                                ...
                                //Variables generales
                                string Subti = rows["Subti"].ToString();
                                string CDP = rows["CDP"].ToString();
                                string FechIni = rows["FechIni"].ToString();
                                string FechFin = rows["FechFin"].ToString();
                                string Porce = rows["Porce"].ToString();
                                string Firma = rows["Firma"].ToString();
                                string Docu = rows["Docu"].ToString();


                                //String campo = "2";

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Subti, CDP, FechIni, FechFin, Porce, Firma, Docu };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmpasyp.Click(desktopSession, 0, crudPrincipal, file);
                                        newFunctions_4.ScreenshotNuevo("Datos en el maestro", true, file);
                                        Thread.Sleep(2000);

                                        CrudKnmpasyp.Click(desktopSession, 1, crudPrincipal, file);
                                        newFunctions_4.ScreenshotNuevo("Click en preeliminar", true, file);
                                        Thread.Sleep(6000);
        ...
        public void KNmPavfcChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_102.KNmPavfcChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmpahoc.ClickButtonAceptarEnter(desktopSession, 0);
                                        Thread.Sleep(1000);

                                        newFunctions_4.ScreenshotNuevo("Mensaje de ventana", true, file);
                                        Thread.Sleep(2000);
                                        CrudKnmpahoc.ClickButtonAceptarEnter(desktopSession, 1);
        ...
        public void KNmPeranChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_102.KNmPeranChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["ConceIn"].ToString().Length != 0 && rows["ConceIn"].ToString() != null &&
                                rows["ConcePa"].ToString().Length != 0 && rows["ConcePa"].ToString() != null &&
                                rows["SuelBa"].ToString().Length != 0 && rows["SuelBa"].ToString() != null &&
                                rows["ActSuelBa"].ToString().Length != 0 && rows["ActSuelBa"].ToString() != null)

                            {
                                ...
                                string ConceIn = rows["ConceIn"].ToString();
                                string ConcePa = rows["ConcePa"].ToString();
                                string SuelBa = rows["SuelBa"].ToString();
                                string ActSuelBa = rows["ActSuelBa"].ToString();

                                String campo = "1";

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { ConceIn, ConcePa, SuelBa, ActSuelBa };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmperan.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        ...
                                        CrudKnmperan.AgregarCrud(desktopSession, 1, crudPrincipal);
        ...
        public void KNmPerioChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_102.KNmPerioChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["ActMes"].ToString().Length != 0 && rows["ActMes"].ToString() != null)

                            {
                                ...
                                string ActMes = rows["ActMes"].ToString();

                                String campo = "2";

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { FechIni, FechFin, Mes, ActMes };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        //MODIFICAMOS
                                        CrudKnmperio.AgregarCrud(desktopSession, 2, crudPrincipal);
                                        Thread.Sleep(1500);
                                        //AGREGAR REGISTRO Principal
                                        Dictionary<string, Point> botonesNavegador = new Dictionary<string, Point>();
                                        botonesNavegador = PruebaCRUD.findname(desktopSession, 30, 0);
                                        ...
                                        CrudKnmperio.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmperio.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
        ...
        public void KNmPlcemChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_102.KNmPlcemChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmplcem.ClickButtonAceptarEnter(desktopSession, 0);
                                        Thread.Sleep(1000);

                                        newFunctions_4.ScreenshotNuevo("Mensaje de ventana", true, file);
                                        Thread.Sleep(2000);
                                        CrudKnmplcem.ClickButtonAceptarEnter(desktopSession, 1);

                                        CrudKnmplcem.ClickButtonAceptarEnter(desktopSession, 0);
                                        Thread.Sleep(1000);

                                        newFunctions_4.ScreenshotNuevo("Mensaje de que el proceso termino con errores", true, file);
                                        Thread.Sleep(2000);
                                        CrudKnmplcem.ClickButtonAceptarEnter(desktopSession, 1);

                                        Thread.Sleep(2000);
                                        CrudKnmplcem.ClickButtonErrores(desktopSession, file);
