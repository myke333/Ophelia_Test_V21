...
{
    [TestClass]
    public class ModulosNM_103 : FuncionesVitales
    {
        ...
        public void KNmPreliChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_103.KNmPreliChecKlist")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
...

                            {
                                ...
                                List<string> crudPrincipal = new List<string>() { Year };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmpreli.Click(desktopSession, 0, crudPrincipal, file);
                                        ...
                                        CrudKnmpreli.ClickButtonAceptarEnter(desktopSession, 0);
                                        newFunctions_4.ScreenshotNuevo("Click en Aceptar", true, file);
                                        Thread.Sleep(6000);

                                        newFunctions_4.ScreenshotNuevo("Ventana de proceso", true, file);
                                        Thread.Sleep(2000);
                                        CrudKnmpreli.ClickButtonAceptarEnter(desktopSession, 1);

                                        newFunctions_4.ScreenshotNuevo("Proceso Terminado con errores", true, file);
                                        Thread.Sleep(2000);
                                        CrudKnmpreli.ClickButtonAceptarEnter(desktopSession, 1);

                                        CrudKnmpreli.Click(desktopSession, 1, crudPrincipal, file);
                                        newFunctions_4.ScreenshotNuevo("Datos en el maestro", true, file);
                                        Thread.Sleep(2000);
        ...
        public void KNmPriteChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_103.KNmPriteChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
...

                            {
                                ...
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Fecha, ActFecha };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmprite.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        ...
                                        CrudKnmprite.AgregarCrud(desktopSession, 1, crudPrincipal);
        ...
        public void KNmNcdivChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_103.KNmNcdivChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                //Datos Crud Principal
                                rows["Conta"].ToString().Length != 0 && rows["Conta"].ToString() != null &&
                                rows["ActConta"].ToString().Length != 0 && rows["ActConta"].ToString() != null)

                            {
                                ...
                                //Variables crud principal
                                string Conta = rows["Conta"].ToString();
                                string ActConta = rows["ActConta"].ToString();

                                String campo = "1";

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Conta, ActConta };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmncdiv.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmncdiv.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
        ...
        public void KNmMpfieChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_103.KNmMpfieChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["Ccost"].ToString().Length != 0 && rows["Ccost"].ToString() != null &&
...

                            {
                                ...
                                string Ccost = rows["Ccost"].ToString();
                                string ActId = rows["ActId"].ToString();

                                //String campo = "1";

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Id, Ccost, ActId };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmmpfie.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmmpfie.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        CrudKnmmpfie.Click(desktopSession, 0);
                                        Thread.Sleep(1500);
                                        newFunctions_4.ScreenshotNuevo("Reporte preliminar 1", true, file);
                                        string pdf1 = @"C:\Reportes\ReportePDF1_" + "Preliminar1" + "_" + Hora();
                                        errors = CrudKnmrnoel.GenerarReportes("Preliminar", file, pdf1, nomProgram);
                                        if (errors.Count > 0) { foreach (string er in errors) { errorMessages.Add(er); } }

                                        //REPORTE PRELIMINAR 2
                                        CrudKnmmpfie.Click(desktopSession, 1);
                                        Thread.Sleep(1500);
                                        newFunctions_4.ScreenshotNuevo("Reporte Preliminar 2", true, file);
                                        string pdf2 = @"C:\Reportes\ReportePDF1_" + "Preliminar2" + "_" + Hora();
                                        errors = CrudKnmrnoel.GenerarReportes("Preliminar", file, pdf2, nomProgram);
                                        if (errors.Count > 0) { foreach (string er in errors) { errorMessages.Add(er); } }

                                        //REPORTE PRELIMINAR 3
                                        CrudKnmmpfie.Click(desktopSession, 2);
                                        Thread.Sleep(1500);
                                        newFunctions_4.ScreenshotNuevo("Reporte Preliminar 2", true, file);
                                        string pdf3 = @"C:\Reportes\ReportePDF1_" + "Preliminar3" + "_" + Hora();
                                        errors = CrudKnmrnoel.GenerarReportes("Preliminar", file, pdf3, nomProgram);
                                        if (errors.Count > 0) { foreach (string er in errors) { errorMessages.Add(er); } }
