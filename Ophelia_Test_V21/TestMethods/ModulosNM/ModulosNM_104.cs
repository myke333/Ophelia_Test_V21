...
{
    [TestClass]
    public class ModulosNM_104 : FuncionesVitales
    {
        ...
        public void KNmNcrcoChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_104.KNmNcrcoChecKlist")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["ActArea"].ToString().Length != 0 && rows["ActArea"].ToString() != null)

                            {
                                ...
                                string ActArea = rows["ActArea"].ToString();

                                //String campo = "2";

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Codigo, Area, ActArea };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmncrco.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        ...
                                        CrudKnmncrco.AgregarCrud(desktopSession, 1, crudPrincipal);
