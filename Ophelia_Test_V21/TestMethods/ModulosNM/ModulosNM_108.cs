...
{
    [TestClass]
    public class ModulosNM_108 : FuncionesVitales
    {
        ...
        public void KNmSubccChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_108.KNmSubccChecKlistORA")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["SubCen"].ToString().Length != 0 && rows["SubCen"].ToString() != null &&
                                rows["ActSubCen"].ToString().Length != 0 && rows["ActSubCen"].ToString() != null &&
...

                            {
                                ...
                                //Variables Crud principal
                                string Cod = rows["Codigo"].ToString();
                                string SubCen = rows["SubCen"].ToString();
                                string ActSubCen = rows["ActSubCen"].ToString();
        ...
        public void KNmTaralChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_108.KNmTaralChecKlistORA")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["Codigo"].ToString().Length != 0 && rows["Codigo"].ToString() != null &&
                                rows["EdCodigo"].ToString().Length != 0 && rows["EdCodigo"].ToString() != null &&

                                //Variables Validaciones Crud pricipal
                                rows["Tabla"].ToString().Length != 0 && rows["TablaDet"].ToString() != null &&
                                rows["Campo"].ToString().Length != 0 && rows["CampoDet"].ToString() != null &&
                                rows["EditCampo"].ToString().Length != 0 && rows["EditCampoDet"].ToString() != null &&

                                //Datos Crud detalle 1
                                rows["ValorTarf"].ToString().Length != 0 && rows["ValorTarf"].ToString() != null &&
...

                            {
                                ...
                                //Variables Crud principal
                                string Cod = rows["Codigo"].ToString();
                                string EdCod = rows["EdCodigo"].ToString();
                                ...
                                string ValorTarf = rows["ValorTarf"].ToString();
                                ...
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Cod, EdCod };
                                //LISTA DETALLE 1
                                List<string> crudDet1 = new List<string>() { ValorTarf };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        //Thread.Sleep(1500);
                                        CrudKnmtaral.AgregarCrud1(desktopSession, 0, crudDet1);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmtaral.AgregarCrud1(desktopSession, 1, crudDet1);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
        ...
        public void KNmTarifChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_110.KNmTarifChecKlistORA")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["ValorTarif"].ToString().Length != 0 && rows["ValorTarif"].ToString() != null &&
...

                            {
                                ...
                                //Variables Crud principal
                                string Cod = rows["Codigo"].ToString();
                                string Descrip = rows["Descripcion"].ToString();
                                string ValorTarif = rows["ValorTarif"].ToString();
                                string EdDescrip = rows["EdDesc"].ToString();
                                ...
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Cod, Descrip, ValorTarif, EdDescrip };
                                //LISTA DETALLE 1
                                List<string> crudDet1 = new List<string>() { Cargo };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        //CrudKnmcaban.Click(desktopSession);
                                        //Thread.Sleep(1500);
                                        CrudKnmtarif.AgregarCrud1(desktopSession, 0, crudDet1);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmtarif.AgregarCrud1(desktopSession, 1, crudDet1);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
        ...
        public void KNmTargpChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_.KNmTargpChecKlistORA")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["EditGP"].ToString().Length != 0 && rows["EditGP"].ToString() != null &&
...

                            {
                                ...
                                string EditGP = rows["EditGP"].ToString();
                                //String Codigo = "9";

                                // String campo = "1";

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { GrupoPro, EditGP };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmtargp.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmtargp.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
