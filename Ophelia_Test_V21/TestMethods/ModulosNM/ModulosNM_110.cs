...
{
    [TestClass]
    public class ModulosNM_110 : FuncionesVitales
    {
        ...
        public void KNmHdecoChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_110.KNmHdecoChecKlist")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
...

                            {
                                ...
                                List<string> crudPrincipal = new List<string>() {  Valor, EditValor };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmhdeco.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        ...
                                        CrudKnmhdeco.AgregarCrud(desktopSession, 1, crudPrincipal);
        ...
        [TestMethod]
        public void KNmRprocChecKlist()
        //CASOS DE PRUEBA
        //SQL 2325 CONJUNTO 2272
        //ORA 2654 CONJUNTO 2273
        {
            //Debugger.Launch();
            List<string> errorMessages = new List<string>();
            List<string> listaResultado;
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_110.KNmRprocChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                //Variables Crud principal
                                rows["Fec1"].ToString().Length != 0 && rows["Fec1"].ToString() != null &&
                                rows["Fec2"].ToString().Length != 0 && rows["Fec2"].ToString() != null)
...

                            {
                                ...
                                //Variables Crud principal
                                string Fec1 = rows["Fec1"].ToString();
                                string Fec2 = rows["Fec2"].ToString();

                                string campo = "0";

                                //LISTA CRUD PRINCIPAL

                                List<string> crudPrincipal = new List<string>() { Fec1, Fec2};
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmrproc.AgregarCrud(desktopSession, 0, crudPrincipal); 
                                        ...
                                        CrudKnmrproc.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Seleccion de datos", true, file);
        ...
        public void KNmTinteChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_110.KNmTinteChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["Valor"].ToString().Length != 0 && rows["Valor"].ToString() != null &&
                                rows["Reser"].ToString().Length != 0 && rows["Reser"].ToString() != null &&
...

                            {
                                ...
                                string Valor = rows["Valor"].ToString();
                                string Reser = rows["Reser"].ToString();
                                string Tipo = rows["Tipo"].ToString();
                                string Obser = rows["Obser"].ToString();
                                string EditValor = rows["EditValor"].ToString();
                                string Ter = rows["Ter"].ToString();
                                string Codigo2 = rows["Codigo2"].ToString();

                                string campo = "1";

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Codigo, Valor, Reser, Tipo, Obser, EditValor, Ter, Codigo2 };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmtinte.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmtinte.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }
                                        newFunctions_1.lapiz(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Sumatoria", true, file);
                                        Thread.Sleep(2000);
                                        ...
                                        listaResultado = Textopdf(pdf, codProgram, user);
                                        listaResultado.ForEach(e => ErrorValidacion.Add(e));
                                        newFunctions_4.ScreenshotNuevo("Rectificar Pie Pagina PDF DINAMICO", true, file);
                                        Thread.Sleep(2000);
                                        ...
                                        listaResultado = Textopdf(pdf1, codProgram, user);
                                        listaResultado.ForEach(e => ErrorValidacion.Add(e));
                                        newFunctions_4.ScreenshotNuevo("Pie Pagina PDF PRELIMINAR", true, file);
                                        Thread.Sleep(2000);
                                        ...
                                        errors = newFunctions_2.ExpExcel(desktopSession, banExcel, file, codProgram, ruta);
                                        if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }
                                        newFunctions_4.ScreenshotNuevo("Eporrtar exel", true, file);
                                        Thread.Sleep(2000);
                                        ...
                                        //ELIMINAR REGISTRO
                                        CrudKnmtinte.EliminarRegistro(desktopSession, ElementList[0], botonesNavegador, file);
                                        PruebaCRUD.EliminarRegistro(desktopSession, ElementList[0], botonesNavegador, file);
                                        newFunctions_4.ScreenshotNuevo("Datos Eliminados Principal", true, file);
        ...
        public void KNmIcsgcChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_110.KNmIcsgcChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["CodEdit"].ToString().Length != 0 && rows["CodEdit"].ToString() != null )
...

                            {
                                ...
                                string CodEdit = rows["CodEdit"].ToString();
                                

                                string campo = "2";

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Cod, CodEdit};
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        //CrudKnmrcuen.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        //newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        //CrudKnmrcuen.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        //newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        //ELIMINAR REGISTRO
                                        //CrudKnmrcuen.EliminarRegistro(desktopSession, ElementList[0], botonesNavegador, file);
                                        //PruebaCRUD.EliminarRegistro(desktopSession, ElementList[0], botonesNavegador, file);
                                        //newFunctions_4.ScreenshotNuevo("Datos Eliminados Principal", true, file);
        ...
        public void KNmIcsprChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_110.KNmIcsprChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                //Variables Crud principal
                                rows["Ref"].ToString().Length != 0 && rows["Ref"].ToString() != null &&
                                rows["Docres"].ToString().Length != 0 && rows["Docres"].ToString() != null &&
                                rows["Nrores"].ToString().Length != 0 && rows["Nrores"].ToString() != null &&
                                rows["Nroord"].ToString().Length != 0 && rows["Nroord"].ToString() != null &&
                                rows["EdirRef"].ToString().Length != 0 && rows["EdirRef"].ToString() != null &&
                                ...
                                
                            {
                                ...
                                //Variables Crud principal
                                string Ref = rows["Ref"].ToString();
                                string Docres = rows["Docres"].ToString();
                                string Nrores = rows["Nrores"].ToString();
                                string Nroord = rows["Nroord"].ToString();
                                string EdirRef = rows["EdirRef"].ToString();
                                ...
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Ref, Docres, Nrores, Nroord, EdirRef};
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmicspr.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmicspr.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        //ELIMINAR REGISTRO
                                        //CrudKnmicspr.EliminarRegistro(desktopSession, ElementList[0], botonesNavegador, file);
                                        PruebaCRUD.EliminarRegistro(desktopSession, ElementList[0], botonesNavegador, file);
                                        newFunctions_4.ScreenshotNuevo("Datos Eliminados Principal", true, file);
        ...
        public void KNmLitssChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_110.KNmLitssChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["Fec1"].ToString().Length != 0 && rows["Fec1"].ToString() != null &&
                                rows["Fec2"].ToString().Length != 0 && rows["Fec2"].ToString() != null &&
                                rows["Fec3"].ToString().Length != 0 && rows["Fec3"].ToString() != null)
                                ...
                                
                            {
                                ...
                                string Fec1 = rows["Fec1"].ToString();
                                string Fec2 = rows["Fec2"].ToString();
                                string Fec3 = rows["Fec3"].ToString();

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() {Fec1, Fec2, Fec3 };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmlitss.AgregarCrud(desktopSession, 0, crudPrincipal);
        ...
        //    string programa = "KGnDecos"; //caban
        //    //Debugger.Launch();
