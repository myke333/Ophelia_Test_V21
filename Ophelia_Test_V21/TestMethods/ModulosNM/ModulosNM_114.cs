...
{
    [TestClass]
    public class ModulosNM_114 : FuncionesVitales
    {
        ...
        public void KNmRbareChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_114.KNmRbareChecklist")
                {
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        //Insertamos fecha 
                                        CrudKNmRbare.AgregarCrud(desktopSession, 0);
                                        newFunctions_4.ScreenshotNuevo("Ingresar fechas", true, file);
                                        Thread.Sleep(2000);

                                        //Insertamos los datos
                                        CrudKNmRbare.AgregarCrud(desktopSession, 1);
                                        ...
                                        if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }
                                        newFunctions_4.ScreenshotNuevo(" QBE ya insertado", true, file);

                                        CrudKNmRbare.AgregarCrud(desktopSession, 2);
        ...
        public void KNmRprubChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_114.KNmRprubChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        //Insertamos fecha 
                                        CrudKnmrprub.AgregarNomina(desktopSession, 0);
                                        newFunctions_4.ScreenshotNuevo("Ingresar fechas", true, file);
                                        Thread.Sleep(2000);

                                        //Insertamos los datos
                                        CrudKnmrprub.AgregarNomina(desktopSession, 1);
                                        newFunctions_4.ScreenshotNuevo("Insertamos un comentario", true, file);
                                        ...
                                        //CrudKnmrprub.qbe2(desktopSession);
                                        //newFunctions_4.ScreenshotNuevo("Insertamos QBE", true, file);

                                        Thread.Sleep(1500);

                                        CrudKnmrprub.preliminar1(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Elejimos el primer preliminar", true, file);
                                        ...
                                        CrudKnmrprub.qbe2(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Insertamos QBE2", true, file);

                                        Thread.Sleep(3000);

                                        CrudKnmrprub.preliminar2(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Elejimos el segundo preliminar", true, file);
                                        Thread.Sleep(3000);
                                        // PDF preliminar 2
        ...
        public void KNmRirfuChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_114.KNmRirfuChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        //Insertamos los prototipos 
                                        CrudKnmrirfu.AgregarDatos(desktopSession, 0);
                                        newFunctions_4.ScreenshotNuevo("Ingresamos los prototipos", true, file);
                                        Thread.Sleep(2000);

                                        //Insertamos la fecha de proceso
                                        CrudKnmrirfu.AgregarDatos(desktopSession, 1);
                                        newFunctions_4.ScreenshotNuevo("Insertamos la fecha", true, file);

                                        //Insertamos la ruta de archivo
                                        CrudKnmrirfu.AgregarDatos(desktopSession, 2);
                                        Thread.Sleep(1000);
                                        CrudKnmrirfu.Enter(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Insertamos la ruta", true, file);
                                        Thread.Sleep(2000);
                                        ...
                                        ////Insertamos el QBE
                                        //CrudKnmrirfu.qbe2(desktopSession);
                                        //newFunctions_4.ScreenshotNuevo("Insertamos QBE", true, file);

                                        Thread.Sleep(1500);

                                        CrudKnmrirfu.aceptar(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Generar reporte", true, file);

                                        CrudKnmrirfu.Enter(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Darle aceptar", true, file);
                                        Thread.Sleep(2500);
                                        CrudKnmrirfu.Enter(desktopSession);
                                        Thread.Sleep(3000);
                                        // PDF preliminar 1
        ...
        public void KNmPrdjuChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_114.KNmPrdjuChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmprdju.AgregarDatos(desktopSession,0);
                                        ...
                                        CrudKnmprdju.AgregarDatos(desktopSession, 1);
                                        newFunctions_4.ScreenshotNuevo("Da click a boton aceptar", true, file);

                                        Thread.Sleep(1500);

                                        CrudKnmprdju.AgregarDatos(desktopSession, 2);
                                        newFunctions_4.ScreenshotNuevo("Seguimiento de declaraciones", true, file);
        ...
        public void KNmMovtoChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_114.KNmMovtoChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["NitTercero"].ToString().Length != 0 && rows["NitTercero"].ToString() != null &&
                                rows["Concepto"].ToString().Length != 0 && rows["Concepto"].ToString() != null &&
                                rows["Nivel1"].ToString().Length != 0 && rows["Nivel1"].ToString() != null &&
...

                            {
                                ...
                                string NitTercero = rows["NitTercero"].ToString();
                                string Concepto = rows["Concepto"].ToString();
                                string Nivel1 = rows["Nivel1"].ToString();
                                ...
                                List<string> crudPrincipal = new List<string>() { Fecha, Cuenta, CentroCosto, Detalle, NitTercero, Concepto, Nivel1, Unidad, Valor, EditDetalle };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmmovto.AgregarDatos(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        Thread.Sleep(1500);
                                        CrudKnmmovto.AgregarDatos(desktopSession, 1, crudPrincipal);
        ...
        public void KNmRpsriChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_114.KNmRpsriChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["RUC"].ToString().Length != 0 && rows["RUC"].ToString() != null &&
                                rows["Legal"].ToString().Length != 0 && rows["Legal"].ToString() != null &&
...

                            {
                                ...
                                //Variables principales
                                string RUC = rows["RUC"].ToString();
                                string Legal = rows["Legal"].ToString();
                                ...
                                String campo = "0";
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { RUC, Legal, Id, Direccion, Numero, Fecha };
                                //CREAR EL DOCUMENTO DEL REPORTE DE LA PRUEBA
                                string file = CrearDocumentoWordDinamico(codProgram, "NM", motor);
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        //Insertamos datos
                                        CrudKnmrpsri.AgregarDatos(desktopSession, crudPrincipal);
