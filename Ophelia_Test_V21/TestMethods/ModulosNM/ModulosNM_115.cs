...
{
    [TestClass]
    public class ModulosNM_115 : FuncionesVitales
    {
        ...
        public void KNmAntceChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_115.KNmAntceChecKlist")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["ValorA"].ToString().Length != 0 && rows["ValorA"].ToString() != null &&
                                rows["EditValorA"].ToString().Length != 0 && rows["EditValorA"].ToString() != null &&
...

                            {
                                ...
                                string ValorA = rows["ValorA"].ToString();
                                string EditValorA = rows["EditValorA"].ToString();
                                ...
                                List<string> crudPrincipal = new List<string>() { Identificacion, ValorA, EditValorA };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmantce.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        ...
                                        CrudKnmantce.AgregarCrud(desktopSession, 1, crudPrincipal);
        ...
        public void KNmCactiChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_115.KNmCactiChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["NombreA"].ToString().Length != 0 && rows["NombreA"].ToString() != null &&
...

                            {
                                ...
                                string NombreA = rows["NombreA"].ToString();
                                ...
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Codigo, NombreA, Descrip, ActNombre };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmcacti.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmcacti.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        CrudKnmcacti.AgregarCrudDetalle(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
        ...
        public void KNmComobChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_115.KNmComobChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["CodigoP"].ToString().Length != 0 && rows["CodigoP"].ToString() != null &&
                                rows["NumeroP"].ToString().Length != 0 && rows["NumeroP"].ToString() != null &&
                                rows["EdtiNumeroP"].ToString().Length != 0 && rows["EdtiNumeroP"].ToString() != null &&
...

                            {
                                ...
                                string CodigoP = rows["CodigoP"].ToString();
                                string NumeroP = rows["NumeroP"].ToString();
                                string EdtiNumeroP = rows["EdtiNumeroP"].ToString();
                                ...
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Costo, CodigoP, NumeroP, EdtiNumeroP };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmcomob.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmcomob.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
        ...
        public void KNmDpcolChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_115.KNmDpcolChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
...

                            {
                                ...
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Mensaje };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmdpcol.AgregarCrud(desktopSession, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Selecionar fecha desde y hasta", true, file);
                                        Thread.Sleep(2000);
                                        ...
                                        Thread.Sleep(1000);
                                        CrudKnmdpcol.Aceptar(desktopSession);
        ...
        public void KNmFaLiqChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_115.KNmFaLiqChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
...

                            {
                                ...
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { FechaI, FechaF, Proceso };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmfaliq.AgregarCrud(desktopSession, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Seleccionar tipos de liquidacion y fechas", true, file);
                                        Thread.Sleep(2000);
                                        ...
                                        CrudKnmfaliq.Aceptar(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Validar Datos", true, file);
                                        Thread.Sleep(10000);
                                        CrudKnmfaliq.Ventana(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Validar Datos", true, file);
                                        Thread.Sleep(10000);
                                        CrudKnmfaliq.Ventana(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("finalizar proceso", true, file);
                                        Thread.Sleep(2000);
                                        CrudKnmfaliq.Errores(desktopSession);
                                        string pdf1 = @"C:\Reportes\ReportePDF1_" + "Preliminar" + "_" + Hora();
                                        errors = newFunctions_5.GenerarReportes("Preliminar", file, pdf1, nomProgram);
                                        if (errors.Count > 0) { foreach (string er in errors) { errorMessages.Add(er); } }
                                        newFunctions_4.ScreenshotNuevo("Reporte de Errores en el proceso", true, file);
        ...
        public void KNmFapgeChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_115.KNmFapgeChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmfapge.AgregarCrud(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Seleccionar datos", true, file);
                                        Thread.Sleep(2000);
                                        ...
                                        CrudKnmfapge.Aceptar(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Validar Datos", true, file);
                                        Thread.Sleep(10000);
                                        CrudKnmfapge.Ventana(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Validar Datos", true, file);
                                        Thread.Sleep(10000);
                                        //CrudKnmfaliq.Ventana(desktopSession);
                                        //newFunctions_4.ScreenshotNuevo("finalizar proceso", true, file);
        ...
        public void KNmFaSopChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_115.KNmFaSopChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmfasop.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmfasop.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
