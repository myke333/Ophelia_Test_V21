...
{
    [TestClass]
    public class ModulosNM_122 : FuncionesVitales
    {
        ...
        [TestMethod]
        public void KNmGtcotChecKlist()

        //MAESTRO
        //NOMBRE:Grupos de Trabajo y Condiciones
        //CASOS DE PRUEBA
        //SQL 2611 CONJUNTO 2588
        //ORA 2 CONJUNTO 2

        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_122.KNmGtcotChecKlist")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                                ...
                                
                            {
                                ...
                                //LISTA DETALLE 1
                                List<string> crudDet1 = new List<string>() { Cantidad, Valor};
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmgtcot.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        ...
                                        CrudKnmgtcot.AgregarCrud2(desktopSession, 1, crudDet1);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        //if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }
                                        //newFunctions_1.lapiz(desktopSession);10.212.132.124
                                        ...
                                        CrudKnmgtcot.AgregarCrud(desktopSession, 1, crudDet1);
        ...
        [TestMethod]
        public void KNmMgsriChecKlist()

        //PROCESO
        //NOMBRE:Srv. Magnético SRI
        //CASOS DE PRUEBA
        //SQL 2621 CONJUNTO 2588
        //ORA 2622 CONJUNTO 2587

        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_122.KNmMgsriChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmmgsri.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmmgsri.AgregarCrud(desktopSession, 1, crudPrincipal);
        ...
        [TestMethod]
        public void KNmRimcoChecKlist()

        //PROCESO
        //NOMBRE: Reporte Interfaz contable 
        //CASOS DE PRUEBA
        //SQL 2621 CONJUNTO 2588
        //ORA 2622 CONJUNTO 2587

        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_122.KNmRimcoChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
...

                            {
                                ...
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Fecha };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmrimco.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmrimco.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("ACEPTAR", true, file);
