...
{
    /// <summary>
    /// Summary description for ModulosNM_123
    /// </summary>
    [TestClass]
    public class ModulosNM_123 : FuncionesVitales
    {
        ...
        public void KNmHeempChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_123.KNmHeempChecKlist")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                //Datos Generales @TipoQbe @QbeFilter @banExcel @BanderaLupa @BanderaPreli @BanderaSum
...

                            {
                                ...
                                //Variables generales  ----   @TipoQbe @QbeFilter @banExcel @BanderaLupa @BanderaPreli @BanderaSum
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmheemp.AggCrudDet(desktopSession, 0);
                                        ...
                                        CrudKnmheemp.AggCrudDet(desktopSession, 1);
                                        ...
                                        newFunctions_4.ScreenshotNuevo("Fin de Automatizacion", true, file);
        ...
        public void KNmDpconChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_123.KNmDpconChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmdpcon.InData(desktopSession, file, Principal);
                                        Thread.Sleep(1000);
                                        ...
                                        CrudKnmdpcon.ClickBtnAceptar(desktopSession);
                                        Thread.Sleep(1000);
                                        ...
                                        CrudKnmdpcon.Aceptar1(desktopSession);
                                        Thread.Sleep(1000);



                                        // Ventana Mensaje institucional
                                        newFunctions_4.ScreenshotNuevo("Ventana 2 - Mensaje Correo Comprobante ", true, file);
                                        //Click en btn ACEPTAR  Ventana Mensaje institucional
                                        CrudKnmdpcon.Aceptar2(desktopSession);
                                        Thread.Sleep(2000);
                                        ...
                                        CrudKnmdpcon.Enter(desktopSession);
                                        Thread.Sleep(50000);


                                        newFunctions_4.ScreenshotNuevo("Ventana 4 del proceso", true, file);
                                        CrudKnmdpcon.Enter(desktopSession);
                                        Thread.Sleep(1500);
                                        ...
                                        CrudKnmdpcon.CerrarVentana(desktopSession);
                                        Thread.Sleep(1000);
        ...
        public void KNmCrplaChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_118.KNmCrplaChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmcrpla.InData(desktopSession, file, Principal);
                                        Thread.Sleep(1000);


                                        //Click en btn aceptar
                                        CrudKnmcrpla.ClickBtnAceptar(desktopSession);
                                        Thread.Sleep(1000);


                                        newFunctions_4.ScreenshotNuevo("Ventana 1", true, file);
                                        CrudKnmcrpla.Enter(desktopSession);
                                        Thread.Sleep(1000);
                                        ...
                                        CrudKnmcrpla.ClickBtnErrores(desktopSession, file);
                                        Thread.Sleep(1000);


                                        // Cerrar ventana de errores
                                        CrudKnmcrpla.CerrarVentana(desktopSession);
                                        Thread.Sleep(1000);
