...
{
    [TestClass]
    public class ModulosNM_125 : FuncionesVitales
    {
        ...
        public void KNmFaforChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_125.KNmFaforChecKlist")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["NFormato"].ToString().Length != 0 && rows["NFormato"].ToString() != null &&
                                rows["Formato"].ToString().Length != 0 && rows["Formato"].ToString() != null &&
                                ...
                                rows["EditConsecutivo"].ToString().Length != 0 && rows["EditConsecutivo"].ToString() != null &&
...

                            {
                                ...
                                //Variables crud Principal
                                string NFormato = rows["NFormato"].ToString();
                                string Formato = rows["Formato"].ToString();
                                string Prototipo = rows["Prototipo"].ToString();
                                string Consecutivo = rows["Consecutivo"].ToString();
                                string EditConsecutivo = rows["EditConsecutivo"].ToString();
                                ...
                                List<string> crudPrincipal = new List<string>() { NFormato, Formato, Prototipo };

                                //LISTA CRUD DETALLE
                                List<string> crudDet = new List<string>() { Consecutivo, EditConsecutivo };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmfafor.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        ...
                                        CrudKnmfafor.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        ...
                                        CrudKnmfafor.CrudDetalle(desktopSession, 0, crudDet);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmfafor.CrudDetalle(desktopSession, 1, crudDet);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
        ...
        public void KNmFagenChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_125.KNmFagenChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void KNmGeinsChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_125.KNmGeinsChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
...

                            {
                                ...
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Secuencial };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmgeins.AgregarCrud(desktopSession, crudPrincipal);
                                        ...
                                        Thread.Sleep(1000);
                                        CrudKnmgeins.Aceptar(desktopSession);
                                        Thread.Sleep(3000);
                                        newFunctions_4.ScreenshotNuevo("Validar Datos", true, file);
                                        Thread.Sleep(5000);
                                        CrudKnmgeins.Enter(desktopSession);
                                        Thread.Sleep(1000);
                                        newFunctions_4.ScreenshotNuevo("Finalizar proceso", true, file);
                                        Thread.Sleep(10000);
                                        //newFunctions_4.ScreenshotNuevo("Validar Datos", true, file);
                                        //CrudKnmgeins.Errores(desktopSession);
                                        //newFunctions_4.ScreenshotNuevo("Finalizar proceso", true, file);
        ...
        public void KNmGnhexChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_125.KNmGnhexChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        Thread.Sleep(1000);
                                        CrudKnmgnhex.Aceptar(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Validar Datos", true, file);
                                        Thread.Sleep(15000);
                                        CrudKnmgnhex.Enter(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Validar Datos", true, file);
                                        Thread.Sleep(5000);
        ...
        public void KNmLiupcChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_125.KNmLiupcChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void KNmLividChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_125.KNmLividChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void KNmPacjeChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_125.KNmPacjeChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmpacje.AgregarCrud(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Validar Datos", true, file);
                                        Thread.Sleep(15000);
                                        ...
                                        Thread.Sleep(1000);
                                        CrudKnmpacje.Aceptar(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Validar Datos", true, file);
                                        Thread.Sleep(15000);
                                        CrudKnmpacje.Enter(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Validar Datos", true, file);
                                        Thread.Sleep(5000);
        ...
        public void KNmHccsfChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_125.KNmHccsfChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                //Variables Crud principal y detalle
                                rows["Codigo"].ToString().Length != 0 && rows["Codigo"].ToString() != null &&
                                rows["Nombre"].ToString().Length != 0 && rows["Nombre"].ToString() != null &&
                                rows["EditNombre"].ToString().Length != 0 && rows["Prototipo"].ToString() != null &&
                                rows["CodCentro"].ToString().Length != 0 && rows["CodCentro"].ToString() != null &&
                                rows["EditCodCentro"].ToString().Length != 0 && rows["EditCodCentro"].ToString() != null &&
...

                            {
                                ...
                                string CodCentro = rows["CodCentro"].ToString();
                                string EditCodCentro = rows["EditCodCentro"].ToString();
                                ...
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Codigo, Nombre, EditNombre };

                                //LISTA CRUD DETALLE
                                List<string> crudDet = new List<string>() { CodCentro, EditCodCentro };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmhccsf.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmhccsf.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        CrudKnmhccsf.CrudDetalle(desktopSession, 0, crudDet);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmhccsf.CrudDetalle(desktopSession, 1, crudDet);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
