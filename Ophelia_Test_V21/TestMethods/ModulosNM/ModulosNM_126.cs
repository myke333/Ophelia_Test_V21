...
{
    [TestClass]
    public class ModulosNM_126 : FuncionesVitales
    {
        ...
        public void KNmHdiseChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_126.KNmHdiseChecKlist")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["EditIden"].ToString().Length != 0 && rows["EditIden"].ToString() != null &&
...

                            {
                                ...
                                //Variables crud Principal
                                string EditIden = rows["EditIden"].ToString();
                                ...
                                List<string> crudPrincipal = new List<string>() { Proporcion, EditIden };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmhdise.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        ...
                                        CrudKnmhdise.AgregarCrud(desktopSession, 1, crudPrincipal);
        ...
        public void KNmInfsiChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_126.KNmInfsiChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
...

                            {
                                ...
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { EditIden };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnminfsi.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnminfsi.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
        ...
        public void KNmLiqfpChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_126.KNmLiqfpChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmliqfp.AgregarCrud(desktopSession);
                                        ...
                                        CrudKnmliqfp.Aceptar(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Validar Datos", true, file);
                                        Thread.Sleep(5000);
                                        CrudKnmliqfp.Enter(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Validar Datos", true, file);
                                        Thread.Sleep(10000);
                                        CrudKnmliqfp.Errores(desktopSession);
                                        Thread.Sleep(3000);
        ...
        public void KNmPaconChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_126.KNmPaconChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                //Variables Crud principal
                                rows["Protocolo"].ToString().Length != 0 && rows["Protocolo"].ToString() != null &&
                                rows["EditProtocolo"].ToString().Length != 0 && rows["EditProtocolo"].ToString() != null &&
...

                            {
                                ...
                                //Variables crud Principal
                                string Protocolo = rows["Protocolo"].ToString();
                                string EditProtocolo = rows["EditProtocolo"].ToString();
                                ...
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Protocolo, EditProtocolo };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmpacon.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmpacon.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
        ...
        public void KNmPaeptChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_126.KNmPaeptChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmpaept.Aceptar(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Validar Datos", true, file);
                                        Thread.Sleep(5000);
                                        CrudKnmpaept.Enter(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Validar Datos", true, file);
                                        Thread.Sleep(10000);
                                        CrudKnmpaept.Errores(desktopSession);
                                        Thread.Sleep(3000);
                                        string pdf1 = @"C:\Reportes\ReportePDF1_" + "Errores" + "_" + Hora();
                                        errors = newFunctions_5.GenerarReportes("Preliminar", file, pdf1, nomProgram);
                                        if (errors.Count > 0) { foreach (string er in errors) { errorMessages.Add(er); } }
        ...
        public void KNmPaturChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_126.KNmPaturChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmpatur.Aceptar(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Validar Datos", true, file);
                                        Thread.Sleep(5000);
                                        CrudKnmpatur.Enter(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Validar Datos", true, file);
                                        Thread.Sleep(10000);
                                        //CrudKnmpatur.Informe(desktopSession);
                                        //Thread.Sleep(3000);
                                        //string pdf1 = @"C:\Reportes\ReportePDF1_" + "Errores" + "_" + Hora();
                                        //errors = newFunctions_5.GenerarReportes("Preliminar", file, pdf1, nomProgram);
                                        //if (errors.Count > 0) { foreach (string er in errors) { errorMessages.Add(er); } }
        ...
        public void KNmPsfacChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_126.KNmPsfacChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
...

                            {
                                ...
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Nombre, EditNombre};

                                //LISTA CRUD DETALLE
                                List<string> crudDet = new List<string>() { CodigoProt };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmpsfac.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmpsfac.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        botonesNavegador2 = PruebaCRUD.findname(desktopSession, 20, 1);
                                        ...
                                        CrudKnmpsfac.CrudDetalle(desktopSession, 0, crudDet);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmpsfac.CrudDetalle(desktopSession, 1, crudDet);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
        ...
        public void KNmRanftChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_126.KNmRanftChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmranft.AgregarCrud(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Ingresar Datos", true, file);
                                        Thread.Sleep(5000);
                                        ...
                                        CrudKnmranft.Preliminar(desktopSession);
                                        Thread.Sleep(3000);
                                        CrudKnmranft.Enter(desktopSession);
                                        Thread.Sleep(3000);
                                        CrudKnmranft.Enter(desktopSession);
                                        Thread.Sleep(3000);
                                        string pdf1 = @"C:\Reportes\ReportePDF1_" + "Preliminar" + "_" + Hora();
