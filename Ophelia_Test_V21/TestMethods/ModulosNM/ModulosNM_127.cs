...
{
    [TestClass]
    public class ModulosNM_127 : FuncionesVitales
    {
        ...
        public void KNmRcnmcChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_127.KNmRcnmcChecKlist")
                {
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmrcnmc.AgregarCrud(desktopSession);
                                        ...
                                        CrudKnmrcnmc.Preliminar(desktopSession);
                                        Thread.Sleep(3000);
        ...
        public void KNmRcpspChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_127.KNmRcpspChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmrcpsp.AgregarCrud(desktopSession, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Ingresar Datos", true, file);
                                        Thread.Sleep(5000);
                                        ...
                                        CrudKnmrcpsp.Enter(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Mensaje de errores", true, file);
                                        Thread.Sleep(5000);

                                        CrudKnmrcpsp.Errores(desktopSession);
                                        Thread.Sleep(3000);
                                        string pdf = @"C:\Reportes\ReportePDF1_" + "Errores" + "_" + Hora();
                                        errors = newFunctions_5.GenerarReportes("Preliminar", file, pdf, nomProgram);
                                        if (errors.Count > 0) { foreach (string er in errors) { errorMessages.Add(er); } }
        ...
        public void KNmRdeapChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_127.KNmRdeapChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmrdeap.AgregarCrud(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Ingresar Datos", true, file);
                                        Thread.Sleep(5000);
                                        ...
                                        CrudKnmrdeap.Aceptar(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Validar Datos", true, file);
                                        Thread.Sleep(5000);
                                        string pdf1 = @"C:\Reportes\ReportePDF1_" + "Reporte" + "_" + Hora();
        ...
        public void KNmRdevlChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_127.KNmRdevlChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmrdevl.AgregarCrud(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Ingresar Datos", true, file);
                                        Thread.Sleep(5000);
                                        ...
                                        CrudKnmrdevl.Aceptar(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Validar Datos", true, file);
                                        Thread.Sleep(5000);
                                        string pdf1 = @"C:\Reportes\ReportePDF1_" + "Reporte" + "_" + Hora();
                                        errors = newFunctions_5.GenerarReportes("Preliminar", file, pdf1, nomProgram);
        ...
        public void KNmRlfacChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_127.KNmRlfacChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmrlfac.AgregarCrud(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Ingresar Datos", true, file);
                                        Thread.Sleep(5000);
                                        ...
                                        CrudKnmrlfac.Aceptar(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Validar Datos", true, file);
                                        Thread.Sleep(25000);
        ...
        public void KNmRpr07ChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_127.KNmRpr07ChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
