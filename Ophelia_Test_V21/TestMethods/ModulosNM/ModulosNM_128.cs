...
{
    [TestClass]
    public class ModulosNM_128 : FuncionesVitales
    {
        ...
        public void KNmPreinChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_128.KNmPreinChecKlist")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["FechaSueldo"].ToString().Length != 0 && rows["FechaSueldo"].ToString() != null &&
                                ...
                                rows["FechaContr"].ToString().Length != 0 && rows["FechaContr"].ToString() != null &&
                                rows["ActSecuencial"].ToString().Length != 0 && rows["ActSecuencial"].ToString() != null &&

                                //Crud det 1
                                rows["CodigoVariable"].ToString().Length != 0 && rows["CodigoVariable"].ToString() != null &&
...

                            {
                                ...
                                string FechaSueldo = rows["FechaSueldo"].ToString();
                                string Secuencial = rows["Secuencial"].ToString();
                                string Centro = rows["Centro"].ToString();
                                string Estado = rows["Estado"].ToString();
                                string FechaContr = rows["FechaContr"].ToString();
                                string ActSecuencial = rows["ActSecuencial"].ToString();

                                //Variables curd det
                                string CodigoVariable = rows["CodigoVariable"].ToString();
                                ...
                                List<string> crudPrincipal = new List<string>() { Id, FechaSueldo, Secuencial, Centro, Estado, FechaContr, ActSecuencial };
                                List<string> crudDet = new List<string>() { CodigoVariable, ValorVariable, ActValor };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmprein.CrudPrincipal(desktopSession, 0, crudPrincipal,file);
                                        ...
                                        Thread.Sleep(1500);
                                        CrudKnmprein.CrudPrincipal(desktopSession, 1, crudPrincipal, file);
                                        ...
                                        Thread.Sleep(1000);
                                        CrudKnmprein.CrudDet(desktopSession, 2, crudDet, file);
                                        Thread.Sleep(1000);
                                        ...
                                        CrudKnmprein.CrudDet(desktopSession, 0, crudDet, file);
                                        ...
                                        CrudKnmprein.CrudDet(desktopSession, 1, crudDet, file);
        ...
        public void KNmPro23ChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_128.KNmPro23ChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
...

                            {
                                ...
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Año, Fecha };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmpro23.CrudPrincipal(desktopSession, 0, crudPrincipal, file);
                                        Thread.Sleep(1000);
                                        newFunctions_4.ScreenshotNuevo("Insercion de datos", true, file);
                                        ...
                                        Thread.Sleep(1500);
                                        CrudKnmpro23.CrudPrincipal(desktopSession, 1, crudPrincipal, file);
        ...
        public void KNmIncapChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_128.KNmIncapChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["NumIncapacidad"].ToString().Length != 0 && rows["NumIncapacidad"].ToString() != null &&
                                rows["CodigoDiagnostico"].ToString().Length != 0 && rows["CodigoDiagnostico"].ToString() != null &&
                                ...
                                rows["Ips"].ToString().Length != 0 && rows["Ips"].ToString() != null &&
...

                            {
                                ...
                                string NumIncapacidad = rows["NumIncapacidad"].ToString();
                                string CodigoDiagnostico = rows["CodigoDiagnostico"].ToString();
                                string NumDias = rows["NumDias"].ToString();
                                string Fechas = rows["Fechas"].ToString();
                                string Entidad = rows["Entidad"].ToString();
                                string Ips = rows["Ips"].ToString();
                                ...
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Id, Codigo, NumIncapacidad, CodigoDiagnostico, NumDias, Fechas, Entidad, Ips, Num, Obs, ActObs };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmincap.CrudPrincipal(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);

                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Aplicar"].X, botonesNavegador["Aplicar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        newFunctions_4.ScreenshotNuevo("Ventana al intentar guardar", true, file);
                                        CrudKnmincap.Enter(desktopSession);                                  
                                        ...
                                        newFunctions_4.ScreenshotNuevo("Editar", true, file);
                                        Thread.Sleep(1500);
                                        CrudKnmincap.CrudPrincipal(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Editar Datos Crud Principal", true, file);
                                        Thread.Sleep(1500);
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Cancelar"].X, botonesNavegador["Cancelar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        ...
                                        //CrudKnmincap.Reportes(desktopSession, 0, file);
                                        //Thread.Sleep(1000);
                                        ...
                                        //Thread.Sleep(2000);
                                        //CrudKnmincap.Reportes(desktopSession, 1, file);
                                        //Thread.Sleep(1000);
                                        ...
                                        PruebaCRUD.EliminarRegistro(desktopSession, ElementList[0], botonesNavegador, file);
                                        newFunctions_4.ScreenshotNuevo("Mensaje al eliminar", true, file);
                                        CrudKnmincap.Enter(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Datos Eliminados Principal", true, file);
                                        //VALIDACIÓN ELIMINAR REGISTRO
                                        ErrorValidacion = ValidacionesQueries.ValidacionLogbo(Tabla, motor, user, Campo, Codigo, "D", c, ErrorValidacion);
        ...
        public void KNmCoddeChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_128.KNmCoddeChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["CodigoDemanda"].ToString().Length != 0 && rows["CodigoDemanda"].ToString() != null &&
                                rows["DescDemanda"].ToString().Length != 0 && rows["DescDemanda"].ToString() != null &&
                                rows["Obs"].ToString().Length != 0 && rows["Obs"].ToString() != null &&
                                rows["ActObs"].ToString().Length != 0 && rows["ActObs"].ToString() != null &&
...

                            {
                                ...
                                string CodigoDemanda = rows["CodigoDemanda"].ToString();
                                string DescDemanda = rows["DescDemanda"].ToString();
                                string Obs = rows["Obs"].ToString();
                                string ActObs = rows["ActObs"].ToString();
                                ...
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { CodigoDemanda, DescDemanda, Obs, ActObs };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmcodde.CrudPrincipal(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        newFunctions_4.ScreenshotNuevo("Editar", true, file);
                                        Thread.Sleep(1500);
                                        CrudKnmcodde.CrudPrincipal(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Editar Datos Crud Principal", true, file);
                                        Thread.Sleep(1500);
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Cancelar"].X, botonesNavegador["Cancelar"].Y);
                                        desktopSession.Mouse.Click(null);
        ...
        public void KNmHocofChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_128.KNmHocofChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
...

                            {
                                ...
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Contr, id, Fecha , Obs, ActObs };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmhocof.CrudPrincipal(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        newFunctions_4.ScreenshotNuevo("Editar", true, file);
                                        Thread.Sleep(1500);
                                        CrudKnmhocof.CrudPrincipal(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Editar Datos Crud Principal", true, file);
                                        Thread.Sleep(1500);
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Cancelar"].X, botonesNavegador["Cancelar"].Y);
                                        desktopSession.Mouse.Click(null);
