...
{
    [TestClass]
    public class ModulosNM_129 : FuncionesVitales
    {
        ...
        public void KNmHsupaChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_129.KNmHsupaChecKlist")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                //Variables Validaciones Crud Principal     fechaSustitucion                           
                                rows["Contrato"].ToString().Length != 0 && rows["Contrato"].ToString() != null &&
                                rows["fechaSustitucion"].ToString().Length != 0 && rows["fechaSustitucion"].ToString() != null &&
                                rows["ActfechaSustitucion"].ToString().Length != 0 && rows["ActfechaSustitucion"].ToString() != null &&
...

                            {
                                ...
                                string fechaSustitucion = rows["fechaSustitucion"].ToString();
                                string ActfechaSustitucion = rows["ActfechaSustitucion"].ToString();


                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Contrato, fechaSustitucion, ActfechaSustitucion };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmhsupa.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        ...
                                        CrudKnmhsupa.AgregarCrud(desktopSession, 1, crudPrincipal);
        ...
        public void KNmThemsChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_129.KNmThemsChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                //Variables Validaciones Crud Principal     fechaSustitucion                           
                                rows["TopeMensual"].ToString().Length != 0 && rows["TopeMensual"].ToString() != null &&
                                rows["ActTopeMensual"].ToString().Length != 0 && rows["ActTopeMensual"].ToString() != null &&
...

                            {
                                ...
                                //Variables Crud principal                                
                                string TopeMensual = rows["TopeMensual"].ToString();
                                string ActTopeMensual = rows["ActTopeMensual"].ToString();
                                ...
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { TopeMensual, ActTopeMensual, CentroCostos };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmthems.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmthems.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
        ...
        public void KNmVianiChecklist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_129.KNmVianiChecklist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["NomRango"].ToString().Length != 0 && rows["NomRango"].ToString() != null &&
                                rows["ActNomRango"].ToString().Length != 0 && rows["ActNomRango"].ToString() != null &&
                                

                                //Variables Validaciones detalle 1
                                rows["CodNivel"].ToString().Length != 0 && rows["CodNivel"].ToString() != null &&
...

                            {
                                ...
                                string NomRango = rows["NomRango"].ToString();
                                string ActNomRango = rows["ActNomRango"].ToString();
                                ...
                                string CodNivel = rows["CodNivel"].ToString();
                                ...
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { CodRango, NomRango, ActNomRango};
                                //LISTA DETALLE 1
                                List<string> crudDet1 = new List<string>() { CodNivel, Valor, Porcentaje, ActPorcentaje };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmviani.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmviani.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        CrudKnmviani.AgregarCrud1(desktopSession, 0, crudDet1);
                                        ...
                                        CrudKnmviani.AgregarCrud1(desktopSession, 1, crudDet1);
                                        ...
                                        //CrudKnmviani.ClickButton(desktopSession, 0);
                                        //Thread.Sleep(2000);
                                        ...
                                        //CrudKnmviani.ClickButton(desktopSession, 1);
