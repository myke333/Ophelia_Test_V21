...
{
    [TestClass]
    public class ModulosNM_133 : FuncionesVitales
    {
        ...
        public void KNmDpaceChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_133.KNmDpaceChecKlist")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
...

                            {
                                ...
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Año, Costo, Pais, Cedula, Nom1, Nom2, Obs, ActObs };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmdpace.CrudPrincipal(desktopSession, 0, crudPrincipal, file);
                                        ...
                                        Thread.Sleep(1500);
                                        CrudKnmdpace.CrudPrincipal(desktopSession, 1, crudPrincipal, file);
        ...
        public void KNmPacotChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_133.KNmPacotChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["Desc"].ToString().Length != 0 && rows["Desc"].ToString() != null &&
                                rows["Prot"].ToString().Length != 0 && rows["Prot"].ToString() != null &&
                                rows["ActDesc"].ToString().Length != 0 && rows["ActDesc"].ToString() != null &&
...

                            {
                                ...
                                string Desc = rows["Desc"].ToString();
                                string Prot = rows["Prot"].ToString();
                                string ActDesc = rows["ActDesc"].ToString();
                                ...
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Desc, Prot, ActDesc };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmpacot.CrudPrincipal(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        newFunctions_4.ScreenshotNuevo("Editar", true, file);
                                        Thread.Sleep(1500);
                                        CrudKnmpacot.CrudPrincipal(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Editar Datos Crud Principal", true, file);
                                        Thread.Sleep(1500);
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Cancelar"].X, botonesNavegador["Cancelar"].Y);
                                        desktopSession.Mouse.Click(null);
