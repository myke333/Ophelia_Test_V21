...
{
    [TestClass]
    public class ModulosNM_135 : FuncionesVitales
    {
        ...
        public void KNmJedesChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_135.KNmJedesChecKlist")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["CarReDJ"].ToString().Length != 0 && rows["CarReDJ"].ToString() != null &&
                                rows["CarRePD"].ToString().Length != 0 && rows["CarRePD"].ToString() != null &&
...

                            {
                                ...
                                string CarReDJ = rows["CarReDJ"].ToString();
                                string CarRePD = rows["CarRePD"].ToString();
                                ...
                                List<string> crudPrincipal = new List<string>() { rol, CarReDJ, CarRePD, Cod, Nom};
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmjedes.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        ...
                                        CrudKnmjedes.AgregarCrud(desktopSession, 1, crudPrincipal);
        ...
        public void KNmDptdoChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_135.KNmDptdoChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                //Datos Crud principal
                                rows["codDepa"].ToString().Length != 0 && rows["codDepa"].ToString() != null &&
                                rows["nomDepa"].ToString().Length != 0 && rows["nomDepa"].ToString() != null &&
...

                            {
                                ...
                                //Variables Crud principal
                                string codDepa = rows["codDepa"].ToString();
                                string nomDepa = rows["nomDepa"].ToString();
                                ...
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() {codDepa, nomDepa, codArea};
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmDptdo.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmDptdo.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
        ...
        public void KNmSaldiChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_135.KNmSaldiChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["pagoAño"].ToString().Length != 0 && rows["pagoAño"].ToString() != null &&
                                rows["diasTraba"].ToString().Length != 0 && rows["diasTraba"].ToString() != null &&
                                rows["salaDig"].ToString().Length != 0 && rows["salaDig"].ToString() != null &&
                                rows["dife"].ToString().Length != 0 && rows["dife"].ToString() != null &&
                                rows["acumuAño"].ToString().Length != 0 && rows["acumuAño"].ToString() != null &&
                                rows["proySD"].ToString().Length != 0 && rows["proySD"].ToString() != null)

                            {
                                ...
                                string pagoAño = rows["pagoAño"].ToString();
                                string diasTraba = rows["diasTraba"].ToString();
                                string salaDig = rows["salaDig"].ToString();
                                string dife = rows["dife"].ToString();
                                string acumuAño = rows["acumuAño"].ToString();
                                string proySD = rows["proySD"].ToString();
                                ...
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { contrato, fechaLiq, pagoAño, diasTraba, salaDig, dife, acumuAño, proySD };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmSaldi.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmSaldi.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
