...
{
    /// <summary>
    /// Descripción resumida de ModulosNM_37
    /// </summary>
    [TestClass]
    public class ModulosNM_37 : FuncionesVitales
    {
        ...
        public void KNmUnempCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_37.KNmUnempCheckList")
                {
        ...
        public void KNmUnestCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_37.KNmUnestCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                                ...
                                )
                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmunest.CRUDKnmunest(desktopSession, 1, crudVariables);
                                        ...
                                        CrudKnmunest.CRUDKnmunest(desktopSession, 2, crudVariables);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, Nombre, "NOM_UNES", c, ErrorValidacion, "No se descarto correctamente", 1);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, Editar, "NOM_UNES", c, ErrorValidacion, "El registro no se editó correctamente", 1);
...

        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_37.KNmUtnomCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void KNmValpeCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_37.KNmValpeCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["FechaD"].ToString().Length != 0 && rows["FechaD"].ToString() != null &&
                                ...
                                )
                            {
                                ...
                                string FechaD = rows["FechaD"].ToString();
                                string FechaF = rows["FechaF"].ToString();
                                string Editar = rows["Editar"].ToString();
                                List<string> crudVariables = new List<string>() { Parametro, FechaD, FechaF, Editar };
                                //CREAR EL DOCUMENTO DEL REPORTE DE LA PRUEBA
                                string file = CrearDocumentoWordDinamico(codProgram, "NM", motor);
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmvalpe.CRUDKnmvalpe(desktopSession, 1, crudVariables);
                                        ...
                                        CrudKnmvalpe.CRUDKnmvalpe(desktopSession, 2, crudVariables);
                                        newFunctions_4.ScreenshotNuevo("Editar Registro", true, file);
                                        ...
                                        //Validacion Editar Descartar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Parametro, FechaF, "FEC_HAST", c, ErrorValidacion, "No se descarto correctamente", 1);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Parametro, Editar, "FEC_HAST", c, ErrorValidacion, "El registro no se editó correctamente", 1);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Parametro, "", Campo, c, ErrorValidacion, "los datos no se eliminaron correctamente", 2);
                                    }
                                    else
                                    {
                                        ErrorValidacion.Add($"El programa no puede ser leido : {codProgram}");
        ...
        public void KNmHemvaCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_37.KNmHemvaCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                                ...
                                )
                            {
                                ...
                                string Editar = rows["Editar"].ToString();
                                List<string> crudVariables = new List<string>() { ID, Tipo, Fecha, Editar };
                                //CREAR EL DOCUMENTO DEL REPORTE DE LA PRUEBA
                                string file = CrearDocumentoWordDinamico(codProgram, "NM", motor);
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmhemva.CRUDKnmhemva(desktopSession, 1, crudVariables);
                                        ...
                                        CrudKnmhemva.CRUDKnmhemva(desktopSession, 2, crudVariables);
                                        newFunctions_4.ScreenshotNuevo("Editar Registro", true, file);
                                        ...
                                        //Validacion Editar Descartar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, QbeFilter, Fecha, "FEC_VIGE", c, ErrorValidacion, "No se descarto correctamente", 1);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, QbeFilter, Editar, "FEC_VIGE", c, ErrorValidacion, "El registro no se editó correctamente", 1);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, QbeFilter, "", Campo, c, ErrorValidacion, "los datos no se eliminaron correctamente", 2);
                                    }
                                    else
                                    {
                                        ErrorValidacion.Add($"El programa no puede ser leido : {codProgram}");
        ...
        public void KNmHentiCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_37.KNmHentiCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                                ...
                                )
                            {
                                ...
                                string Fecha = rows["Fecha"].ToString();
                                string Editar = rows["Editar"].ToString();
                                List<string> crudVariables = new List<string>() {Tipo, Codigo, Nombre, Fecha, Editar };
                                //CREAR EL DOCUMENTO DEL REPORTE DE LA PRUEBA
                                string file = CrearDocumentoWordDinamico(codProgram, "NM", motor);
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmhenti.CRUDKnmhenti(desktopSession, 1, crudVariables);
                                        ...
                                        CrudKnmhenti.CRUDKnmhenti(desktopSession, 2, crudVariables);
                                        newFunctions_4.ScreenshotNuevo("Editar Registro", true, file);
                                        ...
                                        //Validacion Editar Descartar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, Nombre, "NOM_ENTI", c, ErrorValidacion, "No se descarto correctamente", 1);
                                        ...
                                        Thread.Sleep(1000);
                                        ErrorValidacion = ValidacionesQueries.ValidacionLogbo(Tabla, motor, user, Campo, Codigo, "E", c, ErrorValidacion);
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, Editar, "NOM_ENTI", c, ErrorValidacion, "El registro no se editó correctamente", 1);
        ...
        public void KNmHextrCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_37.KNmHextrCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["HoraI"].ToString().Length != 0 && rows["HoraI"].ToString() != null &&
                                rows["FechaF"].ToString().Length != 0 && rows["FechaF"].ToString() != null &&
                                rows["HoraF"].ToString().Length != 0 && rows["HoraF"].ToString() != null &&
                                rows["HorasE"].ToString().Length != 0 && rows["HorasE"].ToString() != null &&
                                ...
                                )
                            {
                                ...
                                string HoraI = rows["HoraI"].ToString();
                                string FechaF = rows["FechaF"].ToString();
                                string HoraF = rows["HoraF"].ToString();
                                string HorasE = rows["HorasE"].ToString();
                                string Estado = rows["Estado"].ToString();
                                string Editar = rows["Editar"].ToString();
                                List<string> crudVariables = new List<string>() { ID, FechaI, HoraI, FechaF, HoraF, HorasE, Estado, Editar };
                                //CREAR EL DOCUMENTO DEL REPORTE DE LA PRUEBA
                                string file = CrearDocumentoWordDinamico(codProgram, "NM", motor);
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmhextr.CRUDKnmhextr(desktopSession, 1, crudVariables);
                                        ...
                                        CrudKnmhextr.CRUDKnmhextr(desktopSession, 2, crudVariables);
                                        newFunctions_4.ScreenshotNuevo("Editar Registro", true, file);
                                        ...
                                        //Validacion Editar Descartar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, ID, HorasE, "CAN_HOEX", c, ErrorValidacion, "No se descarto correctamente", 1);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, ID, Editar, "CAN_HOEX", c, ErrorValidacion, "El registro no se editó correctamente", 1);
