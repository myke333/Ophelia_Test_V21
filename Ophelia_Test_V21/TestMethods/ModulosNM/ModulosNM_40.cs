...
{
    /// <summary>
    /// Descripción resumida de ModulosNM_40
    /// </summary>
    [TestClass]
    public class ModulosNM_40 : FuncionesVitales
    {
        ...
        public void KNmRdnccChecklist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_40.KNmRdnccChecklist")
                {
                                ...
                                rows["BanderaSum"].ToString().Length != 0 && rows["BanderaSum"].ToString() != null)
                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        //Boton Imprimir
                                        CrudKnmrdncc.ImprimirKNmrdncc(desktopSession, file, TipoQbe, QbeFilter);
                                    }
                                    else
                                    {
        ...
        public void KNmLiqreChecklist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_40.KNmLiqreChecklist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                                ...
                                rows["codigo"].ToString().Length != 0 && rows["codigo"].ToString() != null)
                            {
                                ...
                                List<string> data = new List<string> { nroContr, codigo };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        errors = CrudKnmliqre.CrudKNmliqre(desktopSession, data, file);
                                        if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }
                                    }
                                    else
                                    {
        ...
        public void KNmGdpreChecklist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_40.KNmGdpreChecklist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                                ...
                                rows["lupa"].ToString().Length != 0 && rows["lupa"].ToString() != null)
                            {
                                ...
                                List<string> data = new List<string> { year, fechaIni, fechaFin, lupa };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        errors = CrudKnmgdpre.CrudKNmgdpre(desktopSession, data, file, TipoQbe, QbeFilter);
                                        if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }
                                    }
                                    else
                                    {
        ...
        public void KNmDaaumChecklist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_40.KNmDaaumChecklist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["porAumento"].ToString().Length != 0 && rows["porAumento"].ToString() != null &&
                                ...
                                rows["campoEdit"].ToString().Length != 0 && rows["campoEdit"].ToString() != null)
                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmdaaum.CrudKNmdaaum(desktopSession, 1, data);
                                        ...
                                        CrudKnmdaaum.CrudKNmdaaum(desktopSession, 2, data);
                                        ...
                                        //Validacion Editar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, id, editObs, campoEdit, c, ErrorValidacion, "No se editó correctamente", 1);
        ...
        public void KNmPaptuChecklist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_40.KNmPaptuChecklist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
