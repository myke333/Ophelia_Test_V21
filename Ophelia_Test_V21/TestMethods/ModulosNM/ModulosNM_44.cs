...
{
    /// <summary>
    /// Descripción resumida de ModulosNM_44
    /// </summary>
    [TestClass]
    public class ModulosNM_44:FuncionesVitales
    {
        ...
        public void AbrirPrograma()
        {
            ...
            string motor = "SQL";
            AbrirPrograma a = new AbrirPrograma("KEcRubro", "UCalida1");
            //string motor = "ORA";
            ...
            //string file = CrearDocumentoWordDinamico("KNmRprov", "PruebasCrud", motor);
            //List<string> crudVariables = new List<string> { "7", "102", "08/02/2021", "1234", "1234", "123", "1234" };
            ...
            //CrudKnmbasld.CRUD(desktopSession, 1, crudVariables, file);
            ...
            //CrudKnmbasld.CRUD(desktopSession, 2, crudVariables, file);
        ...
        public void KNmBasldCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_44.KNmBasldCheckList")
                {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                               ...
                               // @Codigo @Concepto @Fecha @Base @Concep @Doceava @EditarDoceava
                                ...
                                rows["Concep"].ToString().Length != 0 && rows["Concep"].ToString() != null &&
                                rows["Doceava"].ToString().Length != 0 && rows["Doceava"].ToString() != null &&
                                rows["EditarDoceava"].ToString().Length != 0 && rows["EditarDoceava"].ToString() != null 
                                ...
                                )
                            {
                                ...
                                string Concep = rows["Concep"].ToString();
                                string Doceava = rows["Doceava"].ToString();
                                string EditarDoceava = rows["EditarDoceava"].ToString();

                                List<string> crudVariables = new List<string>() { Codigo, Concepto, Fecha, Base, Concep , Doceava , EditarDoceava };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        //ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, Doceava, "VAL_DOCE", c, ErrorValidacion, "No se edito correctamente", 1);
                                        ...
                                        //ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, EditarDoceava, "VAL_DOCE", c, ErrorValidacion, "El registro no se editó correctamente", 1);
        ...
        public void KNmRcontCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_44.KNmRcontCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                                ...
                                )
                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        string pdf1 = @"C:\Reportes\ReportePDF1_" + "Preliminar" + "_" + Hora();
                                        errors = FuncionesGlobales.ReportePreliminar(desktopSession, BanderaPreli, file, pdf1);
                                        //CrudKnmrptva.Preliminar(desktopSession, file, pdf1);
                                        if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }
                                        //Rectificar Pie Pagina PDF PRELIMINAR
                                        listaResultado = Textopdf(pdf1, codProgram, user);
                                        listaResultado.ForEach(e => ErrorValidacion.Add(e));
        ...
        public void KNmRvapeCheckList()
        {
           ...
           // TableOrder = "ktes1";
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_44.KNmRvapeCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                                ...
                                )
                            {
                                ...
                                List<string> crudVariables = new List<string>() { Fecha1 };
                                //CREAR EL DOCUMENTO DEL REPORTE DE LA PRUEBA
                                string file = CrearDocumentoWordDinamico(codProgram, "NM", motor);
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        //AGREGAR DATOS
                                        CrudKnmrvape.CRUD(desktopSession, 1, crudVariables, file);
                                        ...
                                        string pdf1 = @"C:\Reportes\ReportePDF1_" + "Preliminar" + "_" + Hora();
                                        errors = FuncionesGlobales.ReportePreliminar(desktopSession, BanderaPreli, file, pdf1);
                                        CrudKnmrvape.Preliminar(desktopSession, file, pdf1);
                                        if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }
                                        //Rectificar Pie Pagina PDF PRELIMINAR
                                        listaResultado = Textopdf(pdf1, codProgram, user);
                                        listaResultado.ForEach(e => ErrorValidacion.Add(e));
        ...
        [TestMethod]public void KNmRptvaCheckList()
        {
            List<string> listaResultado;
            List<string> Celda = new List<string>();
            List<string> errorMessages = new List<string>();
           ...
           // TableOrder = "ktes1";
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_44.KNmRptvaCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void KNmRptieCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_44.KNmRptieCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void KNmRprovCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_44.KNmRprovCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                                ...
                                )
                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        //AGREGAR DATOS
                                        CrudKnmrprov.CRUD(desktopSession, 1, crudVariables, file);
