...
namespace Ophelia_Test_V21.TestMethods.ModulosNM
{
    ...
    [TestClass]
    public class ModulosNM_48 : FuncionesVitales
    {
        ...
        public void KNmCencaCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_48.KNmCencaCheckList")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            ...
                            if (
                                ...
                                rows["NombreSec"].ToString().Length != 0 && rows["NombreSec"].ToString() != null &&
                                rows["EditNombreSec"].ToString().Length != 0 && rows["EditNombreSec"].ToString() != null &&
                                ...
                                )
                            {
                                ...
                                string NombreSec = rows["NombreSec"].ToString();
                                string EditNombreSec = rows["EditNombreSec"].ToString();
                                ...
                                Modulo = "NM";
                                List<string> crudVariables = new List<string>() { Identificacion, NombreSec, EditNombreSec };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmcenca.CRUD(desktopSession, 1, crudVariables, file);
                                        ...
                                        CrudKnmcenca.CRUD(desktopSession, 2, crudVariables, file);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Identificacion, NombreSec, EditCampo, c, ErrorValidacion, "No se edito correctamente", 1);
                                        //ACEPTAR EDICION
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Editar"].X, botonesNavegador["Editar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Identificacion, EditNombreSec, EditCampo, c, ErrorValidacion, "El registro no se editó correctamente", 1);
