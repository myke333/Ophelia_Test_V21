...
namespace Ophelia_Test_V21.TestMethods.ModulosNM
{
    ...
    /// </summary>
    [TestClass]
    public class ModulosNM_67 : FuncionesVitales
    {
        ...
        public void abrirprograma()
        {
            ...
            var prog = "knmlinom";
            //Debugger.Launch();
            AbrirPrograma a = new AbrirPrograma(prog, "UCalida1");
            ...
            Thread.Sleep(1000);
            //Thread.Sleep(50000);
            var Elementlist1 = desktopSession.FindElementsByClassName("TDBEdit");//TEdit
