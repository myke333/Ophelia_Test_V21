...
{
    /// <summary>
    /// Descripción resumida de ModulosNM_71
    /// </summary>
    [TestClass]
    public class ModulosNM_71 : FuncionesVitales
    {
...

        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_71.KNmNconcCheckList")
                {
...

        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_71.KNmHdecoCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["IndicadorCargo"].ToString().Length != 0 && rows["IndicadorCargo"].ToString() != null &&
                                rows["FechaMovimiento"].ToString().Length != 0 && rows["FechaMovimiento"].ToString() != null &&
                                rows["ValorVariable"].ToString().Length != 0 && rows["ValorVariable"].ToString() != null &&
                                rows["EditValorVariable"].ToString().Length != 0 && rows["EditValorVariable"].ToString() != null &&
                                ...
                                )
                            {
                                ...
                                string IndicadorCargo = rows["IndicadorCargo"].ToString();
                                string FechaMovimiento = rows["FechaMovimiento"].ToString();
                                string ValorVariable = rows["ValorVariable"].ToString();
                                string EditValorVariable = rows["EditValorVariable"].ToString();
                                ...
                                List<string> crudVariables = new List<string>() { Identificacion, Variable, Cargo, Estado, IndicadorCargo, FechaMovimiento, ValorVariable, EditValorVariable };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmhdeco.CRUD(desktopSession, 1, crudVariables, file);
                                        ...
                                        CrudKnmhdeco.CRUD(desktopSession, 2, crudVariables, file);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Identificacion, ValorVariable, EditCampo, c, ErrorValidacion, "No se edito correctamente", 1);
                                        Thread.Sleep(1000);
                                        //ACEPTAR EDICION
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Editar"].X, botonesNavegador["Editar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Identificacion, EditValorVariable, EditCampo, c, ErrorValidacion, "El registro no se editó correctamente", 1);
        ...
        public void KNmPreaiChecklist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_71.KNmPreaiChecklist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                                ...
                                
                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmpreai.AgregarCrud(desktopSession);
                                        Thread.Sleep(2000);
                                        newFunctions_4.ScreenshotNuevo("Abrir Programa", true, file);

                                        CrudKnmpreai.AgregarCrud2(desktopSession);
                                        Thread.Sleep(2000);
                                        newFunctions_4.ScreenshotNuevo("Abrir Programa", true, file);

                                        CrudKnmpreai.AgregarCrud3(desktopSession);
                                        Thread.Sleep(2000);
                                        newFunctions_4.ScreenshotNuevo("Abrir Programa", true, file);

                                        CrudKnmpreai.AgregarCrud4(desktopSession);
                                        Thread.Sleep(2000);
                                        newFunctions_4.ScreenshotNuevo("Abrir Programa", true, file);
                                    }
                                    else
        ...
        public void KNmCendoChecklist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_71.KNmCendoChecklist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
...

                            {
                                ...
                                List<string> crudPrincipal = new List<string>() { Codigo, Nombre, NombreAct, };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmcendo.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        ...
                                        CrudKnmcendo.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, NombreAct, EditCampo, c, ErrorValidacion, "El registro no se editó correctamente", 1);
        ...
        public void KNmPargtChecklist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_71.KNmPargtChecklist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["jornada"].ToString().Length != 0 && rows["jornada"].ToString() != null &&
                                rows["tope"].ToString().Length != 0 && rows["tope"].ToString() != null &&
                                rows["turnos"].ToString().Length != 0 && rows["turnos"].ToString() != null &&
                                rows["horas"].ToString().Length != 0 && rows["horas"].ToString() != null &&
                                rows["ActTurnos"].ToString().Length != 0 && rows["ActTurnos"].ToString() != null )

                            {
                                ...
                                string jornada = rows["jornada"].ToString();
                                string tope = rows["tope"].ToString();
                                string turnos = rows["turnos"].ToString();
                                string horas = rows["horas"].ToString();
                                string ActTurnos = rows["ActTurnos"].ToString();

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { grupo, jornada, tope, turnos,  horas, ActTurnos };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmpargt.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmpargt.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        ////Validacion Editar Descartar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, grupo, turnos, EditCampo, c, ErrorValidacion, "No se edito correctamente", 1);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, grupo, ActTurnos, EditCampo, c, ErrorValidacion, "El registro no se editó correctamente", 1);
        ...
        public void KNmDfadoChecklist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_71.KNmDfadoChecklist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["Fallas"].ToString().Length != 0 && rows["Fallas"].ToString() != null &&
                                rows["Ccosto"].ToString().Length != 0 && rows["Ccosto"].ToString() != null &&
                                rows["Cnovedades"].ToString().Length != 0 && rows["Cnovedades"].ToString() != null &&
                                rows["ActCnovedades"].ToString().Length != 0 && rows["ActCnovedades"].ToString() != null )
                                                                
                            {
                                ...
                                //Variables validacion 2
                                string Tabla2 = rows["Tabla2"].ToString();
                                string Campo2 = rows["Campo2"].ToString();
                                string EditCampo2 = rows["EditCampo2"].ToString();

                                //Variables crud principal
                                string Asignatura = "12";                               
                                string Fallas = rows["Fallas"].ToString(); 
                                string Ccosto = rows["Ccosto"].ToString();
                                string Cnovedades = rows["Cnovedades"].ToString();
                                string ActCnovedades = rows["ActCnovedades"].ToString();
                                ...
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Asignatura, Fallas, Ccosto, Cnovedades, ActCnovedades };                                                               
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        //CrudKnmdfado.AgregarCrud(desktopSession);
                                        CrudKnmdfado.LupaDinamica(desktopSession, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmdfado.AgregarCrud2(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmdfado.AgregarCrud2(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        ////Validacion Editar Descartar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla2, user, motor, Campo2, Asignatura, Cnovedades, EditCampo2, c, ErrorValidacion, "No se edito correctamente", 1);
                                        ...
                                        Thread.Sleep(1500);
                                        ////// //Debugger.Launch();
                                        ErrorValidacion = ValidacionesQueries.ValidacionLogbo(Tabla2, motor, user, Campo2, Asignatura, "E", c, ErrorValidacion);
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla2, user, motor, Campo2, Asignatura, ActCnovedades, EditCampo2, c, ErrorValidacion, "El registro no se editó correctamente", 1);
                                        ...
                                        newFunctions_4.ScreenshotNuevo("Datos Eliminados Principal", true, file);
                                        //VALIDACIÓN ELIMINAR REGISTRO
                                        ErrorValidacion = ValidacionesQueries.ValidacionLogbo(Tabla2, motor, user, Campo2, Asignatura, "D", c, ErrorValidacion);
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla2, user, motor, Campo2, Asignatura, "", Campo2, c, ErrorValidacion, "los datos no se eliminaron correctamente", 2);
