...
{
    /// <summary>
    /// Descripción resumida de ModulosNM_84
    /// </summary>
    [TestClass]
    public class ModulosNM_84 : FuncionesVitales
    {
        ...
        public void KNmPrctlChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_84.KNmPrctlChecKlist")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
...

                            {
                                ...
                                List<string> crudPrincipal = new List<string>() { Ano, Actano };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmprctl.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        ...
                                        CrudKnmprctl.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, Ano, EditCampo, c, ErrorValidacion, "No se edito correctamente", 1);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, Actano, EditCampo, c, ErrorValidacion, "El registro no se editó correctamente", 1);
        ...
        public void KNmActpaChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_84.KNmActpaChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmactpa.AgregarCrud(desktopSession);
                                        Thread.Sleep(6000);
                                        newFunctions_4.ScreenshotNuevo("QBE", true, file);

                                        CrudKnmactpa.AgregarCrud2(desktopSession);
                                        Thread.Sleep(2000);
                                        newFunctions_4.ScreenshotNuevo("ACEPTAR", true, file);

                                        CrudKnmactpa.AgregarCrud2(desktopSession);
                                        Thread.Sleep(2000);
                                        newFunctions_4.ScreenshotNuevo("", true, file);
        ...
        public void KNmGmensChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_84.KNmGmensChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void KNmMaposChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_84.KNmMaposChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
...

                            {
                                ...
                                string CodDime = rows["CodDime"].ToString();
                                string CodVariable = rows["CodVariable"].ToString();
                                string ActCodDimen = rows["ActCodDimen"].ToString();                               
                                ...
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Lupa, Nombre, ActNombre };

                                //LISTA DETALLE 1
                                List<string> crudDet1 = new List<string>() { CodDime, CodVariable, ActCodDimen };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        // Posicionamiento Botones CRUD Principal
                                        Dictionary<string, Point> botonesNavegador = new Dictionary<string, Point>();
                                        botonesNavegador = PruebaCRUD.findname(desktopSession, 30, 0);
                                        var ElementList = PruebaCRUD.NavClass(desktopSession);
                                        Thread.Sleep(2000);

                                        // Posicionamiento Botones CRUD Detalle
                                        ...
                                        CrudKnmmapos.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmmapos.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        CrudKnmmapos.AgregarCrudDet(desktopSession, 0, crudDet1);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmmapos.AgregarCrudDet(desktopSession, 1, crudDet1);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        errors = newFunctions_3.LupaAud(desktopSession, BanderaLupa, file);
                                        if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }
                                        // Eliminar Registro CRUD Detallle1
        ...
        public void KNmplcocChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_84.KNmplcocChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        //List<string> crudPrincipal = new List<string>() { Lupa1, Lupa2};

                                        //Thread.Sleep(2000);

                                        //CrudKnmploc.AgregarCrud(desktopSession);
        ...
        public void KNmPreulChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_84.KNmPreulChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["ActConsecutivo"].ToString().Length != 0 && rows["ActConsecutivo"].ToString() != null &&
                                rows["Fecha"].ToString().Length != 0 && rows["Fecha"].ToString() != null )

                            {
                                ...
                                string ActConsecutivo = rows["ActConsecutivo"].ToString();
                                string Codigo = "9";

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Identificacion, Concepto, Valor, Consecutivo, Fecha, ActConsecutivo };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmpreui.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmpreui.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        ////Validacion Editar Descartar
                                        //ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, Consecutivo, EditCampo, c, ErrorValidacion, "No se edito correctamente", 1);
                                        ...
                                        ////// //Debugger.Launch();
                                        //ErrorValidacion = ValidacionesQueries.ValidacionLogbo(Tabla, motor, user, Campo, Codigo, "E", c, ErrorValidacion);
                                        //ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, ActConsecutivo, EditCampo, c, ErrorValidacion, "El registro no se editó correctamente", 1);
        ...
        //        if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_84.KNmPrpleChecKlist")
        //        {
        //            DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
        //            string endstatus = null;
        //            foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        //                                CrudKnmprple.AgregarCrud(desktopSession);
        ...
        //                                CrudKnmprple.AgregarCrud2(desktopSession);
        //                                newFunctions_4.ScreenshotNuevo("BOTON ACEPTAR", true, file);

        //                                Thread.Sleep(2000);

        //                                CrudKnmprple.AgregarCrud3(desktopSession);
        //                                newFunctions_4.ScreenshotNuevo("PROCESO 1", true, file);

        //                                Thread.Sleep(8000);

        //                                CrudKnmprple.AgregarCrud3(desktopSession);
        //                                newFunctions_4.ScreenshotNuevo("FIN PROCESO", true, file);
