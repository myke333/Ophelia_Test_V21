...
{    
    [TestClass]
    public class ModulosNM_85 : FuncionesVitales
    {
        ...
        public void KNmPrsruChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_85.KNmPrsruChecKlist")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["ActConcepto1"].ToString().Length != 0 && rows["ActConcepto1"].ToString() != null &&

                                //Datos Cruds detalle 2

                                rows["Concepto2"].ToString().Length != 0 && rows["Concepto2"].ToString() != null &&
                                rows["ActConcepto2"].ToString().Length != 0 && rows["ActConcepto2"].ToString() != null &&

                                //Datos Cruds detalle 3

                                rows["Concepto3"].ToString().Length != 0 && rows["Concepto3"].ToString() != null &&
                                rows["ActConcepto3"].ToString().Length != 0 && rows["ActConcepto3"].ToString() != null )

                            {
                                ...
                                string TablaDetalle2 = rows["TablaDetalle1"].ToString();
                                string CampoDetalle2 = rows["CampoDetalle1"].ToString();
                                string EditCampoDetalle2 = rows["EditCampoDetalle1"].ToString();

                                //Variables validacion DETALLE 3
                                string TablaDetalle3 = rows["TablaDetalle1"].ToString();
                                string CampoDetalle3 = rows["CampoDetalle1"].ToString();
                                string EditCampoDetalle3 = rows["EditCampoDetalle1"].ToString();
                                ...
                                string ActConcepto1 = rows["ActConcepto1"].ToString();

                                //Variables Crud Det 2
                                string Concepto2 = rows["Concepto2"].ToString();
                                string ActConcepto2 = rows["ActConcepto2"].ToString();

                                //Variables Crud Det 3
                                string Concepto3 = rows["Concepto3"].ToString();
                                string ActConcepto3 = rows["ActConcepto3"].ToString();

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Codigo, Nombre, Ccosto, Presupuesto, ActNombre };
                                //LISTA DETALLE 1
                                List<string> crudDet1 = new List<string>() { Concepto1, ActConcepto1};
                                //LISTA DETALLE 2
                                List<string> crudDet2 = new List<string>() { Concepto2, ActConcepto2 };
                                //LISTA DETALLE 3
                                List<string> crudDet3 = new List<string>() { Concepto3, ActConcepto3 };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(TablaDetalle3, user, motor, CampoDetalle3, Codigo, Codigo, CampoDetalle3, c, ErrorValidacion, "No se agregó correctamente", 0, "1");
                                        ...
                                        botonesNavegador2 = PruebaCRUD.findname(desktopSession, 28, 3);
                                        var ElementList2 = PruebaCRUD.NavClass(desktopSession);
                                        desktopSession.Mouse.MouseMove(ElementList2[3].Coordinates, botonesNavegador2["Insertar"].X, botonesNavegador2["Insertar"].Y);
                                        desktopSession.Mouse.Click(null);

                                        CrudKnmprsru.AgregarCrud1(desktopSession, 0, crudDet1);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);

                                        desktopSession.Mouse.MouseMove(ElementList2[3].Coordinates, botonesNavegador2["Aplicar"].X, botonesNavegador2["Aplicar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        newFunctions_4.ScreenshotNuevo("Datos Insertados", true, file);
                                        ...
                                        ////DESCARTAR EDICION
                                        desktopSession.Mouse.MouseMove(ElementList2[3].Coordinates, botonesNavegador2["Editar"].X, botonesNavegador2["Editar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        newFunctions_4.ScreenshotNuevo("Editar", true, file);

                                        CrudKnmprsru.AgregarCrud1(desktopSession, 1, crudDet1);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);

                                        desktopSession.Mouse.MouseMove(ElementList2[3].Coordinates, botonesNavegador2["Cancelar"].X, botonesNavegador2["Cancelar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        newFunctions_4.ScreenshotNuevo("Cancelar Datos Editados", true, file);
                                        ...
                                        botonesNavegador3 = PruebaCRUD.findname(desktopSession, 28, 2);
                                        var ElementList3 = PruebaCRUD.NavClass(desktopSession);
                                        desktopSession.Mouse.MouseMove(ElementList2[2].Coordinates, botonesNavegador3["Insertar"].X, botonesNavegador3["Insertar"].Y);
                                        desktopSession.Mouse.Click(null);

                                        CrudKnmprsru.AgregarCrud2(desktopSession, 0, crudDet2);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmprsru.AgregarCrud2(desktopSession, 1, crudDet2);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        ////Validacion Editar Descartar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(TablaDetalle2, user, motor, CampoDetalle2, Codigo, Nombre, EditCampoDetalle2, c, ErrorValidacion, "No se edito correctamente", 1);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(TablaDetalle2, user, motor, CampoDetalle2, Codigo, ActNombre, EditCampoDetalle2, c, ErrorValidacion, "El registro no se editó correctamente", 1);

                                        Thread.Sleep(2000);

                                        ////AGREGAR REGISTRO DETALLE 3                                        
                                        Dictionary<string, Point> botonesNavegador4 = new Dictionary<string, Point>();
                                        botonesNavegador4 = PruebaCRUD.findname(desktopSession, 28, 1);
                                        ...
                                        CrudKnmprsru.AgregarCrud3(desktopSession, 0, crudDet3);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        ////Validacion Agregar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(TablaDetalle3, user, motor, CampoDetalle3, Codigo, Codigo, CampoDetalle3, c, ErrorValidacion, "No se agregó correctamente", 0);
                                        ...
                                        CrudKnmprsru.AgregarCrud3(desktopSession, 1, crudDet3);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        ////Validacion Editar Descartar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(TablaDetalle3, user, motor, CampoDetalle3, Codigo, Nombre, EditCampoDetalle1, c, ErrorValidacion, "No se edito correctamente", 1);
                                        ...
                                        Thread.Sleep(1500);
                                        //Debugger.Launch();
                                        ErrorValidacion = ValidacionesQueries.ValidacionLogbo(TablaDetalle3, motor, user, CampoDetalle3, Codigo, "E", c, ErrorValidacion);
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(TablaDetalle3, user, motor, CampoDetalle3, Codigo, ActNombre, EditCampoDetalle1, c, ErrorValidacion, "El registro no se editó correctamente", 1);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(TablaDetalle1, user, motor, CampoDetalle1, Codigo, "", CampoDetalle2, c, ErrorValidacion, "los datos no se eliminaron correctamente", 2);
                                        ...
                                        PruebaCRUD.EliminarRegistro(desktopSession, ElementList2[3], botonesNavegador2, file);
                                        newFunctions_4.ScreenshotNuevo("Datos Eliminados Detalle 1", true, file);
                                        //VALIDACIÓN ELIMINAR REGISTRO
        ...
        public void KNmPrvecChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_85.KNmPrvecChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                //Datos Cruds Fecha2
                                rows["Identificacicon"].ToString().Length != 0 && rows["Identificacicon"].ToString() != null &&
...

                            {
                                ...
                                //Variables crud principal @Fecha2 
                                string Identificacicon = rows["Identificacicon"].ToString();
                                ...
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Identificacicon, Fecha, Dias, Dinero, Fecha2, ActDias };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        //ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Identificacicon, Identificacicon, Campo, c, ErrorValidacion, "No se agregó correctamente", 0, "1");
                                        ...
                                        CrudKnmPrvec.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        //////Validacion Agregar
                                        //ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Identificacicon, Identificacicon, Campo, c, ErrorValidacion, "No se agregó correctamente", 0);
                                        ...
                                        CrudKnmPrvec.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        //////Validacion Editar Descartar
                                        //ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Identificacicon, Dias, EditCampo, c, ErrorValidacion, "No se edito correctamente", 1);
                                        ...
                                        //Thread.Sleep(1500);
                                        //////// //Debugger.Launch();
                                        //ErrorValidacion = ValidacionesQueries.ValidacionLogbo(Tabla, motor, user, Campo, Identificacicon, "E", c, ErrorValidacion);
                                        //ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Identificacicon, ActDias, EditCampo, c, ErrorValidacion, "El registro no se editó correctamente", 1);
                                        ...
                                        ////VALIDACIÓN ELIMINAR REGISTRO
                                        //ErrorValidacion = ValidacionesQueries.ValidacionLogbo(Tabla, motor, user, Campo, Identificacicon, "D", c, ErrorValidacion);
                                        //ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Identificacicon, "", Campo, c, ErrorValidacion, "los datos no se eliminaron correctamente", 2);
        ...
        public void KNmAplvaChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_85.KNmAplvaChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
...

                            {
                                ...
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Codigo, Secuencial, Fecha, Valor, ActValor };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmaplva.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmaplva.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
        ...
        public void KNmAret1ChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_85.KNmAret1ChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                                 ...
                                 
                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmaret1.AgregarCrud(desktopSession, crudVariables);
                                        newFunctions_4.ScreenshotNuevo("datos para el qbe", true, file);

                                        //QBE
                                        errors = FuncionesGlobales.QBEQry(desktopSession, TipoQbe, QbeFilter, file);
                                        if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }

                                        CrudKnmaret1.Click(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("boton aceptar", true, file);

                                        CrudKnmaret1.Enter(desktopSession);
                                        ...
                                        CrudKnmaret1.Errores(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Boton de errores", true, file);
        ...
        public void KNmAsfheChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_85.KNmAsfheChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
...

                            {
                                ...
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal1 = new List<string>() { ActLupa };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmasfhe.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmasfhe.AgregarCrud(desktopSession, 1, crudPrincipal1);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
