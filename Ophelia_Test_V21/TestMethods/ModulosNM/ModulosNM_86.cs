...
{
    [TestClass]
    public class ModulosNM_86 : FuncionesVitales
    {
        ...
        public void KNmPrtpuChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_86.KNmPrtpuChecKlist")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
...

                            {
                                ...
                                List<string> crudPrincipal = new List<string>() { Cargo, Puntaje, Puntos, ActCargo };
                                //LISTA DETALLE 1
                                List<string> crudDet1 = new List<string>() { Modalidad, Cantidad, ActCantidad };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmprtpu2.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        ...
                                        CrudKnmprtpu2.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        ...
                                        CrudKnmprtpu2.Click(desktopSession);
                                        Thread.Sleep(1500);                                        
                                        CrudKnmprtpu2.AgregarCrud1(desktopSession, 0, crudDet1);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmprtpu2.AgregarCrud1(desktopSession, 1, crudDet1);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
        ...
        public void KNmRaumcChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_86.KNmRaumcChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
        ...
        public void KNmAgrucChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_86.KNmAgrucCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmagruc.Click(desktopSession, 0);
                                        Thread.Sleep(2000);
                                        newFunctions_4.ScreenshotNuevo("Pasar conceptos no asociados a conceptos asociados", true, file);

                                        CrudKnmagruc.ClickButtonAceptarEnter(desktopSession, 0, file);
                                        Thread.Sleep(2000);
                                        newFunctions_4.ScreenshotNuevo("Click en Boton aceptar", true, file);

                                        CrudKnmagruc.Click(desktopSession, 1);
                                        Thread.Sleep(2000);
                                        newFunctions_4.ScreenshotNuevo("Pasar conceptos asociados a conceptos no asociados", true, file);

                                        CrudKnmagruc.ClickButtonAceptarEnter(desktopSession, 0, file);
                                        Thread.Sleep(2000);
                                        newFunctions_4.ScreenshotNuevo("Click en aceptar para confirmar cambios, Programa Finalizado", true, file);
        ...
        public void KNmActctChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_86.KNmActctCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
...

                            {
                                ...
                                List<string> crudPrincipal = new List<string>() { RutaPdf };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmactct.Click(desktopSession, 0, crudPrincipal);
                                        Thread.Sleep(2000);
                                        newFunctions_4.ScreenshotNuevo("Agregar la ruta", true, file);

                                        CrudKnmactct.ClickButtonAceptarEnter(desktopSession, 0, file);
                                        Thread.Sleep(2000);
                                        newFunctions_4.ScreenshotNuevo("Click en Boton aceptar", true, file);

                                        CrudKnmactct.ClickButtonAceptarEnter(desktopSession, 1, file);
                                        Thread.Sleep(2000);
        ...
        public void KNmAccatChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_86.KNmAccatCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmaccat.Click(desktopSession, 0);
                                        Thread.Sleep(2000);
                                        newFunctions_4.ScreenshotNuevo("Se agregar los datos necesarios", true, file);
        ...
        public void KNmCabanChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_86.KNmCabanChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["ActPosFinal"].ToString().Length != 0 && rows["ActPosFinal"].ToString() != null)

                            {
                                ...
                                string ActPosFinal = rows["ActPosFinal"].ToString();
                                string Tipo= rows["Tipo"].ToString();
                                //String Codigo = "9";

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Codigo, Nombre, Numero, ActNumero };
                                //LISTA DETALLE 1
                                List<string> crudDet1 = new List<string>() { PosFinal, ActPosFinal, Tipo };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        //CrudKnmcaban.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Abrir Programa", true, file);
                                        //VALIDACION CODIGO DEL PROGRAMA
                                        errors = FuncionesGlobales.validarCodPrograma(desktopSession, codProgram);
                                        if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }
                                        ...
                                        CrudKnmcaban.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        //Thread.Sleep(1500);
                                        CrudKnmcaban.AgregarCrud1(desktopSession, 0, crudDet1);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmcaban.AgregarCrud1(desktopSession, 1, crudDet1);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
