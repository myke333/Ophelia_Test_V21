...
{
    [TestClass]
    public class ModulosNM_87 : FuncionesVitales
    {
        ...
        public void KNmCabonChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_87.KNmCabonChecKlist")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["ActNumero"].ToString().Length != 0 && rows["ActNumero"].ToString() != null &&

                                //Datos Crud Detalle 1
                                rows["Codigo"].ToString().Length != 0 && rows["Codigo"].ToString() != null &&
                                rows["FechaIn"].ToString().Length != 0 && rows["FechaIn"].ToString() != null &&
                                rows["FechaRet"].ToString().Length != 0 && rows["FechaRet"].ToString() != null &&
                                rows["ActDias"].ToString().Length != 0 && rows["ActDias"].ToString() != null)

                            {
                                ...
                                string ActNumero = rows["ActNumero"].ToString();

                                //Variables Crud Det 1
                                string Codigo = rows["Codigo"].ToString();
                                string FechaIn = rows["FechaIn"].ToString();
                                string FechaRet = rows["FechaRet"].ToString();
                                string ActDias = rows["ActDias"].ToString();
                                //String Codigo = "9";

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Numero, ActNumero };
                                //LISTA DETALLE 1
                                List<string> crudDet1 = new List<string>() { Codigo, FechaIn, FechaRet, ActDias };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmcabon.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        ...
                                        CrudKnmcabon.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        ...
                                        //Thread.Sleep(1500);
                                        CrudKnmcabon.AgregarCrud1(desktopSession, 0, crudDet1);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmcabon.AgregarCrud1(desktopSession, 1, crudDet1);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
        ...
        public void KNmCacsjChecKlist() 
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_87.KNmCacsjChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["Memorando"].ToString().Length != 0 && rows["Memorando"].ToString() != null &&
                                rows["RutaPng"].ToString().Length != 0 && rows["RutaPng"].ToString() != null &&
                                rows["FechaVen"].ToString().Length != 0 && rows["FechaVen"].ToString() != null &&
                                rows["Motivo"].ToString().Length != 0 && rows["Motivo"].ToString() != null &&
                                rows["ActMotivo"].ToString().Length != 0 && rows["ActMotivo"].ToString() != null)

                            {
                                ...
                                string Memorando = rows["Memorando"].ToString();
                                string RutaPng = rows["RutaPng"].ToString();
                                string FechaVen = rows["FechaVen"].ToString();
                                string Motivo = rows["Motivo"].ToString();
                                string ActMotivo = rows["ActMotivo"].ToString();
                                String campo = "4";

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Identificacion, Memorando, RutaPng, FechaVen, Motivo, ActMotivo };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmcacsj.AgregarCrud(desktopSession, 0, crudPrincipal, file);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmcacsj.AgregarCrud(desktopSession, 1, crudPrincipal, file);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
        ...
        public void KNmCahexChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_87.KNmCahexChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["RutaTxt"].ToString().Length != 0 && rows["RutaTxt"].ToString() != null)

                            {
                                ...
                                string RutaTxt = rows["RutaTxt"].ToString();

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { RutaTxt };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmcahex.Click(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Ruta", true, file);

                                        CrudKnmcahex.ClickButtonAceptarEnter(desktopSession, 0);

                                        newFunctions_4.ScreenshotNuevo("Mensaje de error", true, file);
                                        CrudKnmcahex.ClickButtonAceptarEnter(desktopSession, 1);
                                                                                
                                        CrudKnmcahex.ClickButtonErrores(desktopSession, file);
                                        newFunctions_4.ScreenshotNuevo("Mensaje de error", true, file);

                                        //Generar el reporte de los errores
                                        string pdf1 = @"C:\Reportes\ReportePDF1_" + "Preliminar" + "_" + Hora();
        ...
        public void KNmCalheChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_87.KNmCalheChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["NovDes"].ToString().Length != 0 && rows["NovDes"].ToString() != null &&
                                rows["NovHas"].ToString().Length != 0 && rows["NovHas"].ToString() != null &&
                                rows["FechPro"].ToString().Length != 0 && rows["FechPro"].ToString() != null &&
                                rows["Prot"].ToString().Length != 0 && rows["Prot"].ToString() != null)

                            {
                                ...
                                string NovDes = rows["NovDes"].ToString();
                                string NovHas = rows["NovHas"].ToString();
                                string FechPro = rows["FechPro"].ToString();
                                string Prot = rows["Prot"].ToString();

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { NovDes, NovHas, FechPro, Prot };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmcalhe.Click(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar campos necesarios", true, file);

                                        //QBE
                                        errors = FuncionesGlobales.QBEQry(desktopSession, TipoQbe, QbeFilter, file);
                                        if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }
                                                                                
                                        CrudKnmcalhe.ClickButtonAceptarEnter(desktopSession, 0);

                                        newFunctions_4.ScreenshotNuevo("Ventana emergente", true, file);
                                        Thread.Sleep(1000);
                                        CrudKnmcalhe.ClickButtonAceptarEnter(desktopSession, 1);

                                        //Por si hay errores
                                        //CrudKnmcalhe.ClickButtonErrores(desktopSession, file);
                                        //newFunctions_4.ScreenshotNuevo("Mensaje de error", true, file);
        ...
        public void KNmCaltuChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_87.KNmCaltuChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmcaltu.Click(desktopSession, 0);
                                        newFunctions_4.ScreenshotNuevo("Se ponen los datos y se anexa el evento", true, file);

                                        CrudKnmcaltu.ClickButtonAceptarEnter(desktopSession, 0);
                                        newFunctions_4.ScreenshotNuevo("Se aplican cambios", true, file);
                                                                                
                                        CrudKnmcaltu.Click(desktopSession, 1);
                                        newFunctions_4.ScreenshotNuevo("Se borra el evento", true, file);

                                        CrudKnmcaltu.ClickButtonAceptarEnter(desktopSession, 0);
                                        newFunctions_4.ScreenshotNuevo("Se aplican cambios nuevamente y se finaliza el maestro", true, file);
        ...
        public void KNmCamidChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_87.KNmCamidChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmcamid.Click(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Ruta", true, file);

                                        CrudKnmcamid.ClickButtonAceptarEnter(desktopSession, 0);

                                        ///CODIGO CORRECION 
                                        Thread.Sleep(10000);

                                        CrudKnmcamid.EnterErrores(desktopSession, 0);
                                        Thread.Sleep(1000);
                                        CrudKnmcamid.EnterErrores(desktopSession, 1);
                                        Thread.Sleep(1000);
                                        ...
                                        //newFunctions_4.ScreenshotNuevo("Mensaje de error", true, file);
                                        //CrudKnmcamid.ClickButtonAceptarEnter(desktopSession, 1);

                                        //newFunctions_4.ScreenshotNuevo("Mensaje de error", true, file);
                                        //CrudKnmcamid.ClickButtonAceptarEnter(desktopSession, 1);

                                        //CrudKnmcamid.ClickButtonErrores(desktopSession, file);
                                        //newFunctions_4.ScreenshotNuevo("Mensaje de error", true, file);
