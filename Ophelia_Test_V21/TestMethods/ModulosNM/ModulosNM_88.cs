...
{
    [TestClass]
    public class ModulosNM_88 : FuncionesVitales
    {
        ...
        public void KNmCapreChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_88.KNmCapreChecKlist")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["Final"].ToString().Length != 0 && rows["Final"].ToString() != null &&
                                rows["ActFinal"].ToString().Length != 0 && rows["ActFinal"].ToString() != null &&
...

                            {
                                ...
                                string Final = rows["Final"].ToString();
                                string ActFinal = rows["ActFinal"].ToString();
                                ...
                                List<string> crudPrincipal = new List<string>() { Codigo, Nombre, Registro, ActNombre };
                                //LISTA DETALLE 1
                                List<string> crudDet1 = new List<string>() { Final, ActFinal };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmcapre.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        ...
                                        //Thread.Sleep(1500);
                                        CrudKnmcapre.AgregarCrud1(desktopSession, 0, crudDet1);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmcapre.AgregarCrud1(desktopSession, 1, crudDet1);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
        ...
        public void KNmCincaChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_88.KNmCincaChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
...

                            {
                                ...
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Entidad, Fecha, Documento, ActFecha };
                                //LISTA DETALLE 1
                                List<string> crudDet1 = new List<string>() { Identificacion, Incap, Observ, ActObserv };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmcinca.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmcinca.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        //CrudKnmcaban.Click(desktopSession);
                                        //Thread.Sleep(1500);
                                        CrudKnmcinca.AgregarCrud1(desktopSession, 0, crudDet1);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmcinca.AgregarCrud1(desktopSession, 1, crudDet1);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        CrudKnmcinca.Click(desktopSession, file);
                                        ...
                                        //EXPORTAR EXCEL
                                        string ruta = @"C:\Reportes\ExportarExcel" + "_" + codProgram + "_" + Hora();
                                        errors = CrudKnmcinca.ExpExcel(desktopSession, banExcel, file, codProgram, ruta);
                                        if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }
                                        ...
                                        //EXPORTAR EXCEL
                                        errors = CrudKnmcinca.ExpExcel1(desktopSession, banExcel, file, codProgram, ruta);
                                        if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }
        ...
        public void KNmCmacoChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_88.KNmCmacoChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["CanTotal"].ToString().Length != 0 && rows["CanTotal"].ToString() != null &&
...

                            {
                                ...
                                string CanTotal = rows["CanTotal"].ToString();
                                ...
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { FechaIni, FechaFin, CanTotal, Personas, ActPerso };
                                //LISTA DETALLE 1
                                List<string> crudDet1 = new List<string>() { FechaIni, Cantidad, ActCantidad };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmcmaco.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmcmaco.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        //CrudKnmcaban.Click(desktopSession);
                                        //Thread.Sleep(1500);
                                        CrudKnmcmaco.AgregarCrud1(desktopSession, 0, crudDet1);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
        ...
        public void KNmCisriChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_88.KNmCisriChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmcisri.ClickButtonAceptarEnter(desktopSession, 0);
                                        Thread.Sleep(2000);
        ...
        public void KNmCnobrChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_88.KNmCnobrChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
...

                            {
                                ...
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { FechaIni, Porce, ActPorce };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmcnobr.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmcnobr.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
        ...
        public void KNmCoaplChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_88.KNmCoaplChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["QbeFilter"].ToString().Length != 0 && rows["QbeFilter"].ToString() != null &&
                                rows["Fecha"].ToString().Length != 0 && rows["Fecha"].ToString() != null &&
                                rows["FechReso"].ToString().Length != 0 && rows["FechReso"].ToString() != null &&
                                rows["NumReso"].ToString().Length != 0 && rows["NumReso"].ToString() != null)

                            {
                                ...
                                string QbeFilter = rows["QbeFilter"].ToString();
                                string Fecha = rows["Fecha"].ToString();
                                string FechReso = rows["FechReso"].ToString();
                                string NumReso = rows["NumReso"].ToString();

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Fecha, FechReso, NumReso };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmcoapl.Click(desktopSession, 0, crudPrincipal);
                                        ...
                                        CrudKnmcoapl.ClickButtonAceptarEnter(desktopSession, 0);
                                        Thread.Sleep(2000);

                                        newFunctions_4.ScreenshotNuevo("Mensaje de que el proceso termino correctamente", true, file);
                                        Thread.Sleep(2000);
                                        CrudKnmcoapl.ClickButtonAceptarEnter(desktopSession, 1);
        ...
        public void AbrirPrograma()
        {
            ...
            string programa = "KBiEmple"; //caban
            //Debugger.Launch();
            AbrirPrograma a = new AbrirPrograma(programa, "GRANGOSE");
