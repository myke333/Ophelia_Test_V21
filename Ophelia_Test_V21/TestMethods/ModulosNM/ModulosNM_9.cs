...
namespace Ophelia_Test_V21.TestMethods.ModulosNM
{
    ...
    [TestClass]
    public class ModulosNM_9 : FuncionesVitales
    {
        ...
        public void KNmPacadCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_9.KNmPacadCheckList")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            ...
                            if (
                                ...
                                rows["NombreReporte"].ToString().Length != 0 && rows["NombreReporte"].ToString() != null &&
                                rows["EditarNombreReporte"].ToString().Length != 0 && rows["EditarNombreReporte"].ToString() != null &&
                                ...
                                )
                            {
                                ...
                                string nombreReporte = rows["NombreReporte"].ToString();
                                string editarNombreReporte = rows["EditarNombreReporte"].ToString();
                                ...
                                Modulo = "NM";
                                List<string> crudVariables = new List<string>() { codigo, nombreReporte, editarNombreReporte };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmpacad.CRUD(desktopSession, 1, crudVariables, file);
                                        ...
                                        CrudKnmpacad.CRUD(desktopSession, 2, crudVariables, file);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo,codigo, nombreReporte, editCampo, c, ErrorValidacion, "No se edito correctamente", 1);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo,codigo,editarNombreReporte, editCampo, c, ErrorValidacion, "El registro no se editó correctamente", 1);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, codigo, "", "COD_ARBO", c, ErrorValidacion, "los datos no se encontraron correctamente", 2);
        ...
        public void KNmNosdeCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_9.KNmNosdeCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                                ...
                                )
                            {
                                ...
                                Modulo = "NM";
                                List<string> crudVariables = new List<string>() { identificacion, concepto, fechaPago, fechaReal,cantidad,valor,editarCantidad,editarValor };
                                //CREAR EL DOCUMENTO DEL REPORTE DE LA PRUEBA
                                string file = CrearDocumentoWordDinamico(codProgram, Modulo, motor);
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmnosde.CRUD(desktopSession, 1, crudVariables, file);
                                        ...
                                        CrudKnmnosde.CRUD(desktopSession, 2, crudVariables, file);
                                        newFunctions_4.ScreenshotNuevo("Registo Descartado", true, file);
                                        ...
                                        //Validacion Editar Descartar
                                        //ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo,QbeFilter, valor, editCampo, c, ErrorValidacion, "No se edito correctamente", 1);
                                        ...
                                        //ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo,QbeFilter, editarValor, editCampo, c, ErrorValidacion, "El registro no se editó correctamente", 1);
        ...
        public void KNmNosldCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_9.KNmNosldCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            ...
                            if (
                                ...
                                rows["Concepto"].ToString().Length != 0 && rows["Concepto"].ToString() != null &&
                                rows["Costos"].ToString().Length != 0 && rows["Costos"].ToString() != null &&
                                rows["Cargo"].ToString().Length != 0 && rows["Cargo"].ToString() != null &&
                                rows["Prototipos"].ToString().Length != 0 && rows["Prototipos"].ToString() != null &&
                                ...
                                )
                            {
                                ...
                                string concepto = rows["Concepto"].ToString();
                                string costos = rows["Costos"].ToString();
                                string cargo = rows["Cargo"].ToString();
                                string prototipos = rows["Prototipos"].ToString();
                                ...
                                Modulo = "NM";
                                List<string> crudVariables = new List<string>() { identificacion,nomina, concepto, costos,cargo, prototipos, secuencial,valor, fechaLiquidacion, fechaPago, editarValor };
                                //CREAR EL DOCUMENTO DEL REPORTE DE LA PRUEBA
                                string file = CrearDocumentoWordDinamico(codProgram, Modulo, motor);
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        desktopSession.Mouse.Click(null);
                                        Thread.Sleep(3000);
                                        CrudKnmnosld.CRUD(desktopSession, 1, crudVariables, file);
                                        Thread.Sleep(3000);
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Aplicar"].X, botonesNavegador["Aplicar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        newFunctions_4.ScreenshotNuevo("Registo Agregado", true, file);
                                        ...
                                        CrudKnmnosld.CRUD(desktopSession, 2, crudVariables, file);
                                        newFunctions_4.ScreenshotNuevo("Registo Descartado", true, file);
                                        ...
                                        //Validacion Editar Descartar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo,identificacion, valor, editCampo, c, ErrorValidacion, "No se edito correctamente", 1);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo,identificacion, editarValor, editCampo, c, ErrorValidacion, "El registro no se editó correctamente", 1);
        ...
        public void KNmNovedCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_9.KNmNovedCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            ...
                            if (
                                ...
                                rows["Codigo"].ToString().Length != 0 && rows["Codigo"].ToString() != null &&
                                rows["Cantidad"].ToString().Length != 0 && rows["Cantidad"].ToString() != null &&
                                rows["FechaIngreso"].ToString().Length != 0 && rows["FechaIngreso"].ToString() != null &&
                                ...
                                )
                            {
                                ...
                                string codigo = rows["Codigo"].ToString();
                                string cantidad = rows["Cantidad"].ToString();
                                string fechaIngreso = rows["FechaIngreso"].ToString();
                                ...
                                Modulo = "NM";
                                List<string> crudVariables = new List<string>() { nroContrato, codigo, cantidad, editarCantidad,fechaIngreso,fechaFinal };
                                //CREAR EL DOCUMENTO DEL REPORTE DE LA PRUEBA
                                string file = CrearDocumentoWordDinamico(codProgram, Modulo, motor);
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmnoved.CRUD(desktopSession, 1, crudVariables, file);
                                        ...
                                        CrudKnmnoved.CRUD(desktopSession, 2, crudVariables, file);
                                        newFunctions_4.ScreenshotNuevo("Editar Registro", true, file);
                                        ...
                                        //Validacion Editar Descartar
                                        //ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, QbeFilter, cantidad, editCampo, c, ErrorValidacion, "No se descarto correctamente", 1);
                                        ...
                                        //Thread.Sleep(1000);
                                        //ErrorValidacion = ValidacionesQueries.ValidacionLogbo(Tabla, motor, user, Campo, QbeFilter, "E", c, ErrorValidacion);                                        
                                        //ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo,QbeFilter, editarCantidad, editCampo, c, ErrorValidacion, "El registro no se editó correctamente", 1);
        ...
        public void KNmNovteCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_9.KNmNovteCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                                ...
                                )
                            {
                                ...
                                Modulo = "NM";
                                List<string> crudVariables = new List<string>() {  nroContrato, codigo, cantidad, editarCantidad };
                                //CREAR EL DOCUMENTO DEL REPORTE DE LA PRUEBA
                                string file = CrearDocumentoWordDinamico(codProgram, Modulo, motor);
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmnovte.CRUD(desktopSession, 1, crudVariables, file);
                                        ...
                                        CrudKnmnovte.CRUD(desktopSession, 2, crudVariables, file);
                                        newFunctions_4.ScreenshotNuevo("Registo Descartado", true, file);
                                        ...
                                        //Validacion Editar Descartar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo,QbeFilter, cantidad, editCampo, c, ErrorValidacion, "No se edito correctamente", 1);
        ...
        public void KNmNovtuCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_9.KNmNovtuCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            ...
                            if (
                                ...
                                rows["EditarNovedad"].ToString().Length != 0 && rows["EditarNovedad"].ToString() != null &&
                                ...
                                )
                            {
                                ...
                                string editarNovedad = rows["EditarNovedad"].ToString();
                                ...
                                Modulo = "NM";
                                List<string> crudVariables = new List<string>() {codigo, novedad, tipoNovedad, editarCodigo, editarNovedad };
                                //CREAR EL DOCUMENTO DEL REPORTE DE LA PRUEBA
                                string file = CrearDocumentoWordDinamico(codProgram, Modulo, motor);
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmnovtu.CRUD(desktopSession, 1, crudVariables, file);
                                        ...
                                        CrudKnmnovtu.CRUD(desktopSession, 2, crudVariables, file);
                                        newFunctions_4.ScreenshotNuevo("Registo Descartado", true, file);
                                        ...
                                        //Validacion Editar Descartar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo,codigo, novedad, editCampo, c, ErrorValidacion, "No se edito correctamente", 1);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo,editarCodigo, editarNovedad, editCampo, c, ErrorValidacion, "El registro no se editó correctamente", 1);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, editarCodigo, "", editCampo, c, ErrorValidacion, "los datos no se encontraron correctamente", 2);
