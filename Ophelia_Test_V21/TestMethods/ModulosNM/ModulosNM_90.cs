...
{
    [TestClass]
    public class ModulosNM_90 : FuncionesVitales
    {
        ...
        public void KNmCodisChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_90.KNmCodisChecKlist")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
...

                            {
                                ...
                                //LISTA datos
                                List<string> crudPrincipal = new List<string>() { Fecha, Identificacion };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmcodis.Click(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Seleccion de Concepto de Aplazamiento", true, file);
                                        Thread.Sleep(2000);

                                        CrudKnmcodis.ClickButtonAceptarEnter(desktopSession, 0);
                                        Thread.Sleep(2000);

                                        CrudKnmcodis.ClickButtonAceptarEnter(desktopSession, 1);
                                        Thread.Sleep(2000);
        ...
        public void KNmCogruChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_90.KNmCogruChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["Festivos"].ToString().Length != 0 && rows["Festivos"].ToString() != null &&
                                rows["ActFesti"].ToString().Length != 0 && rows["ActFesti"].ToString() != null &&

                                //Datos Crud Detalle 1
                                rows["Cantidad"].ToString().Length != 0 && rows["Cantidad"].ToString() != null &&
                                rows["ActCantidad"].ToString().Length != 0 && rows["ActCantidad"].ToString() != null)

                            {
                                ...
                                string ActFesti = rows["ActFesti"].ToString();

                                //Variables Crud Det 1
                                string Cantidad = rows["Cantidad"].ToString();
                                string ActCantidad = rows["ActCantidad"].ToString();
                                //String campo = "2";

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Festivos, ActFesti };
                                //LISTA DETALLE 1
                                List<string> crudDet1 = new List<string>() { Cantidad, ActCantidad };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmcogru.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        ...
                                        //Thread.Sleep(1500);
                                        CrudKnmcogru.AgregarCrud1(desktopSession, 0, crudDet1);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmcogru.AgregarCrud1(desktopSession, 1, crudDet1);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        CrudKnmcogru.Click(desktopSession, file);
        ...
        public void KNmCocesChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_90.KNmCocesChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                //Datos Crud Principal
                                rows["Causadas"].ToString().Length != 0 && rows["Causadas"].ToString() != null &&
                                rows["Trabajados"].ToString().Length != 0 && rows["Trabajados"].ToString() != null &&
                                rows["ActTrabaja"].ToString().Length != 0 && rows["ActTrabaja"].ToString() != null)

                            {
                                ...
                                //Variables crud principal
                                string Causadas = rows["Causadas"].ToString();
                                string Trabajados = rows["Trabajados"].ToString();
                                string ActTrabaja = rows["ActTrabaja"].ToString();

                                //String campo = "2";

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Causadas, Trabajados, ActTrabaja };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmcoces.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKnmcoces.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        //EXPORTAR EXCEL
                                        string ruta = @"C:\Reportes\ExportarExcel" + "_" + codProgram + "_" + Hora();
                                        errors = CrudKnmcoces.ExpExcel(desktopSession, banExcel, file, codProgram, ruta);
                                        if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }

                                        Thread.Sleep(2000);

                                        //EXPORTAR EXCEL
                                        errors = CrudKnmcoces.ExpExcel1(desktopSession, banExcel, file, codProgram, ruta);
                                        if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }
        ...
        public void KNmCompsChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_90.KNmCompsChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                //Datos Generales
                                rows["Servidor"].ToString().Length != 0 && rows["Servidor"].ToString() != null &&
...

                            {
                                ...
                                string TipoQbe = rows["TipoQbe"].ToString();
                                string QbeFilter = rows["QbeFilter"].ToString();
                                string Servidor = rows["Servidor"].ToString();
                                ...
                                //LISTA datos
                                List<string> crudPrincipal = new List<string>() { Servidor, Usuario, Clave, Base };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmcomps.Click(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos de conexion", true, file);
                                        Thread.Sleep(2000);
                                        ...
                                        newFunctions_4.ScreenshotNuevo("Mensaje de errores", true, file);
                                        Thread.Sleep(2000);
                                        CrudKnmcomps.ClickButtonAceptarEnter(desktopSession, 1);

                                        newFunctions_4.ScreenshotNuevo("Click en errores", true, file);
                                        Thread.Sleep(2000);
                                        CrudKnmcomps.ClickButtonErrores(desktopSession, file);
                                        Thread.Sleep(2000);
        ...
        public void KNmCinctChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_90.KNmCinctChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                //Datos Generales
                                rows["Fecha"].ToString().Length != 0 && rows["Fecha"].ToString() != null &&
                                rows["Secu"].ToString().Length != 0 && rows["Secu"].ToString() != null &&
                                rows["TipoQbe"].ToString().Length != 0 && rows["TipoQbe"].ToString() != null &&
                                rows["QbeFilter"].ToString().Length != 0 && rows["QbeFilter"].ToString() != null)

                            {
                                ...
                                string QbeFilter = rows["QbeFilter"].ToString();
                                string Fecha = rows["Fecha"].ToString();
                                string Secu = rows["Secu"].ToString();


                                //LISTA datos
                                List<string> crudPrincipal = new List<string>() { Fecha, Secu };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmcinct.Click(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Ingresar datos necesarios", true, file);
                                        Thread.Sleep(2000);
                                        ...
                                        CrudKnmcinct.ClickButtonAceptarEnter(desktopSession, 0);
                                        Thread.Sleep(2000);

                                        newFunctions_4.ScreenshotNuevo("Mensaje de aceptar", true, file);
                                        Thread.Sleep(2000);
                                        CrudKnmcinct.ClickButtonAceptarEnter(desktopSession, 1);

                                        newFunctions_4.ScreenshotNuevo("Mensaje de proceso correcto", true, file);
                                        Thread.Sleep(2000);
                                        CrudKnmcinct.ClickButtonAceptarEnter(desktopSession, 1);
        ...
        public void KNmInyreChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_90.KNmInyreChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                //Datos Generales
                                rows["Envio"].ToString().Length != 0 && rows["Envio"].ToString() != null &&
...

                            {
                                ...
                                string banderaPreli = rows["banderaPreli"].ToString();
                                string BanderaLupa = rows["BanderaLupa"].ToString();
                                string Envio = rows["Envio"].ToString();
                                string Ruta = rows["Ruta"].ToString();


                                //LISTA datos
                                List<string> crudPrincipal = new List<string>() { Envio, Ruta };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnminyre.Click(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Ingresar datos necesarios", true, file);
                                        Thread.Sleep(2000);
                                        ...
                                        CrudKnminyre.Click(desktopSession, 1, crudPrincipal);
                                        Thread.Sleep(2000);

                                        newFunctions_4.ScreenshotNuevo("Click en Formato 2276", true, file);
                                        Thread.Sleep(2000);
                                        CrudKnminyre.ClickButtonAceptarEnter(desktopSession, 1);

                                        newFunctions_4.ScreenshotNuevo("Genera el archivo XML correctamente", true, file);
                                        Thread.Sleep(2000);
