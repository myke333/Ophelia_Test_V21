...
namespace Ophelia_Test_V21.TestMethods.ModulosNM
{
    ...
    [TestClass]
    public class ModulosNM_91 : FuncionesVitales
    {
        ...
        public void KNmCtimpChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_91.KNmCtimpChecKlist")
                {
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmctimp.AgregarCrud(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("tipo de servicio", true, file);

                                        CrudKnmctimp.Enter(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("carga de datos 1", true, file);
        ...
        public void KNmDgapoChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_91.KNmDgapoChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        crudKnmdgapo.AgregarCrud(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("tipo de servicio", true, file);
                                        ...
                                        crudKnmdgapo.Boton(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("boton aceptar", true, file);
                                        Thread.Sleep(2000);

                                        crudKnmdgapo.Enter(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("carga de datos 1", true, file);
                                        Thread.Sleep(2000);
        ...
        public void KNmDinocChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_91.KNmDinocChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmdinoc.AgregarCrud(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("tipo de servicio", true, file);
                                        ...
                                        CrudKnmdinoc.Boton(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("boton aceptar", true, file);
                                        Thread.Sleep(2000);

                                        CrudKnmdinoc.Enter(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("carga de datos 1", true, file);
                                        Thread.Sleep(2000);
        ...
        public void KNmDisprChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_91.KNmDisprChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["ActRegistro"].ToString().Length != 0 && rows["ActRegistro"].ToString() != null)

                            {
                                ...
                                string ActRegistro = rows["ActRegistro"].ToString();

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Codigo, Nombre, Registro, ActRegistro };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmdispr.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        ...
                                        CrudKnmdispr.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        ...
                                        //ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, Registro, EditCampo, c, ErrorValidacion, "No se edito correctamente", 1);
                                        ...
                                        //ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, ActRegistro, EditCampo, c, ErrorValidacion, "El registro no se editó correctamente", 1);
        ...
        public void KNmDmereChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_91.KNmDmereChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmdmere.AgregarCrud(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("datos para qbe", true, file);

                                        //QBE
                                        errors = FuncionesGlobales.QBEQry(desktopSession, TipoQbe, QbeFilter, file);
                                        if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }

                                        CrudKnmdmere.Boton(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Boton Aceptar", true, file);
                                        Thread.Sleep(4000);
        ...
        public void KNmDnecpChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_91.KNmDnecpChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmdnecp.AgregarCrud(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("datos para qbe", true, file);
                                        ...
                                        CrudKnmdnecp.Boton(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Boton Aceptar", true, file);
                                        Thread.Sleep(4000);

                                        CrudKnmdnecp.Ventana(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Reporte", true, file);
                                        Thread.Sleep(4000);

                                        CrudKnmdnecp.Enter(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Reporte", true, file);
        ...
        public void KNmDnpcnChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_91.KNmDnpcnChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmdnpcn.AgregarCrud(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("datos para qbe", true, file);
