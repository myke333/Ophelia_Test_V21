...
{
    [TestClass]
    public class ModulosNM_137 : FuncionesVitales
    {
        ...
        public void KNmDisceChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_137.KNmDisceChecKlist")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
...

                            {
                                ...
                                List<string> crudPrincipal = new List<string>() { FechaI, FechaF };
                                //LISTA DETALLE 1
                                List<string> crudDet1 = new List<string>() { Cod, NumH, Cod2 };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKNmDisce.AgregarCrud(desktopSession, 0, crudPrincipal, file);
                                        ...
                                        Thread.Sleep(1500);
                                        CrudKNmDisce.AgregarCrud(desktopSession, 1, crudPrincipal, file);
                                        ...
                                        CrudKNmDisce.CrudDet(desktopSession, 0, crudDet1, file);
                                        ...
                                        CrudKNmDisce.CrudDet(desktopSession, 1, crudDet1, file);
        ...
        public void KNmPaireChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_137.KNmPaireChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["Vinge"].ToString().Length != 0 && rows["Vinge"].ToString() != null &&
                                rows["ValorFrac"].ToString().Length != 0 && rows["ValorFrac"].ToString() != null &&
                                rows["AñosT"].ToString().Length != 0 && rows["AñosT"].ToString() != null &&
                                rows["Ingre"].ToString().Length != 0 && rows["Ingre"].ToString() != null &&
                                rows["Disca"].ToString().Length != 0 && rows["Disca"].ToString() != null &&
                                rows["Tre"].ToString().Length != 0 && rows["Tre"].ToString() != null &&
                                rows["Frac"].ToString().Length != 0 && rows["Frac"].ToString() != null &&
                                rows["Frac2"].ToString().Length != 0 && rows["Frac2"].ToString() != null &&
...

                            {
                                ...
                                //Variables validacion  crud Principal
                                string Vinge = rows["Vinge"].ToString();
                                string ValorFrac = rows["ValorFrac"].ToString();
                                string AñosT = rows["AñosT"].ToString();
                                string Ingre = rows["Ingre"].ToString();
                                string Disca = rows["Disca"].ToString();
                                string Tre = rows["Tre"].ToString();
                                string Frac = rows["Frac"].ToString();
                                string Frac2 = rows["Frac2"].ToString();
                                ...
                                List<string> crudPrincipal = new List<string>() { Vinge, ValorFrac, AñosT, Ingre, Disca, Tre, Frac, Frac2 };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKNmPaire.AgregarCrud(desktopSession, 0, crudPrincipal, file);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        newFunctions_4.ScreenshotNuevo("Editar", true, file);
                                        Thread.Sleep(1500);
                                        CrudKNmPaire.AgregarCrud(desktopSession, 1, crudPrincipal, file);
                                        newFunctions_4.ScreenshotNuevo("Editar Datos Crud Principal", true, file);
                                        Thread.Sleep(1500);
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Cancelar"].X, botonesNavegador["Cancelar"].Y);
                                        desktopSession.Mouse.Click(null);
        ...
        public void KNmExsalChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_137.KNmExsalChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["ValorP"].ToString().Length != 0 && rows["ValorP"].ToString() != null &&
                                rows["ValorBS"].ToString().Length != 0 && rows["ValorBS"].ToString() != null &&
                                rows["ValorS"].ToString().Length != 0 && rows["ValorBS"].ToString() != null &&


                                //Variables Validaciones detalle 1

                                rows["ValorBase"].ToString().Length != 0 && rows["ValorBase"].ToString() != null &&
                                rows["ValorSeguridad"].ToString().Length != 0 && rows["ValorSeguridad"].ToString() != null &&
                                rows["ValorSeguridad2"].ToString().Length != 0 && rows["ValorSeguridad2"].ToString() != null &&
...

                            {
                                ...
                                //Variables validacion  crud Principal
                                string ValorP = rows["ValorP"].ToString();
                                string ValorBS = rows["ValorBS"].ToString();
                                string ValorS = rows["ValorS"].ToString();

                                //Variables validacion DETALLE 1
                                string ValorBase = rows["ValorBase"].ToString();
                                string ValorSeguridad = rows["ValorSeguridad"].ToString();
                                string ValorSeguridad2 = rows["ValorSeguridad2"].ToString();
                                ...
                                //LISTA DETALLE PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { ValorP, ValorBS, ValorS };
                                //LISTA DETALLE 1
                                List<string> crudDet1 = new List<string>() { ValorBase, ValorSeguridad, ValorSeguridad2 };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKNmExsal.AgregarCrud(desktopSession, 0, crudPrincipal, file);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKNmExsal.AgregarCrud(desktopSession, 1, crudPrincipal, file);
                                        newFunctions_4.ScreenshotNuevo("Editar Datos Crud Principal", true, file);
                                        Thread.Sleep(1500);
                                        ...
                                        CrudKNmExsal.CrudDet(desktopSession, 0, crudDet1, file);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos Detalle", true, file);
                                        ...
                                        CrudKNmExsal.CrudDet(desktopSession, 1, crudDet1, file);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados detalle", true, file);
        ...
        public void KNmCtanoChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNM_137.KNmCtanoChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["Des2"].ToString().Length != 0 && rows["Des2"].ToString() != null &&



                                //Variables Validaciones detalle 1

                                rows["CodC"].ToString().Length != 0 && rows["CodC"].ToString() != null &&
...

                            {
                                ...
                                string Des2 = rows["Des2"].ToString();



                                //Variables validacion DETALLE 1
                                string CodC = rows["CodC"].ToString();



                                //LISTA DETALLE 1
                                List<string> crudPrincipal = new List<string>() { Cod, Des, Des2 };
                                //LISTA DETALLE 1
                                List<string> crudDet1 = new List<string>() { CodC };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKNmCtano.AgregarCrud(desktopSession, 0, crudPrincipal, file);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKNmCtano.AgregarCrud(desktopSession, 1, crudPrincipal, file);
                                        newFunctions_4.ScreenshotNuevo("Editar Datos Crud Principal", true, file);
                                        Thread.Sleep(1500);
                                        ...
                                        CrudKNmCtano.CrudDet(desktopSession, 0, crudDet1, file);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos Detalle", true, file);
                                        ...
                                        CrudKNmCtano.CrudDet(desktopSession, 1, crudDet1, file);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados detalle", true, file);
