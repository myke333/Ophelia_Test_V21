...
{
    /// <summary>
    /// Descripción resumida de ModulosNm_4
    /// </summary>
    [TestClass]
    public class ModulosNm_4 : FuncionesVitales
    {
        ...
        { 
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNm_4.KNmMcsriCheckList")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            ...
                            if (
                                ...
                                rows["EditSueldo"].ToString().Length != 0 && rows["EditSueldo"].ToString() != null
                                )
                            {
                                ...
                                string editSueldo = rows["EditSueldo"].ToString();

                                Dictionary<string, Point> botonesNavegador = new Dictionary<string, Point>();
                                List<string> crudVariables = new List<string> { identificacion, sueldo, editSueldo };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmmcsri.KNmMcsriCRUD(desktopSession, crudVariables, 0);
                                        Thread.Sleep(5000);
                                        ...
                                        desktopSession.Mouse.Click(null);
                                        CrudKnmmcsri.KNmMcsriCRUD(desktopSession, crudVariables, 1);
                                        Thread.Sleep(1000);
                                        ...
                                        //sueldo = sueldo+",00";
                                        //ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, identificacion, sueldo, editCampo, c, ErrorValidacion, "No se edito correctamente", 1);
                                        ...
                                        //editSueldo = editSueldo + ",00";
                                        //ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, identificacion, editSueldo, editCampo, c, ErrorValidacion, "El registro no se editó correctamente", 1);
                                        //Thread.Sleep(1000);
        ...
        public void KNmDisevCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNm_4.KNmDisevCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            ...
                            if (
                                ...
                                rows["BanderaPreli"].ToString().Length != 0 && rows["BanderaPreli"].ToString() != null &&
                                rows["Identificacion"].ToString().Length != 0 && rows["Identificacion"].ToString() != null &&
                                rows["Consecutivo1"].ToString().Length != 0 && rows["Consecutivo1"].ToString() != null &&
                                rows["Consecutivo2"].ToString().Length != 0 && rows["Consecutivo2"].ToString() != null &&
                                rows["Consecutivo3"].ToString().Length != 0 && rows["Consecutivo3"].ToString() != null &&
                                ...
                                rows["NumeroPresupuesto"].ToString().Length != 0 && rows["NumeroPresupuesto"].ToString() != null &&
                                ...
                                )
                            {
                                ...
                                string identificacion = rows["Identificacion"].ToString();
                                string consecutivo1 = rows["Consecutivo1"].ToString();
                                string consecutivo2 = rows["Consecutivo2"].ToString();
                                string consecutivo3 = rows["Consecutivo3"].ToString();
                                string centroCostos = rows["CentroCostos"].ToString();
                                string proporcion = rows["Proporcion"].ToString();
                                string numeroPresupuesto = rows["NumeroPresupuesto"].ToString();
                                string editLupa = rows["EditLupa"].ToString();

                                Dictionary<string, Point> botonesNavegador = new Dictionary<string, Point>();
                                List<string> crudVariables = new List<string> { identificacion, consecutivo1, consecutivo2, consecutivo3, centroCostos, numeroPresupuesto, proporcion, editLupa };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        if (motor == "SQL") {
                                            ...
                                            desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Insertar"].X, botonesNavegador["Insertar"].Y);
                                            desktopSession.Mouse.Click(null);
                                            CrudKnmdisev.KNmDisevCRUD(desktopSession, crudVariables, 0);
                                            Thread.Sleep(2000);
                                            desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Aplicar"].X, botonesNavegador["Aplicar"].Y);
                                            desktopSession.Mouse.Click(null);
                                            Thread.Sleep(2000);
                                            ...
                                            desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Editar"].X, botonesNavegador["Editar"].Y);
                                            desktopSession.Mouse.Click(null);
                                            CrudKnmdisev.KNmDisevCRUD(desktopSession, crudVariables, 1);//CrudKnmmcsri.KNmMcsriCRUD(desktopSession, crudVariables, 1);
                                            Thread.Sleep(1000);
                                            newFunctions_4.ScreenshotNuevo("Registro Editado", true, file);
                                            desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Cancelar"].X, botonesNavegador["Cancelar"].Y);
                                            desktopSession.Mouse.Click(null);
                                            Thread.Sleep(2000);
                                            newFunctions_4.ScreenshotNuevo("Registro Descartado", true, file);
                                            ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, identificacion, centroCostos, editCampo, c, ErrorValidacion, "No se edito correctamente", 1);


                                            ///////ACEPTAR EDICION
                                            desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Editar"].X, botonesNavegador["Editar"].Y);
                                            desktopSession.Mouse.Click(null);
                                            CrudKnmdisev.KNmDisevCRUD(desktopSession, crudVariables, 1);
                                            Thread.Sleep(1000);
                                            desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Aplicar"].X, botonesNavegador["Aplicar"].Y);
                                            desktopSession.Mouse.Click(null);
                                            Thread.Sleep(3000);
                                            ...
                                            ErrorValidacion = ValidacionesQueries.ValidacionLogbo(Tabla, motor, user, Campo, identificacion, "E", c, ErrorValidacion);
                                            //Validacion Editar Aceptar
                                            ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, identificacion, editLupa, editCampo, c, ErrorValidacion, "El registro no se editó correctamente", 1);
                                            Thread.Sleep(1000);
                                       }
        ...
        public void KNmDisnoCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNm_4.KNmDisnoCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                                ...
                                )
                            {
                                ...
                                //TODO: HACER MTM Y LLENAR ESTA PARTE, agregar validaciones
                                string identificacion = rows["Identificacion"].ToString(); ;
                                string secuencial = rows["Secuencial"].ToString();
                                string centroCosto = rows["CentroCostos"].ToString();
                                string fechaPago = rows["FechaPago"].ToString();
                                string editLupa = rows["EditLupa"].ToString();


                                Dictionary<string, Point> botonesNavegador = new Dictionary<string, Point>();
                                List<string> crudVariables = new List<string> { identificacion, secuencial, centroCosto, fechaPago, editLupa };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Insertar"].X, botonesNavegador["Insertar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        CrudKnmdisno.KNmDisnoCRUD(desktopSession, crudVariables, 0);
                                        Thread.Sleep(5000);
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Aplicar"].X, botonesNavegador["Aplicar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        Thread.Sleep(2000);
                                        ...
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Editar"].X, botonesNavegador["Editar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        CrudKnmdisno.KNmDisnoCRUD(desktopSession, crudVariables, 1);
                                        Thread.Sleep(1000);
                                        newFunctions_4.ScreenshotNuevo("Registro Editado", true, file);
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Cancelar"].X, botonesNavegador["Cancelar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        ...
                                        //Validacion Editar Descartar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, identificacion, centroCosto, editCampo, c, ErrorValidacion, "No se edito correctamente", 1);
        ...
        public void KNmMauseCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNm_4.KNmMauseCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            ...
                            if (
                                ...
                                rows["LupaConcepto"].ToString().Length != 0 && rows["LupaConcepto"].ToString() != null
                                )
                            {
                                ...
                                string lupaConcepto = rows["LupaConcepto"].ToString();
                                string editLupa = rows["EditLupa"].ToString();


                                Dictionary<string, Point> botonesNavegador = new Dictionary<string, Point>();
                                List<string> crudVariables = new List<string> { identificacion, nombre, tipo, lupaConcepto, editLupa };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Insertar"].X, botonesNavegador["Insertar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        CrudKNmmause.KNmMauseCRUD(desktopSession, crudVariables, 0);
                                        Thread.Sleep(2000);
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Aplicar"].X, botonesNavegador["Aplicar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        Thread.Sleep(2000);
                                        ...
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Editar"].X, botonesNavegador["Editar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        CrudKNmmause.KNmMauseCRUD(desktopSession, crudVariables, 1);
                                        Thread.Sleep(1000);
                                        newFunctions_4.ScreenshotNuevo("Registro Editado", true, file);
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Cancelar"].X, botonesNavegador["Cancelar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        ...
                                        newFunctions_4.ScreenshotNuevo("Edición Descartada", true, file);
                                        //Validacion Editar Descartar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, identificacion, lupaConcepto, editCampo, c, ErrorValidacion, "No se edito correctamente", 1);
        ...
        public void KNmMboniCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosNM.ModulosNm_4.KNmMboniCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
...

                            {
                                ...
                                List<string> crudPrincipal = new List<string>() { Id, Concepto, Prot, Valor, EditValor };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKnmmboni.AgregarDatos(desktopSession, 0, crudPrincipal, file);
                                        ...
                                        Thread.Sleep(1500);
                                        CrudKnmmboni.AgregarDatos(desktopSession, 1, crudPrincipal, file);
