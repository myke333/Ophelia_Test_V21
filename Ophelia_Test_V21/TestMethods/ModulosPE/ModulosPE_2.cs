...
{
    [TestClass]
    public class ModulosPE_2 : FuncionesVitales
    {
        ...
        public void KPepercoCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosPE.ModulosPE_2.KPepercoCheckList")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
...

                            {
                                ...
                                List<string> crudPrincipal = new List<string>() { Usuario };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKpeperco.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        ...
                                        CrudKpeperco.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        ...
                                        //    CrudKnmcogru.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        //    newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        newFunctions_4.ScreenshotNuevo("Se traen los registros del QBE", true, file);
        ...
        public void KPeCtlimCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosPE.ModulosPE_2.KPeCtlimCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["NumImpresion"].ToString().Length != 0 && rows["NumImpresion"].ToString() != null &&
                                rows["Radicacion"].ToString().Length != 0 && rows["Radicacion"].ToString() != null &&
                                rows["AnoReporte"].ToString().Length != 0 && rows["AnoReporte"].ToString() != null &&
                                rows["ActualizarConse"].ToString().Length != 0 && rows["ActualizarConse"].ToString() != null)

                            {
                                ...
                                string NumImpresion = rows["NumImpresion"].ToString();
                                string Radicacion = rows["Radicacion"].ToString();
                                string AnoReporte = rows["AnoReporte"].ToString();
                                string ActualizarConse = rows["ActualizarConse"].ToString();

                                //String campo = "2";

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Consecutivo, NumImpresion, Radicacion, AnoReporte, ActualizarConse };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKpectlim.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKpectlim.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
        ...
        public void AbrirPrograma()
        {
            ...
            string programa = "KNmRcoen"; //caban
                                          //Debugger.Launch();
            ...
            //CrudKnmcinca.Clickk(desktopSession, 0);
            //Thread.Sleep(2000);

            //CrudKnmcinca.ClickButtonAceptarEnter(desktopSession, 0);
            //Thread.Sleep(2000);


            //CrudKgnmarco.Clickk(desktopSession, 1);
            //Thread.Sleep(2000);
        }
    }
}