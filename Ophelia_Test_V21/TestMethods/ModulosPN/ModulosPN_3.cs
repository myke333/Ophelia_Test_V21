...
{
    [TestClass]
    public class ModulosPN_3 : FuncionesVitales
    {
        ...
        public void KPnMruafChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosPN.ModulosPN_3.KPnMruafChecKlist")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["codRuaf"].ToString().Length != 0 && rows["codRuaf"].ToString() != null &&
                                rows["nomRuaf"].ToString().Length != 0 && rows["nomRuaf"].ToString() != null &&
                                rows["actNomRuaf"].ToString().Length != 0 && rows["actNomRuaf"].ToString() != null &&
...

                            {
                                ...
                                //Variables Crud principal  @FechaInicial                                
                                string codRuaf = rows["codRuaf"].ToString();
                                string nomRuaf = rows["nomRuaf"].ToString();
                                string actNomRuaf = rows["actNomRuaf"].ToString();


                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { codRuaf, nomRuaf, actNomRuaf };

                                //CREAR EL DOCUMENTO DEL REPORTE DE LA PRUEBA
                                string file = CrearDocumentoWordDinamico(codProgram, "PN", motor);
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKpnmruaf.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        ...
                                        CrudKpnmruaf.AgregarCrud(desktopSession, 1, crudPrincipal);
