...
{
    /// <summary>
    /// Descripción resumida de ModulosRL_1
    /// </summary>
    [TestClass]
    public class ModulosRL_1 : FuncionesVitales
    {
        ...
        public void KRlEmtalCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosRL.ModulosRL_1.KRlEmtalCheckList")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                                ...
                                )
                            {
                                ...
                                Modulo = "RL";
                                List<string> crudVariables = new List<string>() {  identificacion, codigo, editarCodigo };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                       ...
                                       // VALIDACION NOMBRE DEL PROGRAMA
                                        ...
                                        CrudKrlemtal.CRUD(desktopSession, 1, crudVariables, file);
                                        ...
                                        CrudKrlemtal.CRUD(desktopSession, 2, crudVariables, file);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, identificacion, codigo, EditCampo, c, ErrorValidacion, "No se edito correctamente", 1);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, identificacion, editarCodigo, EditCampo, c, ErrorValidacion, "El registro no se editó correctamente", 1);
        ...
        public void KRlRhvexCheckList()
        {
            ...
            { 
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosRL.ModulosRL_1.KRlRhvexCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            ...
                            if (
                                ...
                                rows["TipoArea"].ToString().Length != 0 && rows["TipoArea"].ToString() != null &&
                                rows["OpcionContratado"].ToString().Length != 0 && rows["OpcionContratado"].ToString() != null &&
                                ...
                                )
                            {
                                ...
                                string tipoArea = rows["TipoArea"].ToString();
                                string opcionContratado = rows["OpcionContratado"].ToString();
                                string fechaInicio = rows["FechaInicio"].ToString();
                                string fechaFin = rows["FechaFin"].ToString();

                                Modulo = "RL";
                                List<string> crudVariables = new List<string>() {tipoArea,opcionContratado, fechaInicio, fechaFin };
                                //CREAR EL DOCUMENTO DEL REPORTE DE LA PRUEBA
                                string file = CrearDocumentoWordDinamico(codProgram, Modulo, motor);
