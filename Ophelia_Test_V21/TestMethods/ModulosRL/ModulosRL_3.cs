...
{
    /// <summary>
    /// Descripción resumida de ModulosRL_3
    /// </summary>
    [TestClass]
    public class ModulosRL_3 : FuncionesVitales
    {
        ...
        public void KRlMotsoCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosRL.ModulosRL_3.KRlMotsoCheckList")
                {
                                ...
                                )
                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKrlmotso.CRUDKrlmotso(desktopSession, 1, crudVariables);
                                        ...
                                        CrudKrlmotso.CRUDKrlmotso(desktopSession, 2, crudVariables);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, Nombre, "NOM_MOTI", c, ErrorValidacion, "No se descarto correctamente", 1);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, Editar, "NOM_MOTI", c, ErrorValidacion, "El registro no se editó correctamente", 1);
        ...
        public void KRlMedioCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosRL.ModulosRL_3.KRlMedioCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                                ...
                                )
                            {
                                ...
                                string Nombre = rows["Nombre"].ToString();
                                string Editar = rows["Editar"].ToString();
                                List<string> crudVariables = new List<string>() { Codigo, Tipo, Nombre, Editar };
                                //CREAR EL DOCUMENTO DEL REPORTE DE LA PRUEBA
                                string file = CrearDocumentoWordDinamico(codProgram, "RL", motor);
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKrlmedio.CRUDKrlmedio(desktopSession, 1, crudVariables);
                                        ...
                                        CrudKrlmedio.CRUDKrlmedio(desktopSession, 2, crudVariables);
                                        newFunctions_4.ScreenshotNuevo("Editar Registro", true, file);
                                        ...
                                        //Validacion Editar Descartar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, Nombre, "NOM_MEDI", c, ErrorValidacion, "No se descarto correctamente", 1);
                                        ...
                                        Thread.Sleep(1000);
                                        ErrorValidacion = ValidacionesQueries.ValidacionLogbo(Tabla, motor, user, Campo, Codigo, "E", c, ErrorValidacion);
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, Editar, "NOM_MEDI", c, ErrorValidacion, "El registro no se editó correctamente", 1);
        ...
        public void KRlHhadaCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosRL.ModulosRL_3.KRlHhadaCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
