...
{
    /// <summary>
    /// Descripción resumida de ModulosRL_5
    /// </summary>
    [TestClass]
    public class ModulosRL_5:FuncionesVitales
    {
        ...
        public void KRlEntidCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosRL.ModulosRL_5.KRlEntidCheckList")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                //@Codigo @NombreCur @CursoAso @Valor @EditarNombre
                                //@Registro @Requisito @Especificacion
                                ...
                                )
                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKrlentid.CRUD(desktopSession, 1, crudVariables, file);
                                        ...
                                        CrudKrlentid.CRUD(desktopSession, 2, crudVariables, file);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, Nombre, "NOM_ENTI", c, ErrorValidacion, "No se edito correctamente", 1);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, EditarNombre, "NOM_ENTI", c, ErrorValidacion, "El registro no se editó correctamente", 1);
        ...
        public void KRlArintCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosRL.ModulosRL_5.KRlArintCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                                ...
                                )
                            {
                                ...
                                List<string> crudVariables = new List<string>() { Codigo, Nombre, EditarNombre, Descripcion };
                                //List<string> crudDetalle = new List<string> { Registro, Requisito, Especificacion };
                                //CREAR EL DOCUMENTO DEL REPORTE DE LA PRUEBA
                                string file = CrearDocumentoWordDinamico(codProgram, "RL", motor);
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Insertar"].X, botonesNavegador["Insertar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        CrudKrlarint.CRUD(desktopSession, 1, crudVariables, file);
                                        ...
                                        CrudKrlarint.CRUD(desktopSession, 2, crudVariables, file);
                                        ...
                                        //Validacion Editar Descartar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, Nombre, "NOM_ARIN", c, ErrorValidacion, "No se edito correctamente", 1);
                                        //LUPA
                                        errors = newFunctions_3.LupaAud(desktopSession, BanderaLupa, file);
                                        if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }
                                        //ACEPTAR EDICION
                                        ...
                                        // //Debugger.Launch();
                                        ErrorValidacion = ValidacionesQueries.ValidacionLogbo(Tabla, motor, user, Campo, Codigo, "E", c, ErrorValidacion);
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, EditarNombre, "NOM_ARIN", c, ErrorValidacion, "El registro no se editó correctamente", 1);
        ...
        public void KRlArexpCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosRL.ModulosRL_5.KRlArexpCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                                ...
                                )
                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Insertar"].X, botonesNavegador["Insertar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        CrudKrlarexp.CRUD(desktopSession, 1, crudVariables, file);
                                        ...
                                        CrudKrlarexp.CRUD(desktopSession, 2, crudVariables, file);
                                        ...
                                        //Validacion Editar Descartar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, Nombre, "NOM_AREX", c, ErrorValidacion, "No se edito correctamente", 1);
                                        ...
                                        // //Debugger.Launch();
                                        ErrorValidacion = ValidacionesQueries.ValidacionLogbo(Tabla, motor, user, Campo, Codigo, "E", c, ErrorValidacion);
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, EditarNombre, "NOM_AREX", c, ErrorValidacion, "El registro no se editó correctamente", 1);
                                        ...
                                        CrudKrlarexp.CrudDetalle(desktopSession, 1, crudDetalle, file);
        ...
        public void KRlEdnfoChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosRL.ModulosRL_5.KRlEdnfoChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                //Datos Crud Principal  @Identi @ModAca @ActModAca
                                rows["Identi"].ToString().Length != 0 && rows["Identi"].ToString() != null &&
                                rows["ModAca"].ToString().Length != 0 && rows["ModAca"].ToString() != null &&
                                rows["ActModAca"].ToString().Length != 0 && rows["ActModAca"].ToString() != null &&

                                //Datos Crud Detalle 1  @Tipo @Requi @Espec @ActEspec
...

                            {
                                ...
                                //Variables crud principal  @Identi @ModAca @ActModAca
                                string Identi = rows["Identi"].ToString();
                                string ModAca = rows["ModAca"].ToString();
                                string ActModAca = rows["ActModAca"].ToString();

                                //Variables Crud Det 1    @Tipo @Requi @Espec @ActEspec
                                ...
                                List<string> crudPrincipal = new List<string>() { Identi, ModAca, ActModAca };

                                //LISTA DETALLE 1
                                List<string> crudDet1 = new List<string>() { Tipo, Requi, Espec,  ActEspec };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKrlednfo.AggCrudPri(desktopSession, 0, crudPrincipal);
                                        Thread.Sleep(1500);
                                        ...
                                        CrudKrlednfo.AggCrudPri(desktopSession, 1, crudPrincipal);
                                        ...
                                        // Click en ventana para add datos Crud  Detalle
                                        CrudKrlednfo.ChoiceVentana(desktopSession);
                                        Thread.Sleep(1000);
                                        ...
                                        CrudKrlednfo.AggCrudDet(desktopSession, 0, crudDet1);
                                        ...
                                        CrudKrlednfo.AggCrudDet(desktopSession, 1, crudDet1);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos CRUD DETALLE", true, file);
