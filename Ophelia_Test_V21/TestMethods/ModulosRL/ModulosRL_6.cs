...
{
    /// <summary>
    /// Descripción resumida de ModulosRL_6
    /// </summary>
    [TestClass]
    public class ModulosRL_6 : FuncionesVitales
    {
        ...
        public void KRlHvextChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosRL.ModulosRL_6.KRlHvextChecKlist")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["ActiEmp"].ToString().Length != 0 && rows["ActiEmp"].ToString() != null &&
                                rows["Fecha"].ToString().Length != 0 && rows["Fecha"].ToString() != null &&
                                rows["ActFecha"].ToString().Length != 0 && rows["ActFecha"].ToString() != null &&
                                rows["ActFechaCrud2"].ToString().Length != 0 && rows["ActFechaCrud2"].ToString() != null &&
                                ...
                                rows["ActHerra"].ToString().Length != 0 && rows["ActHerra"].ToString() != null &&

                                //Datos Crud Detalle 4
                                rows["Expe"].ToString().Length != 0 && rows["Expe"].ToString() != null &&
                                rows["ActExpe"].ToString().Length != 0 && rows["ActExpe"].ToString() != null)

                            {
                                ...
                                string ActiEmp = rows["ActiEmp"].ToString();
                                string Fecha = rows["Fecha"].ToString();
                                string ActFecha = rows["ActFecha"].ToString();
                                string ActFechaCrud2 = rows["ActFechaCrud2"].ToString();
                                ...
                                string ActHerra = rows["ActHerra"].ToString();

                                //Variables crud Detalle 4
                                string Expe = rows["Expe"].ToString();
                                string ActExpe = rows["ActExpe"].ToString();

                                String campo = "9";

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Identi, ActiEmp, Fecha, ActFecha };

                                //LISTA CRUD DETALLE
                                List<string> crudDet = new List<string>() { Tipo, Requi, Espe, Punt, ActPunt };

                                //LISTA CRUD DETALLE 2
                                List<string> crudDet2 = new List<string>() { Fecha, ActFecha, Herra, ActFechaCrud2 };

                                //LISTA CRUD DETALLE 3
                                List<string> crudDet3 = new List<string>() { Herra,  ActHerra };

                                //LISTA CRUD DETALLE 4
                                List<string> crudDet4 = new List<string>() { Expe, ActExpe };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKrlhvext.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        ...
                                        CrudKrlhvext.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        ...
                                        CrudKrlhvext.Click(desktopSession, 0);
                                        ...
                                        //Thread.Sleep(1500);
                                        CrudKrlhvext.AgregarCrud1(desktopSession, 0, crudDet);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKrlhvext.AgregarCrud1(desktopSession, 1, crudDet);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        CrudKrlhvext.Click(desktopSession, 1);
                                        newFunctions_4.ScreenshotNuevo("Cambiar a ventana crud proyectos", true, file);
                                        Thread.Sleep(1500);
                                        ...
                                        //CrudKnmcaban.Click(desktopSession);
                                        //Thread.Sleep(1500);
                                        CrudKrlhvext.AgregarCrud2(desktopSession, 0, crudDet2);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKrlhvext.AgregarCrud2(desktopSession, 1, crudDet2);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        CrudKrlhvext.Click(desktopSession, 2);
                                        newFunctions_4.ScreenshotNuevo("Cambiar a ventana crud Herramientas", true, file);
                                        Thread.Sleep(1500);
                                        ...
                                        //CrudKnmcaban.Click(desktopSession);
                                        //Thread.Sleep(1500);
                                        CrudKrlhvext.AgregarCrud3(desktopSession, 0, crudDet3);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKrlhvext.AgregarCrud3(desktopSession, 1, crudDet3);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        CrudKrlhvext.Click(desktopSession, 3);
                                        ...
                                        //CrudKnmcaban.Click(desktopSession);
                                        //Thread.Sleep(1500);
                                        CrudKrlhvext.AgregarCrud4(desktopSession, 0, crudDet4);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKrlhvext.AgregarCrud4(desktopSession, 1, crudDet4);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        newFunctions_4.ScreenshotNuevo("Datos Eliminados Detalle 4 (Experiencia)", true, file);
                                        Thread.Sleep(2000);

                                        CrudKrlhvext.Click(desktopSession, 1);
                                        newFunctions_4.ScreenshotNuevo("Cambiar a ventana crud detalle 3 (Herramientas)", true, file);
                                        Thread.Sleep(1500);

                                        PruebaCRUD.EliminarRegistro(desktopSession, ElementList4[1], botonesNavegador4, file);
                                        newFunctions_4.ScreenshotNuevo("Datos Eliminados Detalle 3 (Herramientas)", true, file);
                                        Thread.Sleep(2000);

                                        CrudKrlhvext.Click(desktopSession, 4);
                                        newFunctions_4.ScreenshotNuevo("Cambiar a ventana crud detalle 2 (Proyectos)", true, file);
                                        Thread.Sleep(1500);

                                        PruebaCRUD.EliminarRegistro(desktopSession, ElementList3[1], botonesNavegador3, file);
                                        newFunctions_4.ScreenshotNuevo("Datos Eliminados Detalle 2 (Proyectos)", true, file);
                                        Thread.Sleep(2000);

                                        CrudKrlhvext.Click(desktopSession, 0);
                                        newFunctions_4.ScreenshotNuevo("Cambiar a ventana crud detalle 1 (Perfiles)", true, file);
                                        Thread.Sleep(1500);

                                        PruebaCRUD.EliminarRegistro(desktopSession, ElementList2[1], botonesNavegador2, file);
                                        newFunctions_4.ScreenshotNuevo("Datos Eliminados Detalle 1 (Perfiles)", true, file);
                                        Thread.Sleep(2000);

                                        CrudKrlhvext.Click(desktopSession, 5);
        ...
        public void KRlEmpleChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosRL.ModulosRL_6.KRlEmpleChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["FechaRa"].ToString().Length != 0 && rows["FechaRa"].ToString() != null &&
                                rows["FechaNa"].ToString().Length != 0 && rows["FechaNa"].ToString() != null &&
                                rows["GrupoSa"].ToString().Length != 0 && rows["GrupoSa"].ToString() != null &&
                                ...
                                rows["Calle"].ToString().Length != 0 && rows["Calle"].ToString() != null &&
                                ...
                                rows["ActObser"].ToString().Length != 0 && rows["ActObser"].ToString() != null)

                            {
                                ...
                                string FechaRa = rows["FechaRa"].ToString();
                                string FechaNa = rows["FechaNa"].ToString();
                                string GrupoSa = rows["GrupoSa"].ToString();
                                ...
                                string Calle = rows["Calle"].ToString();
                                ...
                                string ActObser = rows["ActObser"].ToString();

                                String campo = "3";

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Id, Apelli, Nombre, FechaRa, FechaNa, GrupoSa,
                                                                                 Factor, Pais, Dpto, Muni, Calle, Telefono, Movil,
                                                                                 Correo, ActNombre };

                                //LISTA CRUD DETALLE
                                List<string> crudDet = new List<string>() { Area, ActArea };

                                //LISTA CRUD DETALLE 2
                                List<string> crudDet2 = new List<string>() { Obser, ActObser };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKrlemple.Click(desktopSession, 2);
                                        newFunctions_4.ScreenshotNuevo("Cambiar a ventana crud publicaciones e idiomas", true, file);
                                        Thread.Sleep(1500);

                                        CrudKrlemple.Click(desktopSession, 0);
                                        Thread.Sleep(1500);
                                        newFunctions_4.ScreenshotNuevo("Eliminar datos", true, file);

                                        CrudKrlemple.Enter(desktopSession);
                                        Thread.Sleep(1500);
                                        newFunctions_4.ScreenshotNuevo("datos eliminados", true, file);

                                        CrudKrlemple.Click(desktopSession, 1);
                                        newFunctions_4.ScreenshotNuevo("Cambiar a ventana crud datos solicitud", true, file);
                                        Thread.Sleep(1500);
                                        ...
                                        //MODIFICAMOS 
                                        CrudKrlemple.Click(desktopSession, 9);
                                        newFunctions_4.ScreenshotNuevo("Cambiar a ventana datos basicos", true, file);
                                        Thread.Sleep(1500);

                                        //agregar crud principal
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Insertar"].X, botonesNavegador["Insertar"].Y);
                                        desktopSession.Mouse.Click(null);

                                        CrudKrlemple.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKrlemple.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        //CrudKnmcaban.Click(desktopSession);
                                        //Thread.Sleep(1500);
                                        CrudKrlemple.AgregarCrud1(desktopSession, 0, crudDet);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKrlemple.AgregarCrud1(desktopSession, 1, crudDet);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        ////AGREGAR REGISTRO DETALLE 2                                        
                                        CrudKrlemple.Click(desktopSession, 3);
                                        Thread.Sleep(1500);

                                        //CrudKnmcaban.Click(desktopSession);
                                        //Thread.Sleep(1500);
                                        CrudKrlemple.AgregarCrud2(desktopSession, 0, crudDet2);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);

                                        CrudKrlemple.Click(desktopSession, 4);
                                        Thread.Sleep(1500);
                                        newFunctions_4.ScreenshotNuevo("Datos Insertados", true, file);
                                        ...
                                        ////DESCARTAR EDICION
                                        CrudKrlemple.Click(desktopSession, 5);
                                        Thread.Sleep(1500);
                                        newFunctions_4.ScreenshotNuevo("Editar", true, file);

                                        CrudKrlemple.AgregarCrud2(desktopSession, 1, crudDet);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);

                                        CrudKrlemple.Click(desktopSession, 6);
                                        Thread.Sleep(1500);
                                        newFunctions_4.ScreenshotNuevo("Cancelar Datos Editados", true, file);
                                        ...
                                        CrudKrlemple.Click(desktopSession, 7);
                                        Thread.Sleep(1500);
                                        ...
                                        CrudKrlemple.Click(desktopSession, 8);
                                        Thread.Sleep(1500);
        ...
        public void KRlWRegiChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosRL.ModulosRL_6.KRlWRegiChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["Ape"].ToString().Length != 0 && rows["Ape"].ToString() != null &&
                                rows["Correo"].ToString().Length != 0 && rows["Correo"].ToString() != null &&
                                rows["ActApe"].ToString().Length != 0 && rows["ActApe"].ToString() != null)

                            {
                                ...
                                string Ape = rows["Ape"].ToString();
                                string Correo = rows["Correo"].ToString();
                                string ActApe = rows["ActApe"].ToString();

                                String campo = "1";

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Id, Nom, Ape, Correo, ActApe };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKrlwregi.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        Thread.Sleep(1500);
                                        CrudKrlwregi.Enter(desktopSession);
                                        Thread.Sleep(1000);
                                        ...
                                        CrudKrlwregi.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
        ...
        public void KRlParrlChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosRL.ModulosRL_6.KRlParrlChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                //Datos Crud Principal
                                rows["AreExpe"].ToString().Length != 0 && rows["AreExpe"].ToString() != null &&
                                rows["NameAreExpe"].ToString().Length != 0 && rows["NameAreExpe"].ToString() != null &&
                                rows["ActNameAreExpe"].ToString().Length != 0 && rows["ActNameAreExpe"].ToString() != null &&

                                //Datos Crud Detalle 1
                                rows["Regui"].ToString().Length != 0 && rows["Regui"].ToString() != null &&
                                rows["Reque"].ToString().Length != 0 && rows["Reque"].ToString() != null &&
                                rows["Especi"].ToString().Length != 0 && rows["Especi"].ToString() != null &&
                                rows["ActEspec"].ToString().Length != 0 && rows["ActEspec"].ToString() != null)
                                ...
                                
                            {
                                ...
                                //Variables crud principal
                                string AreExpe = rows["AreExpe"].ToString();
                                string NameAreExpe = rows["NameAreExpe"].ToString();
                                string ActNameAreExpe = rows["ActNameAreExpe"].ToString();

                                //Variables Crud Det 1
                                string Regui = rows["Regui"].ToString();
                                string Reque = rows["Reque"].ToString();
                                string Especi = rows["Especi"].ToString();
                                string ActEspec = rows["ActEspec"].ToString();



                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { AreExpe, NameAreExpe, ActNameAreExpe };

                                //LISTA DETALLE 1
                                List<string> crudDet1 = new List<string>() { Regui, Reque, Especi, ActEspec };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKrlparrl.ChoiceVentana(desktopSession);
                                        Thread.Sleep(1000);
                                        ...
                                        CrudKrlparrl.AggCrudPri(desktopSession, 0, crudPrincipal);
                                        Thread.Sleep(1500);
                                        ...
                                        CrudKrlparrl.AggCrudPri(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKrlparrl.AggCrudDet(desktopSession, 0, crudDet1);
                                        ...
                                        CrudKrlparrl.AggCrudDet(desktopSession, 1, crudDet1);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos CRUD DETALLE", true, file);
