...
{
    [TestClass]
    public class ModulosSL_3 : FuncionesVitales
    {
        ...
        public void KSlInselChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosSL.ModulosSL_3.KSlInselChecKlist")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
...

                            {
                                ...
                                List<string> crudPrincipal = new List<string>() { Descri, ActDescri };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKslinsel.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        ...
                                        CrudKslinsel.AgregarCrud(desktopSession, 1, crudPrincipal);
        ...
        public void KSlSelcaChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosSL.ModulosSL_3.KSlSelcaChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                //Datos Crud Detalle
                                rows["Regis"].ToString().Length != 0 && rows["Regis"].ToString() != null &&
                                rows["Requi"].ToString().Length != 0 && rows["Requi"].ToString() != null &&
                                rows["Espe"].ToString().Length != 0 && rows["Espe"].ToString() != null &&
                                rows["Punt"].ToString().Length != 0 && rows["Punt"].ToString() != null &&
                                rows["ActPunt"].ToString().Length != 0 && rows["ActPunt"].ToString() != null &&

                                //Datos Crud Detalle 2
                                rows["Condi"].ToString().Length != 0 && rows["Condi"].ToString() != null &&
...

                            {
                                ...
                                string Regis = rows["Regis"].ToString();
                                string Requi = rows["Requi"].ToString();
                                string Espe = rows["Espe"].ToString();
                                string Punt = rows["Punt"].ToString();
                                string ActPunt = rows["ActPunt"].ToString();

                                //Variables crud Detalle 2
                                string Condi = rows["Condi"].ToString();
                                ...
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Fecha, ActFecha, QbeFilter };

                                //LISTA CRUD DETALLE
                                List<string> crudDet = new List<string>() { Regis, Requi, Espe, Punt, ActPunt };

                                //LISTA CRUD DETALLE 2
                                List<string> crudDet2 = new List<string>() { Condi, Valor, ActValor };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKslselca.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKslselca.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        //Thread.Sleep(1500);
                                        CrudKslselca.AgregarCrud1(desktopSession, 0, crudDet);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKslselca.AgregarCrud1(desktopSession, 1, crudDet);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        CrudKslselca.Click(desktopSession, 0);
                                        newFunctions_4.ScreenshotNuevo("Cambiar a ventana crud detalle 2", true, file);
                                        Thread.Sleep(1500);                                                                               
                                        ...
                                        //CrudKnmcaban.Click(desktopSession);
                                        //Thread.Sleep(1500);
                                        CrudKslselca.AgregarCrud2(desktopSession, 0, crudDet2);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKslselca.AgregarCrud2(desktopSession, 1, crudDet);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        CrudKslselca.Click(desktopSession, 1);
                                        newFunctions_4.ScreenshotNuevo("Cambiar a ventana crud detalle 1", true, file);
                                        Thread.Sleep(1500);
                                        ...
                                        PruebaCRUD.EliminarRegistro(desktopSession, ElementList[0], botonesNavegador, file);
                                        CrudKslselca.Enter(desktopSession);
                                        newFunctions_4.ScreenshotNuevo("Datos Eliminados Principal", true, file);
                                        //VALIDACIÓN ELIMINAR REGISTRO
                                        //ErrorValidacion = ValidacionesQueries.ValidacionLogbo(Tabla, motor, user, Campo, Codigo, "D", c, ErrorValidacion);
                                        //ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, "", Campo, c, ErrorValidacion, "los datos no se eliminaron correctamente", 2);
        ...
        public void KSlReqpeChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosSL.ModulosSL_3.KSlReqpeChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["Reque"].ToString().Length != 0 && rows["Reque"].ToString() != null &&
                                rows["Fecha"].ToString().Length != 0 && rows["Fecha"].ToString() != null &&
                                ...
                                rows["Perso"].ToString().Length != 0 && rows["Perso"].ToString() != null &&
                                rows["ActPerso"].ToString().Length != 0 && rows["ActPerso"].ToString() != null &&

                                //Datos Crud Detalle
                                rows["Regis"].ToString().Length != 0 && rows["Regis"].ToString() != null &&
                                rows["RequeDet"].ToString().Length != 0 && rows["RequeDet"].ToString() != null &&
                                rows["Espe"].ToString().Length != 0 && rows["Espe"].ToString() != null &&
                                rows["Punta"].ToString().Length != 0 && rows["Punta"].ToString() != null &&
                                rows["ActPunta"].ToString().Length != 0 && rows["ActPunta"].ToString() != null &&

                                //Datos Crud Detalle 2
                                rows["Prueba"].ToString().Length != 0 && rows["Prueba"].ToString() != null &&
                                ...
                                rows["CodConce"].ToString().Length != 0 && rows["CodConce"].ToString() != null &&
                                rows["Valor"].ToString().Length != 0 && rows["Valor"].ToString() != null &&
                                rows["ActValor"].ToString().Length != 0 && rows["ActValor"].ToString() != null)

                            {
                                ...
                                string Reque = rows["Reque"].ToString();
                                string Fecha = rows["Fecha"].ToString();
                                ...
                                string Perso = rows["Perso"].ToString();
                                string ActPerso = rows["ActPerso"].ToString();

                                //Variables crud Detalle
                                string Regis = rows["Regis"].ToString();
                                string RequeDet = rows["RequeDet"].ToString();
                                string Espe = rows["Espe"].ToString();
                                string Punta = rows["Punta"].ToString();
                                string ActPunta = rows["ActPunta"].ToString();

                                //Variables crud Detalle 2
                                string Prueba = rows["Prueba"].ToString();
                                string Peso = rows["Peso"].ToString();
                                string ActPeso = rows["ActPeso"].ToString();

                                //Variables crud Detalle 3
                                string CodConce = rows["CodConce"].ToString();
                                string Valor = rows["Valor"].ToString();
                                string ActValor = rows["ActValor"].ToString();
                                ...
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Grupo, Reque, Fecha, Cargo, Centro, Id,
                                                                                 Pais, Dpto, Muni, Perso, ActPerso};

                                //LISTA CRUD DETALLE
                                List<string> crudDet = new List<string>() { Regis, RequeDet, Espe, Punta, ActPunta };

                                //LISTA CRUD DETALLE 2
                                List<string> crudDet2 = new List<string>() { Prueba, Peso, ActPeso };

                                //LISTA CRUD DETALLE 3
                                List<string> crudDet3 = new List<string>() { CodConce, Valor, ActValor };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKslreqpe.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        newFunctions_4.ScreenshotNuevo("Ventana de enviar correo", true, file);
                                        Thread.Sleep(1500);
                                        CrudKslreqpe.Click(desktopSession, 1);
                                        Thread.Sleep(1500);
                                        ...
                                        CrudKslreqpe.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        CrudKslreqpe.Click(desktopSession, 0);
                                        Thread.Sleep(1500);
                                        newFunctions_4.ScreenshotNuevo("Cambiar a Crud Perfiles", true, file);
                                        Thread.Sleep(1500);
                                        ...
                                        //CrudKnmcaban.Click(desktopSession);
                                        //Thread.Sleep(1500);
                                        CrudKslreqpe.AgregarCrud1(desktopSession, 0, crudDet);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKslreqpe.AgregarCrud1(desktopSession, 1, crudDet);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        CrudKslreqpe.Click(desktopSession, 2);
                                        newFunctions_4.ScreenshotNuevo("Cambiar a ventana crud Pruebas a Aplicar", true, file);
                                        Thread.Sleep(1500);
                                        ...
                                        //CrudKnmcaban.Click(desktopSession);
                                        //Thread.Sleep(1500);
                                        CrudKslreqpe.AgregarCrud2(desktopSession, 0, crudDet2);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKslreqpe.AgregarCrud2(desktopSession, 1, crudDet2);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        //    CrudKslreqpe.AgregarCrud2(desktopSession, 1, crudDet);
                                        //    newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        CrudKslreqpe.Click(desktopSession, 3);
                                        newFunctions_4.ScreenshotNuevo("Cambiar a ventana crud Condiciones de Pago", true, file);
                                        Thread.Sleep(1500);
                                        ...
                                        //CrudKnmcaban.Click(desktopSession);
                                        //Thread.Sleep(1500);
                                        CrudKslreqpe.AgregarCrud3(desktopSession, 0, crudDet3);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKslreqpe.AgregarCrud3(desktopSession, 1, crudDet3);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        CrudKslreqpe.Click(desktopSession, 4);
                                        newFunctions_4.ScreenshotNuevo("Cambiar a ventana crud detalle 2", true, file);
                                        Thread.Sleep(1500);
                                        PruebaCRUD.EliminarRegistro(desktopSession, ElementList3[1], botonesNavegador3, file);
                                        Thread.Sleep(1500);
                                        ...
                                        CrudKslreqpe.Click(desktopSession, 5);
                                        newFunctions_4.ScreenshotNuevo("Cambiar a ventana crud detalle 1", true, file);
                                        Thread.Sleep(1500);
                                        ...
                                        CrudKslreqpe.Click(desktopSession, 6);
                                        newFunctions_4.ScreenshotNuevo("Cambiar a ventana crud principal", true, file);
                                        Thread.Sleep(1500);
        ...
        public void KSlConasChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosSL.ModulosSL_3.KSlConasChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                //Datos Crud Detalle 2
                                rows["EmpreDet"].ToString().Length != 0 && rows["EmpreDet"].ToString() != null &&
                                rows["Identi"].ToString().Length != 0 && rows["Identi"].ToString() != null &&
                                rows["ActIdenti"].ToString().Length != 0 && rows["ActIdenti"].ToString() != null &&

                                //Datos Crud Detalle 
                                rows["Fecha"].ToString().Length != 0 && rows["Fecha"].ToString() != null &&
                                rows["Empre"].ToString().Length != 0 && rows["Empre"].ToString() != null &&
                                rows["Id"].ToString().Length != 0 && rows["Id"].ToString() != null &&
                                rows["ActFecha"].ToString().Length != 0 && rows["ActFecha"].ToString() != null)

                            {
                                ...
                                //Variables crud Detalle 2
                                string EmpreDet = rows["EmpreDet"].ToString();
                                string Identi = rows["Identi"].ToString();
                                string ActIdenti = rows["ActIdenti"].ToString();

                                //Variables crud Detalle 
                                string Fecha = rows["Fecha"].ToString();
                                string Empre = rows["Empre"].ToString();
                                string Id = rows["Id"].ToString();
                                string ActFecha = rows["ActFecha"].ToString();
                                ...
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Grupo, Requi, ActRequi };

                                //LISTA CRUD DETALLE
                                List<string> crudDet = new List<string>() { Fecha, Empre, Id, ActFecha };

                                //LISTA CRUD DETALLE 2
                                List<string> crudDet2 = new List<string>() { EmpreDet, Identi, ActIdenti };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKslconas.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKslconas.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        //CrudKnmcaban.Click(desktopSession);
                                        //Thread.Sleep(1500);
                                        CrudKslconas.AgregarCrud1(desktopSession, 0, crudDet);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKslconas.AgregarCrud1(desktopSession, 1, crudDet);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        CrudKslconas.Click(desktopSession, 2);
                                        newFunctions_4.ScreenshotNuevo("Cambiar a ventana crud calendario pruebas", true, file);
                                        Thread.Sleep(1500);

                                        ////AGREGAR REGISTRO DETALLE 2                                        
                                        CrudKslconas.Click(desktopSession, 3);
                                        Thread.Sleep(1500);

                                        //CrudKnmcaban.Click(desktopSession);
                                        //Thread.Sleep(1500);
                                        CrudKslconas.AgregarCrud2(desktopSession, 0, crudDet2);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);

                                        CrudKslconas.Click(desktopSession, 4);
                                        Thread.Sleep(1500);
                                        newFunctions_4.ScreenshotNuevo("Datos Insertados", true, file);
                                        ...
                                        ////DESCARTAR EDICION
                                        CrudKslconas.Click(desktopSession, 5);
                                        Thread.Sleep(1500);
                                        newFunctions_4.ScreenshotNuevo("Editar", true, file);

                                        CrudKslconas.AgregarCrud2(desktopSession, 1, crudDet);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);

                                        CrudKslconas.Click(desktopSession, 6);
                                        Thread.Sleep(1500);
                                        newFunctions_4.ScreenshotNuevo("Cancelar Datos Editados", true, file);
                                        ...
                                        CrudKslconas.Click(desktopSession, 1);
                                        newFunctions_4.ScreenshotNuevo("Cambiar a ventana crud preseleccionados", true, file);
                                        Thread.Sleep(1500);
                                        ...
                                        CrudKslconas.Click(desktopSession, 7);
                                        Thread.Sleep(1500);
                                        ...
                                        CrudKslconas.Click(desktopSession, 8);
                                        Thread.Sleep(1500);
                                        ...
                                        ////EXPORTAR EXCEL
                                        string ruta = @"C:\Reportes\ExportarExcel" + "_" + codProgram + "_" + Hora();
                                        errors = CrudKslconas.ExpExcel(desktopSession, banExcel, file, codProgram, ruta);
                                        if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }

                                        Thread.Sleep(2000);

                                        //EXPORTAR EXCEL
                                        errors = CrudKslconas.ExpExcel1(desktopSession, banExcel, file, codProgram, ruta);
                                        if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }
        ...
        public void KSlMprueChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosSL.ModulosSL_3.KSlMprueChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["Tip"].ToString().Length != 0 && rows["Tip"].ToString() != null &&
                                rows["Reque"].ToString().Length != 0 && rows["Reque"].ToString() != null &&
                                rows["Espe"].ToString().Length != 0 && rows["Espe"].ToString() != null &&
...

                            {
                                ...
                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Prueba, Nom, Descri, ActDescri };
                                //LISTA DETALLE 1
                                List<string> crudDet1 = new List<string>() { Tip, Reque, Espe, ActEspe };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKslmprue.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKslmprue.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        //CrudKnmcaban.Click(desktopSession);
                                        //Thread.Sleep(1500);
                                        CrudKslmprue.AgregarCrud1(desktopSession, 0, crudDet1);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKslmprue.AgregarCrud1(desktopSession, 1, crudDet1);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        //    CrudKnmcmaco.AgregarCrud1(desktopSession, 1, crudDet1);
                                        //    newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
        ...
        public void KSlRcaprChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosSL.ModulosSL_3.KSlRcaprChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
...

                            {
                                ...
                                //LISTA DETALLE 1
                                List<string> crudDet1 = new List<string>() { Prueba, Peso, ActPeso };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        //CrudKslrcapr.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        //CrudKslrcapr.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        //CrudKnmcaban.Click(desktopSession);
                                        //Thread.Sleep(1500);
                                        //CrudKslrcapr.AgregarCrud1(desktopSession, 0, crudDet1);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        //CrudKslrcapr.AgregarCrud1(desktopSession, 1, crudDet1);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
