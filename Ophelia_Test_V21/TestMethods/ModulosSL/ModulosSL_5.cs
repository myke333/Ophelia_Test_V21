...
{
    [TestClass]
    public class ModulosSL_5 : FuncionesVitales
    {
        ...
        public void KSlMetapChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosSL.ModulosSL_5.KSlMetapChecKlist")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["PunMin"].ToString().Length != 0 && rows["PunMin"].ToString() != null &&
                                rows["PunMax"].ToString().Length != 0 && rows["PunMax"].ToString() != null &&
                                rows["PunMinA"].ToString().Length != 0 && rows["PunMinA"].ToString() != null &&
                                rows["ActPunMinA"].ToString().Length != 0 && rows["ActPunMinA"].ToString() != null &&
                                ...
                                rows["Nom1"].ToString().Length != 0 && rows["Nom1"].ToString() != null &&
                                rows["Peso1"].ToString().Length != 0 && rows["Peso1"].ToString() != null &&
                                rows["Valor1"].ToString().Length != 0 && rows["Valor1"].ToString() != null &&
                                rows["Nom2"].ToString().Length != 0 && rows["Nom2"].ToString() != null &&
                                rows["Peso2"].ToString().Length != 0 && rows["Peso2"].ToString() != null &&
                                rows["Valor2"].ToString().Length != 0 && rows["Valor2"].ToString() != null &&
                                rows["ActValor2"].ToString().Length != 0 && rows["ActValor2"].ToString() != null &&

                                //Datos Crud Detalle 
                                rows["Cod"].ToString().Length != 0 && rows["Cod"].ToString() != null &&
                                rows["PesoP"].ToString().Length != 0 && rows["PesoP"].ToString() != null &&
                                rows["ActPesoP"].ToString().Length != 0 && rows["ActPesoP"].ToString() != null)

                            {
                                ...
                                string PunMin = rows["PunMin"].ToString();
                                string PunMax = rows["PunMax"].ToString();
                                string PunMinA = rows["PunMinA"].ToString();
                                string ActPunMinA = rows["ActPunMinA"].ToString();

                                //Variables crud Detalle 
                                string Nom = rows["Nom"].ToString();
                                string Peso = rows["Peso"].ToString();
                                string Valor = rows["Valor"].ToString();
                                string Nom1 = rows["Nom1"].ToString();
                                string Peso1 = rows["Peso1"].ToString();
                                string Valor1 = rows["Valor1"].ToString();
                                string Nom2 = rows["Nom2"].ToString();
                                string Peso2 = rows["Peso2"].ToString();
                                string Valor2 = rows["Valor2"].ToString();
                                string ActValor2 = rows["ActValor2"].ToString();

                                //Variables crud Detalle 2
                                string Cod = rows["Cod"].ToString();
                                string PesoP = rows["PesoP"].ToString();
                                string ActPesoP = rows["ActPesoP"].ToString();

                                String campo = "1";

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { PunMin, PunMax, PunMinA, ActPunMinA };

                                //LISTA CRUD DETALLE
                                List<string> crudDet = new List<string>() { Nom, Peso, Valor, Nom1, Peso1, Valor1,
                                                                            Nom2, Peso2, Valor2, ActValor2 };

                                //LISTA CRUD DETALLE 2
                                List<string> crudDet2 = new List<string>() { Cod, PesoP, ActPesoP };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKslmetap.Click(desktopSession, 2);
                                        Thread.Sleep(1500);
                                        newFunctions_4.ScreenshotNuevo("Eliminar Datos", true, file);

                                        CrudKslmetap.Click(desktopSession, 0);
                                        Thread.Sleep(1500);
                                        ...
                                        CrudKslmetap.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        ...
                                        CrudKslmetap.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        ...
                                        desktopSession.Mouse.Click(null);
                                        Thread.Sleep(1000);
                                        newFunctions_4.ScreenshotNuevo("Mensaje de que no se puede actualizar el crud principal", true, file);
                                        ...
                                        CrudKslmetap.Click(desktopSession, 3);
                                        Thread.Sleep(1500);

                                        //CrudKnmcaban.Click(desktopSession);
                                        //Thread.Sleep(1500);
                                        CrudKslmetap.AgregarCrud1(desktopSession, 0, crudDet);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);

                                        CrudKslmetap.Click(desktopSession, 4);
                                        Thread.Sleep(1500);
                                        newFunctions_4.ScreenshotNuevo("Datos Insertados", true, file);
                                        ...
                                        //CrudKnmcaban.Click(desktopSession);
                                        //Thread.Sleep(1500);
                                        CrudKslmetap.AgregarCrud1(desktopSession, 2, crudDet);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        ///agregamos tercer registro
                                        CrudKslmetap.Click(desktopSession, 3);
                                        Thread.Sleep(1500);

                                        //CrudKnmcaban.Click(desktopSession);
                                        //Thread.Sleep(1500);
                                        CrudKslmetap.AgregarCrud1(desktopSession, 3, crudDet);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        ////DESCARTAR EDICION
                                        CrudKslmetap.Click(desktopSession, 5);
                                        Thread.Sleep(1500);
                                        newFunctions_4.ScreenshotNuevo("Editar", true, file);

                                        CrudKslmetap.AgregarCrud1(desktopSession, 1, crudDet);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);

                                        CrudKslmetap.Click(desktopSession, 6);
                                        Thread.Sleep(1500);
                                        newFunctions_4.ScreenshotNuevo("Cancelar Datos Editados", true, file);
                                        ...
                                        //    CrudKslmetap.AgregarCrud2(desktopSession, 1, crudDet);
                                        //    newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        //CrudKnmcaban.Click(desktopSession);
                                        //Thread.Sleep(1500);
                                        CrudKslmetap.AgregarCrud2(desktopSession, 0, crudDet2);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        ...
                                        CrudKslmetap.AgregarCrud2(desktopSession, 1, crudDet2);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        newFunctions_4.ScreenshotNuevo("Mensaje de error de parametros", true, file);
                                        Thread.Sleep(1500);
                                        CrudKslconas.Click(desktopSession, 0);
                                        Thread.Sleep(1500);
                                        //validacion error al editar
