...
{
    /// <summary>
    /// Descripción resumida de ModulosSO_10
    /// </summary>
    [TestClass]
    public class ModulosSO_10 : FuncionesVitales
    {
        ...
        public void KSoTipinChecklist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosSO.ModulosSO_10.KSoTipinChecklist")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["editDetalle3"].ToString().Length != 0 && rows["editDetalle3"].ToString() != null &&
                                rows["campoEdit"].ToString().Length != 0 && rows["campoEdit"].ToString() != null)
                            {
                                ...
                                string editDetalle3 = rows["editDetalle3"].ToString();
                                ...
                                List<string> data = new List<string> { codigo, clase, edit };
                                List<string> dataD = new List<string> { tipo, nombre, editDetalle1 };
                                List<string> dataD2 = new List<string> { id, Empresa, editDetalle2 };
                                List<string> dataD3 = new List<string> { descrip, ubicacion, responsable, editDetalle3 };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla1, user, motor, Campo, codigo, codigo, Campo, c, ErrorValidacion, "No se agregó correctamente", 0, "1");

                                        Thread.Sleep(1000);
                                        //ELIMINAR REGISTROS PEGADOS
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla2, user, motor, Campo, codigo, codigo, Campo, c, ErrorValidacion, "No se agregó correctamente", 0, "1");

                                        Thread.Sleep(1000);
                                        //ELIMINAR REGISTROS PEGADOS
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla3, user, motor, Campo, codigo, codigo, Campo, c, ErrorValidacion, "No se agregó correctamente", 0, "1");
                                        ...
                                        CrudKsotipin.CrudKSotipin(desktopSession, 1, data);
                                        ...
                                        CrudKsotipin.CrudKSotipin(desktopSession, 2, data);
                                        ...
                                        //Validacion Editar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, codigo, clase, campoEdit, c, ErrorValidacion, "No se descartó correctamente", 1);
                                        ...
                                        botonesNavegadorDetalle = PruebaCRUD.findname(desktopSession, 28, 2);
                                        ElementList = PruebaCRUD.NavClass(desktopSession);
                                        
                                        //Insertar Detalle 1
                                        desktopSession.Mouse.MouseMove(ElementList[2].Coordinates, botonesNavegadorDetalle["Insertar"].X, botonesNavegadorDetalle["Insertar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        Thread.Sleep(2000);
                                        newFunctions_4.ScreenshotNuevo("Insertar Detalle 1", true, file);

                                        CrudKsotipin.CrudKSotipinDetalle1(desktopSession, 1, dataD);

                                        // Aplicar detalle 1
                                        desktopSession.Mouse.MouseMove(ElementList[2].Coordinates, botonesNavegadorDetalle["Aplicar"].X, botonesNavegadorDetalle["Aplicar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        Thread.Sleep(2000);
                                        newFunctions_4.ScreenshotNuevo("Detalle Insertado", true, file);

                                        // Editar detalle 1
                                        desktopSession.Mouse.MouseMove(ElementList[2].Coordinates, botonesNavegadorDetalle["Editar"].X, botonesNavegadorDetalle["Editar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        Thread.Sleep(2000);
                                        newFunctions_4.ScreenshotNuevo("Editar Detalle 1", true, file);

                                        CrudKsotipin.CrudKSotipinDetalle1(desktopSession, 2, dataD);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);

                                        // Descartar Edicion detalle 1
                                        desktopSession.Mouse.MouseMove(ElementList[2].Coordinates, botonesNavegadorDetalle["Cancelar"].X, botonesNavegadorDetalle["Cancelar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        Thread.Sleep(2000);
                                        newFunctions_4.ScreenshotNuevo("Edición Descartada", true, file);
                                        ...
                                        CrudKsotipin.CrudKSotipinDetalle2(desktopSession, 1, dataD2);
                                        ...
                                        CrudKsotipin.CrudKSotipinDetalle2(desktopSession, 2, dataD2);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        //Detalle 3
                                        desktopSession.Mouse.MouseMove(desktopSession.FindElementByName("Red de Apoyo").Coordinates);
                                        desktopSession.Mouse.Click(null);
                                        Thread.Sleep(1000);
                                        ...
                                        CrudKsotipin.CrudKSotipinDetalle3(desktopSession, 1, dataD3);
                                        ...
                                        CrudKsotipin.CrudKSotipinDetalle3(desktopSession, 2, dataD3);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        desktopSession.Mouse.MouseMove(desktopSession.FindElementByName("Tipo Integrante").Coordinates);
                                        desktopSession.Mouse.Click(null);
                                        Thread.Sleep(1000);
                                        ...
                                        ElementList = PruebaCRUD.NavClass(desktopSession);
                                        Thread.Sleep(1000);
                                        desktopSession.Mouse.MouseMove(ElementList[2].Coordinates, botonesNavegadorDetalle["Borrar"].X, botonesNavegadorDetalle["Borrar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        Thread.Sleep(500);
        ...
        public void KSoCodiaChecklist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosSO.ModulosSO_10.KSoCodiaChecklist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                                ...
                                rows["campoEdit"].ToString().Length != 0 && rows["campoEdit"].ToString() != null)
                            {
                                ...
                                string edit = rows["edit"].ToString();
                                string campoEdit = rows["campoEdit"].ToString();
                                List<string> data = new List<string> { codigo, nombre, lupa, descripcion, edit };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKsocodia.CrudKSocodia(desktopSession, 1, data);
                                        ...
                                        CrudKsocodia.CrudKSocodia(desktopSession, 2, data);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        //Validacion Editar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, codigo, descripcion, campoEdit, c, ErrorValidacion, "No se descartó correctamente", 1);
        ...
        public void KSoTipacChecklist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosSO.ModulosSO_10.KSoTipacChecklist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["BanderaSum"].ToString().Length != 0 && rows["BanderaSum"].ToString() != null &&
                                rows["codigo"].ToString().Length != 0 && rows["codigo"].ToString() != null &&
                                rows["codigoH"].ToString().Length != 0 && rows["codigoH"].ToString() != null &&
                                rows["nombre"].ToString().Length != 0 && rows["nombre"].ToString() != null &&
                                rows["descripcion"].ToString().Length != 0 && rows["descripcion"].ToString() != null &&
                                rows["edit"].ToString().Length != 0 && rows["edit"].ToString() != null &&
                                rows["campoEdit"].ToString().Length != 0 && rows["campoEdit"].ToString() != null)
                            {
                                ...
                                string codigo = rows["codigo"].ToString();
                                string codigoH = rows["codigoH"].ToString();
                                string nombre = rows["nombre"].ToString();
                                string descripcion = rows["descripcion"].ToString();
                                string edit = rows["edit"].ToString();
                                string campoEdit = rows["campoEdit"].ToString();
                                List<string> data = new List<string> { codigo, codigoH, nombre, descripcion, edit };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKsotipac.CrudKSotipac(desktopSession, 1, data);
                                        ...
                                        CrudKsotipac.CrudKSotipac(desktopSession, 2, data);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
        ...
        public void KSoTiprgChecklist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosSO.ModulosSO_10.KSoTiprgChecklist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                                ...
                                rows["campoEdit"].ToString().Length != 0 && rows["campoEdit"].ToString() != null)
                            {
                                ...
                                string edit = rows["edit"].ToString();
                                string campoEdit = rows["campoEdit"].ToString();
                                List<string> data = new List<string> { codigo, nombre, descripcion, edit };
                                ...
                                try
                                {
                                    ...
                                    //error clic derecho al iniciar el programa
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKsotiprg.CrudKSotiprg(desktopSession, 1, data);
                                        ...
                                        CrudKsotiprg.CrudKSotiprg(desktopSession, 2, data);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
        ...
        public void KSoTipseChecklist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosSO.ModulosSO_10.KSoTipseChecklist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                                ...
                                rows["edit"].ToString().Length != 0 && rows["edit"].ToString() != null &&
                                rows["descrip"].ToString().Length != 0 && rows["descrip"].ToString() != null &&
                                rows["codSenal"].ToString().Length != 0 && rows["codSenal"].ToString() != null &&
                                rows["nomSenal"].ToString().Length != 0 && rows["nomSenal"].ToString() != null &&
                                ...
                                rows["campoEdit"].ToString().Length != 0 && rows["campoEdit"].ToString() != null)
                            {
                                ...
                                string descrip = rows["descrip"].ToString();
                                string edit = rows["edit"].ToString();
                                string codSenal = rows["codSenal"].ToString();
                                string nomSenal = rows["nomSenal"].ToString();
                                string editDetalle = rows["editDetalle"].ToString();
                                string campoEdit = rows["campoEdit"].ToString();
                                string Tabla2 = rows["Tabla2"].ToString();
                                List<string> data = new List<string> { codigo, nombre, descrip, edit };
                                List<string> dataD = new List<string> { codSenal, nomSenal, editDetalle };
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        //ELIMINAR REGISTROS DETALLE PEGADOS
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla2, user, motor, Campo, codigo, codigo, Campo, c, ErrorValidacion, "No se agregó correctamente", 0, "1");
                                        ...
                                        CrudKsotipse.CrudKSotipse(desktopSession, 1, data);
                                        ...
                                        CrudKsotipse.CrudKSotipse(desktopSession, 2, data);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
                                        ...
                                        CrudKsotipse.CrudKSotipseDetalle(desktopSession, 1, dataD);
                                        ...
                                        CrudKsotipse.CrudKSotipseDetalle(desktopSession, 2, dataD);
                                        newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
