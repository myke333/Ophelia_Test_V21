...
{
    [TestClass]
    public class ModulosSO_14 : FuncionesVitales
    {
        ...
        //        if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosSO.ModulosSO_14.KSoSaludChecKlist")
        //        {
        ...
        //                        rows["ActLupa"].ToString().Length != 0 && rows["ActLupa"].ToString() != null )
        ...
        //                        string ActLupa = rows["ActLupa"].ToString();
        //                        string Codigo = "9";
        ...
        //                        //LISTA CRUD PRINCIPAL
        //                        List<string> crudPrincipal2 = new List<string>() {ActLupa };
        ...
        //                                CrudSosalud.AgregarCrud(desktopSession, 0, crudPrincipal, crudPrincipal2);
        ...
        //                                CrudSosalud.AgregarCrud(desktopSession, 1, crudPrincipal, crudPrincipal2);
        ...
        //                                ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, Lupa, EditCampo, c, ErrorValidacion, "No se edito correctamente", 1);
        ...
        //                                ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, Codigo, ActLupa, EditCampo, c, ErrorValidacion, "El registro no se editó correctamente", 1);
