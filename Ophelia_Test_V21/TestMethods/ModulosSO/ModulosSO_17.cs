...
{
    [TestClass]
    public class ModulosSO_17 : FuncionesVitales
    {
        ...
        public void KSoSalpeChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosSO.ModulosSO_17.KSoSalpeChecKlist")
                {
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        Thread.Sleep(1500);
                                        CrudKsosalpe.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        ...
                                        Thread.Sleep(1500);
                                        CrudKsosalpe.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        Thread.Sleep(1500);
        ...
        public void KSocovacChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosSO.ModulosSO_17.KSoCovacChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                               rows["User"].ToString().Length != 0 && rows["User"].ToString() != null &&
                                ...
                                rows["fecha3"].ToString().Length != 0 && rows["fecha3"].ToString() != null &&
                                rows["Lote"].ToString().Length != 0 && rows["Lote"].ToString() != null &&
...

                            {
                                ...
                                string fecha2 = rows["fecha3"].ToString();
                                string fecha3 = rows["fecha2"].ToString();
                                string Lote = rows["Lote"].ToString();
                                ...
                                List<string> crudDetalle = new List<string>() { fecha1, fecha2, fecha3, Lote, Observaciones, ActObservaciones };
                                //CREAR EL DOCUMENTO DEL REPORTE DE LA PRUEBA
                                string file = CrearDocumentoWordDinamico(codProgram, "SO", motor);
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        desktopSession.Mouse.Click(null);
                                        Thread.Sleep(1500);
                                        CrudKsocovac.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        Thread.Sleep(1500);
                                        ...
                                        CrudKsocovac.AgregarCrudDetalle(desktopSession, 0, crudDetalle);
                                        ...
                                        CrudKsocovac.AgregarCrudDetalle(desktopSession, 1, crudDetalle);
                                        ...
                                        CrudKsocovac.reportePreliminar(desktopSession, 0, crudDetalle);
                                        newFunctions_4.ScreenshotNuevo("Reporte Preliminar opcion 1", true, file);
                                        Thread.Sleep(1500);
                                        string pdf1 = @"C:\Reportes\ReportePDF1_" + "Preliminar" + "_" + Hora();
                                        ...
                                        CrudKsocovac.reportePreliminar(desktopSession, 1, crudDetalle);
                                        newFunctions_4.ScreenshotNuevo("Reporte Preliminar opcion 2", true, file);
                                        ...
                                        CrudKsocovac.Seguir(desktopSession, 1, crudDetalle);
        ...
        public void KSoVamedChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosSO.ModulosSO_17.KSoVamedChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            if (
                               rows["User"].ToString().Length != 0 && rows["User"].ToString() != null &&
                                ...
                                rows["Subprog"].ToString().Length != 0 && rows["Subprog"].ToString() != null &&
                                rows["Programa"].ToString().Length != 0 && rows["Programa"].ToString() != null &&
                                rows["Procedimientos"].ToString().Length != 0 && rows["Procedimientos"].ToString() != null &&
                                rows["Fecha"].ToString().Length != 0 && rows["Fecha"].ToString() != null &&
                                rows["Consulta"].ToString().Length != 0 && rows["Consulta"].ToString() != null &&
                                rows["Observaciones"].ToString().Length != 0 && rows["Observaciones"].ToString() != null &&                           
                                rows["ActContrato"].ToString().Length != 0 && rows["ActContrato"].ToString() != null &&
                                rows["ActSub"].ToString().Length != 0 && rows["ActSub"].ToString() != null &&
...

                            {
                                ...
                                string Subprog = rows["Subprog"].ToString();
                                string Programa = rows["Programa"].ToString();
                                string Procedimientos = rows["Procedimientos"].ToString();
                                string Fecha = rows["Fecha"].ToString();
                                string Consulta = rows["Consulta"].ToString();
                                string Observaciones = rows["Observaciones"].ToString();
                                string ActContrato = rows["ActContrato"].ToString();
                                string ActSub = rows["ActSub"].ToString();
                                string ActObs = rows["ActObs"].ToString();

                                String campo = "0";

                                //LISTA CRUD PRINCIPAL
                                List<string> crudPrincipal = new List<string>() { Contrato, Subprog, Programa, Procedimientos, Fecha, Consulta, Observaciones};

                                List<string> crudPrincipal2 = new List<string>() { ActContrato, ActSub, Programa, ActObs };
                                //CREAR EL DOCUMENTO DEL REPORTE DE LA PRUEBA
                                string file = CrearDocumentoWordDinamico(codProgram, "SO", motor);
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        desktopSession.Mouse.Click(null);
                                        Thread.Sleep(3500);
                                        CrudKsovamed.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        Thread.Sleep(3500);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        Thread.Sleep(1500);
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Aplicar"].X, botonesNavegador["Aplicar"].Y);
                                        ...
                                        newFunctions_4.ScreenshotNuevo("Editar", true, file);
                                        Thread.Sleep(1500);
                                        CrudKsovamed.AgregarCrud(desktopSession, 1, crudPrincipal2);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        Thread.Sleep(1500);
                                        ...
                                        Thread.Sleep(3000);
                                        CrudKsovamed.reportePreliminar(desktopSession, 0);
                                        newFunctions_4.ScreenshotNuevo("Primera opcion del preliminar", true, file);
                                        CrudKsovamed.reportePreliminar(desktopSession, 1);
                                        string pdf1 = @"C:\Reportes\ReportePDF1_" + "Preliminar" + "_" + Hora();
                                        errors = newFunctions_5.GenerarReportes("Preliminar", file, pdf1, nomProgram);
                                        if (errors.Count > 0) { foreach (string er in errors) { errorMessages.Add(er); } }

                                        Thread.Sleep(5000);
                                        CrudKsovamed.reportePreliminar(desktopSession, 2);
                                        ...
                                        Thread.Sleep(5000);
                                        CrudKsovamed.reportePreliminar(desktopSession, 3);
                                        ...
                                        Thread.Sleep(5000);
                                        CrudKsovamed.reportePreliminar(desktopSession, 4);
        ...
        public void KSoClrieChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosSO.ModulosSO_17.KSoClrieChecKlist")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        desktopSession.Mouse.Click(null);
                                        Thread.Sleep(1500);
                                        CrudKsoclrie.AgregarCrud(desktopSession, 0, crudPrincipal); ;
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        Thread.Sleep(1500);
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Aplicar"].X, botonesNavegador["Aplicar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        ...
                                        newFunctions_4.ScreenshotNuevo("Editar", true, file);
                                        Thread.Sleep(1500);
                                        CrudKsoclrie.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
                                        Thread.Sleep(1500);
