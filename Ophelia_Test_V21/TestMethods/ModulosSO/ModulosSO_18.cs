...
{
    [TestClass]
    public class ModulosSO_18 : FuncionesVitales
    {
        ...
        public void KSoSaludChecKlist()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosSO.ModulosSO_18.KSoSaludChecKlist")
                {
...

                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKsosalud.AgregarCrud(desktopSession, 0, crudPrincipal);
                                        ...
                                        CrudKsosalud.AgregarCrud(desktopSession, 1, crudPrincipal);
                                        newFunctions_4.ScreenshotNuevo("Insertar Datos", true, file);
