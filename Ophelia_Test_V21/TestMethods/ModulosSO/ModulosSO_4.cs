...
{
    /// <summary>
    /// Descripción resumida de ModulosSO_4
    /// </summary>
    [TestClass]
    public class ModulosSO_4 : FuncionesVitales
    {
        ...
        public void KSoOhabiCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosSO.ModulosSO_4.KSoOhabiCheckList")
                {
                                ...
                                )
                            {
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKsoohabi.KSoOhabiCRUD(desktopSession, crudVariables, 0);
                                        Thread.Sleep(5000);
                                        ...
                                        desktopSession.Mouse.Click(null);
                                        CrudKsoohabi.KSoOhabiCRUD(desktopSession, crudVariables, 1);
                                        Thread.Sleep(1000);
        ...
        public void KSoPcontCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosSO.ModulosSO_4.KSoPcontCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            ...
                            if (
                                ...
                                rows["BanderaSum"].ToString().Length != 0 && rows["BanderaSum"].ToString() != null &&
                                rows["BanderaPreli"].ToString().Length != 0 && rows["BanderaPreli"].ToString() != null &&
                                rows["TipoControl"].ToString().Length != 0 && rows["TipoControl"].ToString() != null &&
                                rows["Descripcion"].ToString().Length != 0 && rows["Descripcion"].ToString() != null &&
                                rows["EditDescripcion"].ToString().Length != 0 && rows["EditDescripcion"].ToString() != null &&
                                ...
                                )
                            {
                                ...
                                string tipoControl = rows["TipoControl"].ToString();
                                string descripcion = rows["Descripcion"].ToString();
                                string editDescripcion = rows["EditDescripcion"].ToString();
                                ...
                                Dictionary<string, Point> botonesNavegadorDet1 = new Dictionary<string, Point>();
                                Dictionary<string, Point> botonesNavegadorDet2 = new Dictionary<string, Point>();
                                List<string> crudVariables = new List<string>() { tipoControl, descripcion, editDescripcion };
                                List<string> crudVariablesDet1 = new List<string>() { };
                                bool isErrorDisplayed = false;
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Insertar"].X, botonesNavegador["Insertar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        CrudKsopcont.KSoPcontCRUD(desktopSession, crudVariables, 0);
                                        Thread.Sleep(1000);
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Aplicar"].X, botonesNavegador["Aplicar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        Thread.Sleep(2000);
                                        ...
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Editar"].X, botonesNavegador["Editar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        CrudKsopcont.KSoPcontCRUD(desktopSession, crudVariables, 1);
                                        Thread.Sleep(1000);
                                        newFunctions_4.ScreenshotNuevo("Registro Editado", true, file);
                                        desktopSession.Mouse.MouseMove(ElementList[0].Coordinates, botonesNavegador["Cancelar"].X, botonesNavegador["Cancelar"].Y);
                                        desktopSession.Mouse.Click(null);
        ...
        public void KSoEspecCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosSO.ModulosSO_4.KSoEspecCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            ...
                            if (
                                ...
                                rows["ValorLegal"].ToString().Length != 0 && rows["ValorLegal"].ToString() != null &&
                                rows["Unidad"].ToString().Length != 0 && rows["Unidad"].ToString() != null &&
                                rows["EditUnidad"].ToString().Length != 0 && rows["EditUnidad"].ToString() != null
                                )
                            {
                                ...
                                string valorLegal = rows["ValorLegal"].ToString();
                                string unidad = rows["Unidad"].ToString();
                                string editUnidad = rows["EditUnidad"].ToString();
                                string identificacion = codigo;

                                Dictionary<string, Point> botonesNavegador = new Dictionary<string, Point>();
                                Dictionary<string, Point> botonesNavegadorDet1 = new Dictionary<string, Point>();
                                Dictionary<string, Point> botonesNavegadorDet2 = new Dictionary<string, Point>();
                                List<string> crudVariables = new List<string>() { codigo, nombre, valorLegal, unidad, editUnidad };
                                List<string> crudVariablesDet1 = new List<string>() { };
                                bool isErrorDisplayed = false;
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        newFunctions_4.changeWindow(desktopSession, "SubFactores");
                                        Thread.Sleep(1000);

                                        botonesNavegador = CrudKsoespec.findname(desktopSession, 25, 1);
                                        var ElementList = PruebaCRUD.NavClass(desktopSession);


                                        //AGREGAR REGISTRO
                                        desktopSession.Mouse.MouseMove(ElementList[1].Coordinates, botonesNavegador["Nuevo"].X, botonesNavegador["Nuevo"].Y);
                                        desktopSession.Mouse.Click(null);
                                        CrudKsoespec.KSoEspecCRUD(desktopSession, crudVariables, 0);
                                        Thread.Sleep(5000);
                                        ...
                                        desktopSession.Mouse.Click(null);
                                        CrudKsoespec.KSoEspecCRUD(desktopSession, crudVariables, 1);
                                        Thread.Sleep(1000);
                                        newFunctions_4.ScreenshotNuevo("Registro Editado Detalle", true, file);
                                        desktopSession.Mouse.MouseMove(ElementList[1].Coordinates, botonesNavegador["Descartar"].X, botonesNavegador["Descartar"].Y);
                                        desktopSession.Mouse.Click(null);
                                        Thread.Sleep(2000);
                                        newFunctions_4.ScreenshotNuevo("Edición Descartada Detalle", true, file);
                                        //Validacion Editar Descartar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, identificacion, unidad, editCampo, c, ErrorValidacion, "No se edito correctamente", 1);
                                        ...
                                        ErrorValidacion = ValidacionesQueries.ValidacionLogbo(Tabla, motor, user, Campo, identificacion, "E", c, ErrorValidacion);
                                        //Validacion Editar Aceptar
                                        ErrorValidacion = ValidacionesQueries.ValidacionCabecera(Tabla, user, motor, Campo, identificacion, editUnidad, editCampo, c, ErrorValidacion, "El registro no se editó correctamente", 1);
                                        Thread.Sleep(1000);
        ...
        public void KSoProgiCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosSO.ModulosSO_4.KSoProgiCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            ...
                            if (
                                ...
                                rows["Radio"].ToString().Length != 0 && rows["Radio"].ToString() != null
                                )
                            {
                                ...
                                string radio = rows["Radio"].ToString();

                                Dictionary<string, Point> botonesNavegador = new Dictionary<string, Point>();
                                Dictionary<string, Point> botonesNavegadorDet1 = new Dictionary<string, Point>();
                                Dictionary<string, Point> botonesNavegadorDet2 = new Dictionary<string, Point>();
                                List<string> crudVariables = new List<string>() { año, mes, radio };
                                List<string> crudVariablesDet1 = new List<string>() { };
                                bool isErrorDisplayed = false;
                                //CREAR EL DOCUMENTO DEL REPORTE DE LA PRUEBA
                                string file = CrearDocumentoWordDinamico(codProgram, "SO", motor);
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKsoprogi.KSoProgiCRUD(desktopSession, crudVariables, 0);
                                        ...
                                        CrudKsoprogi.BotonAceptarConBarraProgreso(desktopSession, file);
                                        Thread.Sleep(1000);
        ...
        public void KSoResstCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosSO.ModulosSO_4.KSoResstCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            ...
                            if (
                                ...
                                rows["BanderaSum"].ToString().Length != 0 && rows["BanderaSum"].ToString() != null &&
                                rows["BanderaPreli"].ToString().Length != 0 && rows["BanderaPreli"].ToString() != null &&
                                rows["RadioButton"].ToString().Length != 0 && rows["RadioButton"].ToString() != null &&
                                ...
                                )
                            {
                                ...
                                string radioButton = rows["RadioButton"].ToString();
                                ...
                                Dictionary<string, Point> botonesNavegadorDet1 = new Dictionary<string, Point>();
                                Dictionary<string, Point> botonesNavegadorDet2 = new Dictionary<string, Point>();
                                List<string> crudVariables = new List<string>() { radioButton, fechaFinal, fechaInicial };
                                List<string> crudVariablesDet1 = new List<string>() { };
                                bool isErrorDisplayed = false;
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKsoresst.KSoResstCRUD(desktopSession, crudVariables, 0);

                                        //QBE
                                        errors = CrudKsoresst.QBEQry(desktopSession, TipoQbe, QbeFilter, file);
                                        if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }
                                        Thread.Sleep(5000);
                                        ...
                                        //EXPORTAR EXCEL
                                        /*string ruta = @"C:\Reportes\ExportarExcel" + "_" + codProgram + "_" + Hora();
                                        errors = CrudKsoresst.ExpExcel(desktopSession, banExcel, file, codProgram, ruta);
                                        if (errors.Count > 0) { foreach (string er in errors) { ErrorValidacion.Add(er); } }*/
        ...
        public void KSoRcvotCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosSO.ModulosSO_4.KSoRcvotCheckList")
                {
                    DataSet sta = SqlAdapter.SelectOrderExecution("P", TableOrder, plans, suite, CaseId);
                    string endstatus = null;
                    foreach (DataRow rowsta in sta.Tables[0].Rows)
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            ...
                            if (
                                ...
                                rows["BanderaSum"].ToString().Length != 0 && rows["BanderaSum"].ToString() != null &&
                                rows["BanderaPreli"].ToString().Length != 0 && rows["BanderaPreli"].ToString() != null &&
                                rows["Comite"].ToString().Length != 0 && rows["Comite"].ToString() != null &&
                                rows["FechaInicial"].ToString().Length != 0 && rows["FechaInicial"].ToString() != null &&
                                rows["FechaFinal"].ToString().Length != 0 && rows["FechaFinal"].ToString() != null
                                )
                            {
                                ...
                                string comite = rows["Comite"].ToString();
                                string fechaInicial = rows["FechaInicial"].ToString();
                                string fechaFinal = rows["FechaFinal"].ToString();
                                ...
                                Dictionary<string, Point> botonesNavegadorDet1 = new Dictionary<string, Point>();
                                Dictionary<string, Point> botonesNavegadorDet2 = new Dictionary<string, Point>();
                                List<string> crudVariables = new List<string>() { comite, fechaFinal, fechaInicial };
                                List<string> crudVariablesDet1 = new List<string>() { };
                                bool isErrorDisplayed = false;
                                ...
                                try
                                {
                                    ...
                                    if (leeprograma)
                                    {
                                        ...
                                        CrudKsorcvot.KSoRcvotCRUD(desktopSession, crudVariables, 0);
                                        Thread.Sleep(2000);
