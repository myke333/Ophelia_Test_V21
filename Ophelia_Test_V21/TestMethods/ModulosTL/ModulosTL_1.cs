...
using Ophelia_Test_V21.AFuncionesGlobales.CRUDProgramas.ModulosTl;

namespace Ophelia_Test_V21.TestMethods.ModulosTL
{
    [TestClass]
    public class ModulosTL_1 : FuncionesVitales
    {
        ...
        public void KTlDiforCheckList()
        {
            ...
            foreach (DataRow rowsi in OrderExecutionCase.Tables[0].Rows)
            {
                ...
                if (methodname.Replace(" ", string.Empty) == "Ophelia_Test_V21.TestMethods.ModulosTL.ModulosTL_1.KTlDiforCheckList")
                {
                    ...
                    if (endstatus == "True")
                    {
                        ...
                        foreach (DataRow rows in DataCase.Tables[0].Rows)
                        {
                            ...
                            if (
                                ...
                                rows["Forma"].ToString().Length != 0 && rows["Forma"].ToString() != null &&
                                rows["Nombre"].ToString().Length != 0 && rows["Nombre"].ToString() != null &&
                                rows["Page"].ToString().Length != 0 && rows["Page"].ToString() != null &&
                                rows["TablaDa"].ToString().Length != 0 && rows["TablaDa"].ToString() != null &&                                
...

                            {
                                ...
                                string Forma = rows["Forma"].ToString();
                                string Nombre = rows["Nombre"].ToString();                                
                                string Page = rows["Page"].ToString();
                                string TablaDa = rows["TablaDa"].ToString();
...

                                {
                                    ...
                                    List<string> crudPrincipal = new List<string>() { Forma, Nombre, Page, TablaDa, ActNombre };

                                    //CREAR EL DOCUMENTO DEL REPORTE DE LA PRUEBA
                                    string file = CrearDocumentoWordDinamico(codProgram, "TL", motor);
                                    ...
                                    try
                                    {
                                        ...
                                        if (leeprograma)
                                        {
                                            ...
                                            CrudKtldifor.AgregarCrud(desktopSession, 0, crudPrincipal, file);
                                            ...
                                            CrudKtldifor.AgregarCrud(desktopSession, 1, crudPrincipal, file);
                                            ...
                                            //    CrudKtldifor.AgregarCrud(desktopSession, 1, crudPrincipal);
                                            //    newFunctions_4.ScreenshotNuevo("Datos Editados", true, file);
